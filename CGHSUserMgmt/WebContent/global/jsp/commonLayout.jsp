...
<script src="/CGHSUserMgmt/global/moment/moment.min.js"></script>
...
<!-- <script src="/HIS/hisglobal/FormFlowX/plugins/bootstrapDualListBox/jquery.bootstrap-duallistbox.js"></script> -->
 ...
 <script src="/HIS/hisglobal/FormFlowX/js/security.js<%=globalVersion%>"></script> 
   <script src="/CGHSUserMgmt/global/js/md5.js"></script> 
 ...
 <script src="/HIS/hisglobal/FormFlowX/js/commonFunctions.js<%=globalVersion%>"></script>
  ...
  <!-- FileUpload -->
 <script src="/CGHSUserMgmt/global/js/md5.js<%=globalVersion%>"></script>
 <script src="/CGHSUserMgmt/global/js/fileUploadUtility.js<%=globalVersion%>"></script>
 <!-- QrCode -->
