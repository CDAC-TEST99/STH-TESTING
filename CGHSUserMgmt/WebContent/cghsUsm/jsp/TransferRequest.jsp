...
<html lang="en">
<head>
    <title>Role Transfer Request</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="/CGHSUserMgmt/cghsUsm/js/TransferRequest.js"></script>
</head>
...
<section class="p-0">
    <form action="/CGHSUserMgmt/FormFlowXACTION" name="FormFlowXACTION" method="post">
        <fieldset id="ENTRYFORM">
                                    <legend class="w-auto px-2 legendcss" id='formTitle'>Role Transfer</legend>
                        ...
                        <div class="accordion-body">
                            <div class="container-fluid mt-4" id="newTransferRequestSection">
                                <div class="row">
                                	<div class="col-lg-3">
                                        <div class="form-group">
                                            <label for="fromHosp" class="col-form-label col-form-label-md">Wellness Center:</label>
                                            <select id="fromHosp" name="fromHosp" class="form-control form-control-sm select2" data-validation="mandatory">
