...
public class HISSSOClientRequestFilter implements Filter
{
	...
	//"//HIS//",
	public  String []arrSkipURL= {"//HIS//",".js",".css","image",".pdf",".woff2" ,".ttf" ,"/services/"};
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
	{
		...
		System.out.println("inside CGHSUserMgmt HISSSOClientRequestFilter doFilter");
		...
		try
		{
			...
			System.out.println("CGHSUserMgmt strURI---" + strURI);
		...
		//	System.out.println("isGlobal---" + isGlobal);
			...
			else
			{
				...
				System.out.println("isURLAuthenticationRequired="+isURLAuthenticationRequired +" CGHSUserMgmt :: HisRequestLoginFilter");
