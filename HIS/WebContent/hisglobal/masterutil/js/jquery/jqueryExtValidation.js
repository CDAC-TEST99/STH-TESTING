...
/**
	...
	/**
	 * alphaSpecialChar	: Validates (allows) alphaNumeric and special characters only for address purpose
	 * USAGE			: addressValidate
	 * Added by			:Anjali- to validate Referring Institute Name
	 */
	$.extend($.fn.validatebox.defaults.rules, {  
		   addressValidate: {
		      validator: function(value){
		        	var r = /^[0-9a-zA-Z\,\.\s\&\-\_\()\'\/]+$/i;
		         return value.match(r);
		      },  
		      message: 'Enter Alphabet-Numbers with special characters Only.'
		   }  
		});
