...
$("<div class=\"tabs-header\" id=\"tabid\">"+"<div class=\"tabs-scroller-left\"></div>"+"<div class=\"tabs-scroller-right\"></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"<img id=\"tabs-header-refresh\" src=\"/HIS/hisglobal/images/tabmenu/mini_refresh.png\" alt='' onClick=\"tabRefresh();\" title=\"Refresh\"></div>"+"</div>").prependTo(_316);
...
return false;
	...
	function _323(_324, pp, _325) {
		...
		opts.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"
				+ "<span class=\"tabs-title\"  key=''></span>"
	...
	function _32b(_32c, _32d) {
		...
		//key name for language change  -----------By Ankur Verma
		var tabtitleKey=tab.find("span.tabs-title");
		var tabtitleKeyName=opts.title;
		
		tabtitleKey.attr("key",tabtitleKeyName.toLowerCase().replace(/ /gi, "-"));
