...
function getAJAXDeskMenuList(jsonMenuType)
{
	...
	var action 	= "/HISClinical/hisglobal/utility/dynamicdesk/deskDetail.cnt?deskMode="+listTypeMode+deskPatInfo;
		...
		for (i in arrRecordJsonObj)
		{
			...
			else if(menuViewType=="6")
			{
				...
				dtlRow += 	"<div class='div-table-row' style='padding: 0px;'><div class='div-table-col width100' align='center'>" +
								"<div class='div-table-col width100' align='center' style='padding: 0px;' onclick=\"addTab('"+arrRecordJsonObj[i].deskMenuName+"','"+arrRecordJsonObj[i].deskUrl+"','"+arrRecordJsonObj[i].deskMenuId+"','"+arrRecordJsonObj[i].deskMenuType+"',false,'"+dtl+"','"+arrRecordJsonObj[i].deskUrlType+"','"+arrRecordJsonObj[i].menuExtUrl+"','"+arrRecordJsonObj[i].deskType+"');\" title='"+arrRecordJsonObj[i].deskMenuName+"'>" +
									...
									"</div>" +
							"<div class='div-table-col width100' style='padding: 0px; display:block;' align='center' onclick=\"addTab('"+arrRecordJsonObj[i].deskMenuName+"','"+arrRecordJsonObj[i].deskUrl+"','"+arrRecordJsonObj[i].deskMenuId+"','"+arrRecordJsonObj[i].deskMenuType+"',false,'"+dtl+"','"+arrRecordJsonObj[i].deskUrlType+"','"+arrRecordJsonObj[i].menuExtUrl+"','"+arrRecordJsonObj[i].deskType+"');\"><font size='0' style='font-size: 9px;'><a class='wrapper rounded deskMenuStyle'>"+arrRecordJsonObj[i].deskMenuName+"</a>"+
...
function addTab(title, url, deskMenuId, deskMenuType, flgRefresh, deskSelectInfo, deskUrlType, deskExternalMenuURL,deskType)
{
	...
	if(deskUrlType=='2')
	{
		...
		deskSelectInfo+="&isDesk=1&deskType="+deskType;
		//alert(deskType);
		//alert(deskSelectInfo);
		//alert(deskExternalMenuURL);
		...
		{		
			...
			var content = '<iframe scrolling="no" id="deskPatDashId" frameborder="0" src="'+targetURL+'" style="width:100%;height:'+height1+'; margin-top:2px;"></iframe>';
				...
				//document.getElementById('deskPatDashId').src="/HISClinical/hisglobal/utility/dynamicdesk/deskDetail.cnt"+deskMenuId
