             		...
             		<div class='col-md-12 col-xl-6 welcomebg' >
             			<div class='row mt-5'>
							 		...
							 		<div class="col-12 text-center mt-1">
							 			<h1 class="mb-4 text-warning">Welcome</h1>
							 			<h1 class="mb-4 text-danger"><%=userFullName %> </h1>
							  ...
							  <div class="col-3 group">
                                ...
                                <%} %>  
									...
									<div class="text-center">
										<button class="btn-his" type="button"   style="width: 30%;"  tabindex="4"  value="Login" id="loginid"  >Change Password</button>
