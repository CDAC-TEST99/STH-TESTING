...
public abstract class LoginFeatureSUP extends ActionSupport implements ServletRequestAware, ServletResponseAware
{
	...
	private String varNewMobileNumber;
	private String varRefPass;


	//private String varMenuId;
	
	//Added By Deepti for STH 05.06.2020
	private String captchaResponse_passwordChange;
	...
	public String getCaptchaResponse_passwordChange() {
		return captchaResponse_passwordChange;
	}

	public void setCaptchaResponse_passwordChange(String captchaResponse_passwordChange) {
		this.captchaResponse_passwordChange = captchaResponse_passwordChange;
	}

	public String getVarNewMobileNumber() {
		return varNewMobileNumber;
	}

	public void setVarNewMobileNumber(String varNewMobileNumber) {
		this.varNewMobileNumber = varNewMobileNumber;
	}

	public String getVarRefPass() {
		return varRefPass;
	}

	public void setVarRefPass(String varRefPass) {
		this.varRefPass = varRefPass;
	}
