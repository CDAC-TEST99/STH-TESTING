...
public class UserLoginLogVO extends ValueObject
{
	...
	private String desktopSystemInfo;
	private String browserInfo;
	
	private String varSlNo;
	
	private String varServerIp;
	
	private List<UserSeatVO> userSeatsDtl;
	
	
	
	public List<UserSeatVO> getUserSeatsDtl() {
		return userSeatsDtl;
	}

	public void setUserSeatsDtl(List<UserSeatVO> userSeatsDtl) {
		this.userSeatsDtl = userSeatsDtl;
	}

	public String getVarServerIp() {
		return varServerIp;
	}

	public void setVarServerIp(String varServerIp) {
		this.varServerIp = varServerIp;
	}

	public String getVarAppHost() {
		return varAppHost;
	}

	public void setVarAppHost(String varAppHost) {
		this.varAppHost = varAppHost;
	}
	...
	public String getVarClientSSOTicketId() {
		return varClientSSOTicketId;
	}

	public void setVarClientSSOTicketId(String varClientSSOTicketId) {
		this.varClientSSOTicketId = varClientSSOTicketId;
	}
	...
	public String getVarSlNo() {
		return varSlNo;
	}

	public void setVarSlNo(String varSlNo) {
		this.varSlNo = varSlNo;
	}
