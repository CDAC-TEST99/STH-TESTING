...
public class HISSSOServiceCLN
{
	...
	public HISServiceGrantTicket authenticate(String grantingTicketId, HISService objHISService)
	{
		...
		try
		{
			...
			if(objHISGrantTicket!=null)
				System.out.println("HIS-SSO-CLN:: TGT-" + grantingTicketId+ " Registered Service-" + objHISService.getContext() +" ST-"+objHISGrantTicket.getTicketId());
			else
				System.out.println("HIS-SSO-CLN:: TGT-" + grantingTicketId+ " Not Registered Service-" + objHISService.getContext());
		}
		catch (Exception e)
		{
