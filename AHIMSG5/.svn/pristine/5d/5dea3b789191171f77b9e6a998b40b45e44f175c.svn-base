...
<div>
	<table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-image: '/HIS/hisglobal/images/strip20.png'; background-repeat: repeat-x;"> 
		<tr>
			<td width="30%">
			<div align="left" ><font color="#000000" style="left:3%;top:0%;" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>&nbsp;<span key='welcome-1'>Welcome,</span> <s:property value="varUserName"/></b></font></div>
			</td>	
				<td width="65%">
