...
public class GbltHospitalMst implements Serializable {
	...
	@Column(name="GNUM_IS_LOGO_REQUIRED")
	private Integer gnumIsLogoRequired;
	
	@Column(name="GNUM_LOGO_TYPE")
    private Integer gnumLogoType;
	
	@Column(name="GSTR_LOGO_FILENAME")
    private String gstrLogoFileName;
	...
	public Integer getGnumIsLogoRequired() {
		return gnumIsLogoRequired;
	}

	public void setGnumIsLogoRequired(Integer gnumIsLogoRequired) {
		this.gnumIsLogoRequired = gnumIsLogoRequired;
	}

	public Integer getGnumLogoType() {
		return gnumLogoType;
	}

	public void setGnumLogoType(Integer gnumLogoType) {
		this.gnumLogoType = gnumLogoType;
	}

	public String getGstrLogoFileName() {
		return gstrLogoFileName;
	}

	public void setGstrLogoFileName(String gstrLogoFileName) {
		this.gstrLogoFileName = gstrLogoFileName;
	}
