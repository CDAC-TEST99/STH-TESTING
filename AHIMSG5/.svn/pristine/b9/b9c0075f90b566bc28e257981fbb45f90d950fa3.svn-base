...
//	rajmsdg-rmsc$cdac@2013$RAJSMS
	...
	*/
	static String username = "nims.sms";
	static String password = "Qa%23%2412Ta";
	static String senderid = "NICSMS";
	static String message = "Test SMS from NIMS, Sorry for inconvenience!";
	static String mobileNo = "919873719322";
	static String mobileNos = "9891102810, 9891102810,9891102810";
	...
	/**By Mukund on 22.11.17 
	 * 
	 * https://smsgw.sms.gov.in/failsafe/HttpLink?username=nims.sms&pin=Qa%23%2412Ta&message=hi&mnumber=8527890793&signature=NICSMS 
	 * User Name : nims.sms 
	 * Password : Qa%23%2412Ta 
	 * Message : Any 
	 * Mobile No :Any
	 * Signature : NICSMS 
	 * 
