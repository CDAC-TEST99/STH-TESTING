...
public class HospitalMasterVO extends ValueObject
{
	...
	public void setAdCityId(String adCityId) {
		this.adCityId = adCityId;
	}

	public String getIsAdOffice() {
		return isAdOffice;
	}

	public void setIsAdOffice(String isAdOffice) {
		this.isAdOffice = isAdOffice;
	}
