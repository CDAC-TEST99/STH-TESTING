  <script src="/AHIMSG5/hislogin/transactions/js/cardMgmtListing.js"></script>
...
<section  class="pt-1 mt-1" style='min-height:100vh;letter-spacing: 1px;padding:15px;'> 
	<div class='row'>
		...
		<div class='col-md-2  mb-2 hideOnSearch' >
			...
			<div class='col-md-2  mb-2 hideOnSearch' >
			<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="applicationStatus">Application Status :</label>
              	<select class="form-control filters" id='applicationStatusserach' name="applicationStatusserach">
		...
		<div class='col-md-2  mb-2 hideOnSearch' >
			<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="applicationStatus">Type Of Application :</label>
              	<select class="form-control filters" id='renewalStatusserach' name="renewalStatusserach">
