  ...
  <main class="container my-5">
    <div class="row justify-content-center">
      <div class="col-md-10 col-lg-8">
        <div class="form-card">
          <h3 class="text-center mb-4 fw-bold">List of CGHS Wellness Centres</h3>
         ...
         <%--    <div class="mb-3">
              ...
              <select name="hosp" id="hospid" class="form-select">
                ...
                <option value="S">CGHS Wellness Centres</option>
              </select>
            </div> --%>

            <div class="form-group">
              <label for="cityDropdown" class="form-label fw-semibold">Select City</label>
              <select name="city_name" id="cityWcSelect" class="form-control">
