             		...
             		<div class='col-md-12 col-xl-6 welcomebg' >
             			<div class='row mt-5'>
							 		...
							 		<div class="col-12 text-center mt-1">
							 			...
							 			<h5 class="text-center mb-4 text-white">Please Change your Password</h5>
							 		</div>
                       ...
                       <div class="row justify-content-center mb-3">
						...
						<%	if (HISConfig.CAPTCHA_IMPLEMENTATION.equals("ON")) {%>
							  ...
							  <div class="col-3 group">
                                ...
                                <% if(request.getAttribute("LoginError") != null && request.getAttribute("LoginError").toString().trim().length() > 1){ %>
	 	...
	 	$("#loginid").click(function(event) {
	 	 ...
	 	 event.preventDefault();
			...
			if(mode != 'logout'){
			    	...
			    	var strSecureCode=$("#captchaResponse").val()+$("#varConfirmPassword").val()+$("#varNewPassword").val()+$("#varUserId").val()+$("#varUserName").val();
