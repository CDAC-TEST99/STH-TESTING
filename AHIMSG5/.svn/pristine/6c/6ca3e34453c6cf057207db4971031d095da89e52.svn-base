...
public class SMSServices {
	 ...
	 * 
	 */
	public static String sendBulkSMS(String username, String password , String message , String senderId, String mobileNumber, String secureKey){
		...
		try {
			...
			System.out.println("sendBulkSMS::"+responseString);
		} catch (NoSuchAlgorithmException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (KeyManagementException e) {
...
public static String sendBulkSMS(String username, String password , String message , String senderId, String mobileNumber, String secureKey , String url){
	 ...
	 * @param username : Department Login User Name
	 * @param password : Department Login Password
	 * @param message  : Unicode Message e.g. '� ¤µ� ¤¿� ¤� ¤¾� ¤¸ � ¤� ¤£� ¤¿ � ¤ª� ¥�?� ¤°� ¤� ¤¤ � ¤¸� ¤� ¤� ¤£� ¤¨ � ¤� ¥� ¤� ¤¦� ¥�?� ¤° � ¤®� ¤§� ¥�?� ¤¯� ¥ � ¤¸� ¥�?� ¤µ� ¤¾� ¤� ¤¤ � ¤� ¤¹� ¥'
	 * @param senderId	: Department allocated SenderID
	 * @param mobileNumber : Bulk Mobile Number with comma separated e.g. '99XXXXXXX,99XXXXXXXX' 
	 * @param secureKey :  Department key generated by login to services portal
	 * @return {@link String} response from Mobile Seva Gateway e.g. '402,MsgID = 150620161466003974245msdgsms' 
	...
	protected static String hashGeneratorForBulkSMS(String userName, String senderId, String content) {
		// TODO Auto-generated method stub
		StringBuffer finalString=new StringBuffer();
	 ...
	 * @param message e.g. 'ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂµÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¿ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¢ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¾ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¸ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ£ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¿ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂªÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃ¢â¬Å¡ÃâÃ¯Â¿Â½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ°ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃ¢â¬ï¿½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¤ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¸ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¡ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃ¢â¬ï¿½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ£ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¨ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¢ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¡ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¡ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¦ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃ¢â¬Å¡ÃâÃ¯Â¿Â½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ° ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ®ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ§ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃ¢â¬Å¡ÃâÃ¯Â¿Â½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¯ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¡ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¸ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃ¢â¬Å¡ÃâÃ¯Â¿Â½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂµÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¾ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃ¢â¬ï¿½ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¤ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃÂ¢ÃâÃ¢âÂ¬ ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¤ÃÆÃ¢â¬Å¡ÃâÃÂ¹ÃÆÃâ ÃÆÃ¢â¬Å¡ÃâÃÂ¥ÃÆÃÂ¢ÃâÃ¢âÂ¬ÃâÃÂ¡'
