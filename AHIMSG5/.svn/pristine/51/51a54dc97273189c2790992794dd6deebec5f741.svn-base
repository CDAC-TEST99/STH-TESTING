  <script src="/AHIMSG5/hislogin/transactions/js/registrationListing.js"></script>
...
<section  class="pt-1 mt-1" style='min-height:100vh;letter-spacing: 1px;padding:15px;'> 
	<div class='row'>
		<div class='col-md-3' style="margin-top: -7px;margin-left: -34px;">
			<span class="badge bg-light text-primary"><h5 class='mt-1' id='listModuleTitle'></h5></span>
		</div>
	   <div class='col-md-4  mb-2'>
	    	<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="Search">Search :</label>
			
		<div class="input-group mb-2">
		  <div class="input-group-text" style="padding: 0;background: #fff;border: 0;">
    		<select class="form-select" style="margin-right: 5px;width: 40%;" id='searchBy' name='searchBy'>
    			<option value="beneficiaryId" selected="selected">Ben. ID</option>
    			<option value="mobile">Mobile No.</option>
    			<option value="apt">Appointment No.</option>
    			<!-- <option value="benName">Ben. Name</option> -->
    		</select>
    		<input type='text' maxlength="20" style="width: 60%;" class='form-control' placeholder='Enter Ben ID Here' id='search' name='search' aria-label='Search' aria-describedby='input-group-right'>
    		<span class='input-group-text' id='btnSearch' style="height: 36px;width: 10%;" id='input-group-right-example' ><i class='fa-solid fa-magnifying-glass fa-fw'></i></span>    		
  		  </div>
		</div>		
		...
		<div class='col-md-3  mb-2 hideOnSearch' >
			<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="patDOB">Date :</label>
              	<input type="text" class="form-control form-control" maxlength="11" readonly="true" id='filterDate'   name='filterDate'  placeholder="dd-Mon-yyyy">
	...
	<div class='row  hideOnSearch' id='divrowkpis' style="text-align: right;">
		<div class='col-md-12' id='divKpis'><h6>
		<span class='text-danger kpi'> Total Patients : <span class='kpiNum' id='kpiTotalPatient'></span></span>&nbsp;|&nbsp;
		<span class='text-success kpi'> Total Appointment Visit : <span class='kpiNum' id='kpiAppointmentPatient'></span></span>&nbsp;|&nbsp;
		<span class='text-primary kpi'>Total WalkIn Visit : <span class='kpiNum' id='kpiWalkIn'> </span></span>
		</h6></div> 
	</div>
   ...
   <div class="row" style="margin-top: -22px;">
       ...
       <div class="col-md-12  no-more-tables">
       	<table class="table table-striped border" id='tbl_registration_List'><thead></thead><tbody></tbody></table>
       </div>
