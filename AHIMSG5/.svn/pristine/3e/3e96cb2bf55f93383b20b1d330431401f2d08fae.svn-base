...
<nav class="navbar navbar-expand-lg navbar-light  bg-white w-100" style="padding: 0px;border-bottom: 1px solid #e0e0e0;">
   ...
   <div class="container-fluid position-absolute mt-5" id="seatBox">
							...
							<% } else {  %>
							    ...
							    <div class="col-12">
	                               		...
	                               		<div class="group">
											...
											<input class="input" type="text" name="varUserId" id="varUserId" placeholder="Enter Email Id / User Id" maxlength="50" data-validation="mandatory">
    ...
    <% if(request.getSession().getAttribute("otpValidationKey") != null && request.getSession().getAttribute("otpValidationKey").toString().length() > 0 ){  %>
      ...
      <button class="btn-his"   id="validateButton" >Submit OTP</button>
  
      
      <%}else{
    	 %> 
    	    <button class="btn-his"  style="width: 30%;" type="button" tabindex="4" value="Verify" id="generateButton" >Get OTP</button>
     <% }
    %>
