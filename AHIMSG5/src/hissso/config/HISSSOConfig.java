...
public abstract class HISSSOConfig
{
	...
	public static int LOGIN_USER_SESSION_SALT_BYTE_SIZE = 24; // Good Size
		// Ticket Expiration
	public static int SSO_TICKET_EXPIRY_IN_SECONDS_TGT = 9000;		// 60 Minutes// Modified to 5 hours by Anjali- 01-10-2020
	public static int SSO_TICKET_EXPIRY_IN_SECONDS_ST = 9000;		// 20 Minutes  Changed to 10 mins. - Deepti 01.02.2020// MOdified to 2 hrs by Anjali- 01-10-2020
	...
	public static int LOGIN_LOCK_AFTER_UNSUCCESSFUL_LOGIN_COUNT = 5;  //Changed from 3 to 20 by Garima for AIIMS Requirement discussed with Cheema Sir on 1st Nov 2018
		// Authorization
