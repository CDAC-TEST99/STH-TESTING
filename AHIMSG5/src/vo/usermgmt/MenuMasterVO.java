...
public class MenuMasterVO extends ValueObject implements Serializable
{
	...
	private String varManualContext;//Added by Anjali-18-03-2020
	@XmlElement
	private String varModuleName;
	private String varHospitalCode;
	private String varUserId;
	private String varManualFileName;
	
	private String gstrVidTutorialUrl;
	private String gstrDocFileName;
	
	public String getVarManualContext() {
		return varManualContext;
	}

	public void setVarManualContext(String varManualContext) {
		this.varManualContext = varManualContext;
	}

	/*Added by Anjali*/
	public String getVarManualFileName() {
		return varManualFileName;
	}

	public void setVarManualFileName(String varManualFileName) {
	...
	public String getgstrVidTutorialUrl() {
		return gstrVidTutorialUrl;
	}

	public void setgstrVidTutorialUrl(String gstrVidTutorialUrl) {
		this.gstrVidTutorialUrl = gstrVidTutorialUrl;
	}
	
	
	public String getgstrDocFileName() {
		return gstrDocFileName;
	}

	public void setgstrDocFileName(String gstrDocFileName) {
		this.gstrDocFileName = gstrDocFileName;
	}
