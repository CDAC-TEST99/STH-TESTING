...
public class LoginFeaturesDATA
{
	...
	public static UserMasterVO getValidForgotDetail(LoginVO voLogin) throws HISDataAccessException
	{
		...
		try
		{
			System.out.println("validatepassword>>data");
			UserManagementBO objBusiness = new UserManagementBO();
	...
	public static UserMasterVO changeForgotPassword(UserMasterVO voUser) throws HISDataAccessException
	{
		System.out.println("savepassword>>data");
		try
		{
			UserManagementBO objBusiness = new UserManagementBO();
			voUser = objBusiness.updateForgotPassword(voUser);
		}
		catch(Exception e)
		{
			voUser = null;
	...
	public static UserMasterVO addUpdateMobileNo(UserMasterVO voUser) throws HISDataAccessException
	{
		try
		{
			
			UserManagementBO objBusiness = new UserManagementBO();
			voUser = objBusiness.addUpdateMobileNo(voUser);
		}
		catch(Exception e)
		{
			voUser = null;
	...
	public static List<UserMasterVO> getUserDetail(String varUserName) {
		
		List<UserMasterVO> userMasterVos = null;
		
		try
		{
			UserManagementBO objBusiness = new UserManagementBO();
			userMasterVos = objBusiness.getUserDetail(varUserName);
		}
		catch(Exception e)
		{
			userMasterVos = null;
