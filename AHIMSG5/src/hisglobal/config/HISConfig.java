...
public abstract class HISConfig
{
	...
	public static String HIS_SNOMEDCT_INTERNAL_URL = "/AHIMSG5/snomedct"; //like ""http://10.11.12.13:1415" // Should not be Used for Internal REST Services 
	...
	public static String HIS_SNOMEDCT_SERVER_URL = "http://localhost:8080" ; //like ""http://10.11.12.13:1415" // Should not be Used for Internal REST Services Call
...
//	public static String SYSDATE_OBJECT = "keySystemDateObject";
	public static String CAPTCHA_IMPLEMENTATION="ON";
	...
	//**Get path for server dynamically
	public static String NIS_URL = HisUtil.getParameterFromHisPathXML("HIS_SERVER_URL_NIS");
	public static String HMIS_LITE_URL = HisUtil.getParameterFromHisPathXML("HIS_SERVER_URL_HMIS_LITE");
	public static String HMIS_OFFLINE_URL = HisUtil.getParameterFromHisPathXML("HIS_SERVER_URL_HMIS_OFFLINE");
