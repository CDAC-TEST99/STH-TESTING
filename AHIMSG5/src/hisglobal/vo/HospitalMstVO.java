...
public class HospitalMstVO extends ValueObject {
	...
	private String varIsLogoRequired;
	private String varLogoType;
	private String varStrLogoFileName;
	...
	public String getVarIsLogoRequired() {
		return varIsLogoRequired;
	}
	public void setVarIsLogoRequired(String varIsLogoRequired) {
		this.varIsLogoRequired = varIsLogoRequired;
	}
	public String getVarLogoType() {
		return varLogoType;
	}
	public void setVarLogoType(String varLogoType) {
		this.varLogoType = varLogoType;
	}
	public String getVarStrLogoFileName() {
		return varStrLogoFileName;
	}
	public void setVarStrLogoFileName(String varStrLogoFileName) {
		this.varStrLogoFileName = varStrLogoFileName;
	}
}
