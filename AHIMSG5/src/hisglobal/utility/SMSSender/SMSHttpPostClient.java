...
//	rajmsdg-rmsc$cdac@2013$RAJSMS
	...
	static String username = "nims";
	static String password = "Cd-nims123";
	static String senderid = "CDNIMS";
	...
	/*public static void main(String[] args) 
	{
		try 
		{
			sendSingleSMSThroughSMSGateway(username, password, senderid, mobileNo, message);
	...
	public static void sendSMSThroughNICGateway(String username,String password, String senderId,String sms_URL,String mobileNo, String message) 
	{
		DataOutputStream output =null;
		try 
		{
