...
<script type="text/javascript" src="/HIS/hisglobal/utility/dynamicdesk/js/jquery.min.js"></script>
 ...
 <!-- <script type="text/javascript" src="/HIS/hisglobal/js/avai/util.js"></script> -->
	...
	<BODY  style="background: linear-gradient(to bottom, #E7EFF2 , #FFF ) transparent;">
		...
		StringBuffer str1=new StringBuffer();
		 if(session.getAttribute(HISLoginConfig.LOGGEDIN_USER_SELECTED_MENU_PROCESS_LIST)!=null)
		 {
			 ...
			 str1.append(UserDeskUTL.generateManualList(session));	
			 /* StringBuffer str1=new StringBuffer();
			 if(session.getAttribute(HISLoginConfig.LOGGEDIN_USER_SELECTED_MANUAL_PROCESS_LIST)!=null)
			 {
				 str1.append(UserDeskUTL.generateManualList(session));
			 } */
		 }
...
<script type="text/javascript" src="/AHIMSG5/hissso/js/base64.js"></script>
