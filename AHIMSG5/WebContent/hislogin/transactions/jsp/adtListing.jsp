  <script src="/AHIMSG5/hislogin/transactions/js/adtListing.js"></script>
   <script src="/AHIMSG5/hislogin/transactions/js/security.js"></script>
   
  
<form id="adtList"  method='POST'>
<section  class="pt-1 mt-1 bg-white" style='min-height:100vh;letter-spacing: 1px;padding:15px;'> 
	<div class='row'>
	    <div class='col-md-3  mb-2'>
			...
			<div class='input-group'>
				<input type='text' class='form-control' placeholder='Name/CRNO/Mobile/ABHA ' id='search' name='search' aria-label='Username' aria-describedby='input-group-right'>
	...
	<div class='row  hideOnSearch' id='divrowkpis' style="text-align: right;">
		...
		<span class='text-primary kpi'> Admission : <span class='kpiNum' id='kpiNewPatient'></span></span>&nbsp;|&nbsp;
		<span class='text-success kpi'> Discharge : <span class='kpiNum' id='kpiRevisitedPatient'></span></span>&nbsp;|&nbsp;
		<span class='text-danger kpi'>Cash Collected (Rs.) : <span class='kpiNum' id='kpiCashCollected'> </span></span>
		</h6></div>
	</div>
   <div class="row">
       ...
       <div class="col-md-12  no-more-tables">
       	<table class="table table-striped border" id='tbl_Adt_List'><thead></thead><tbody></tbody></table>
       </div>
       </div>
    </div>
    <div class="row">
