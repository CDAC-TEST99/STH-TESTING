	...
	<div class="div-table" >
		<div class="div-table-row " >
			<div class="div-table-col title width100 " >
					<sapn key='user-login-details'>User Login Details</sapn>
			</div>
		</div>
		<div class="div-table-row " >
			<div class="div-table-col subtitle width100 " >
					<sapn key='hello'>Hello !!!</sapn><s:property value="varUsrName" /><sapn key='please-change-your-password-details-on-first-login'>, Please Change your Password Details On First Login</sapn>
			</div>
		</div>
		<div class="div-table-row ">
			<div class="div-table-col width40 label" >
				<font color="red">*</font><sapn key='hint-question'>Hint Question</sapn>
			</div>
		...
		<div class="div-table-row ">
			<div class="div-table-col width40 label" >
				<font color="red">*</font><sapn key='answer'>Answer</sapn> 
			</div>
			<div class="div-table-col width60 control" >
		...
		<div class="div-table-row ">
			<div class="div-table-col width40 label" >
				<font color="red">*</font><sapn key='new-password'>New Password</sapn>
			</div>
			<div class="div-table-col width60 control" >
				<input type="password" name="varPassword" tabindex="1" value="" maxlength="10" id="varPassword" autocomplete="off">
			</div>
		</div>
		<div class="div-table-row ">
			<div class="div-table-col width40 label" >
				<font color="red">*</font><sapn key='confirm-new-password'>Confirm New Password</sapn>
			</div>
			<div class="div-table-col width60 control" >
				<input type="password" name="varConfirmPassword" tabindex="1" value="" maxlength="10" id="varConfirmPassword" autocomplete="off">
			</div>
		</div>
		<div class="div-table-row ">
			<div class="div-table-col width100 label" >
				<font color='red'>
					<br>
		     		<sapn key='the-password-is-case-sensitive'>The Password is case sensitive.</sapn> 
		     	</font>
		     </div>
		</div>
	</div>
...
var firstLoginUserDetail = {
		...
		secureAnswer : function()
		{
			...
			try 
			{
				hashValue = objPassHash.getHash("SHA-2", "HEX");
			} 
			catch(e)
			{
				return false;
	...
	$('[name="varPassword"]').validatebox({
		required: true,
		validType : [ 'alphaSpecialChar', 'minLength[6]', 'maxLength[10]' ]
	});
