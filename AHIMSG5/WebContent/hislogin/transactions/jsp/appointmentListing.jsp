...
<script src="/AHIMSG5/hislogin/transactions/js/appointmentListing.js"></script>
<script src="/AHIMSG5/hislogin/transactions/js/security.js"></script>

<form id="appointmentList" method='POST'>
	<section class="pt-1 mt-1 bg-white" style='min-height: 100vh; letter-spacing: 1px; padding: 15px;'>
		...
		<div class='row  hideOnSearch' id='divrowkpis'
			...
			<div class='col-md-12' id='divKpis'>
				<h6>
					<span class='col-2 p-3 text-primary kpi'> Pending Patients :<span
						class='kpiNum' id='kpiPendingPatientApptId'></span></span>&nbsp;&nbsp;
					|&nbsp;&nbsp; <span class='col-2 p-3 text-success kpi'>
						Confirmed Patients : <span class='kpiNum'
						id='kpiConfirmedPatientApptId'></span>
					</span>&nbsp;&nbsp; |&nbsp;&nbsp; <span class='col-2 p-3 text-info kpi'>Total
						Patients : <span class='kpiNum' id='kpiTotalPatientApptId'></span>
					</span>
				</h6>
			</div>
		</div>
		<div class="row" style="margin-top: -15px;">
			...
			<div class="col-md-12  no-more-tables">
					<table class="table table-striped border" id='tbl_appointment_List'>
						<thead></thead>
						<tbody></tbody>
					</table>
			</div>
		...
		<div class="row ">
			<div class="col-md-12 alert alert-info" id='dataMsg'
