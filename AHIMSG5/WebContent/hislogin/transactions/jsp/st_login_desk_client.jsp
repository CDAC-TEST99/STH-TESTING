...
<!-- Preloader Start -->
   ...
   <nav class="navbar navbar-expand-lg navbar-light  bg-white w-100" style="padding: 10px;border-bottom: 1px solid #e0e0e0;z-index:999;">
	...
	<div class='col-lg-2 col-md-12 col-sm-12 col-12 ' style="padding-left: 27px;">
	<a class="navbar-brand" href="/AHIMSG5/hissso/Login">
    	...
    	<% 
    			String clientHeading=session.getAttribute("HOSPITAL_NAME").toString();    					 
        %>
    <div class='col-lg-4 col-md-12 col-sm-12 col-12 ' style="text-align: center;">
    		<span class='clientHeading'><%=clientHeading %></span>			
	</div>
	<div class='col-lg-4 col-md-4 col-sm-4 col-4 ' style="text-align: right;padding-top: 14px;">
  				...
  				<button class="btn-his-sm " style='display: none;' id='btnShowVidTutorial'  title="Watch Tutorial" ></button>
  				<button class="btn-his-sm " style='display: none;' id='btnShowManual'  title="User Manual" ></button>
	</div>
    ...
    <section class="p-0" id='sectionModules'>
 	<div class='row'>
	    <div class='col-1 d-none d-md-block' id='modules' style="border-right: 1px solid #e0e0e0;">
	    </div>
	    
	   <div class='col-lg-11 col-md-12 col-sm-12 col-12 ' id='divDeskListingContainer'  style="display: none;">
	    	
	    </div>
	    
		<div class='col-lg-11 col-md-12 col-sm-12 col-12 ' id='divMenuContainer'>
    		<div class='row  mt-1 d-block d-md-none ' >
	    		<div class='col-lg-11 col-md-9 col-sm-9 col-9 p-3'>
	    			<select class="form-select" id="moduleId" name="moduleId">
					  <option selected="All">Select Module</option>
	    	...
	    	<div class='row  mt-1 ' >
	    		<div class='col-lg-4 col-md-9 col-sm-9 col-9'>
	    			<div class="input-group">
						  <input type="text" class="form-control" placeholder="Search Processes" id='search' name="search">
						  <span class="input-group-text" id="input-group-right-example"><i class="fa-classic fa-solid fa-magnifying-glass fa-fw"></i></span>
						</div>
	    		</div>
	    		<div class='col-lg-1 col-md-1 col-sm-1 col-1'>
	    			<button class='btn-his-outline-sm'id="btnResetSearch" onclick="resetSearch()">Clear</button>
	    		</div>
	    		
	    		<%String notification= HisUtil.getParameterFromHisPathXML("HIS_NOTIFICATION_MORQUE"); 
				if(notification!=null && !notification.trim().equals("")){
				
				%>
				<div class='col-lg-7 col-md-9 col-sm-9 col-9'>
						<p style="background:#ec1a47;color:#fff;padding: 9px;font-weight: bold;font-size: 11px;">
							<%=notification %>
						</p>
				</div>		
						 <%} %>
	    	...
	    	<div style='width:100%'>
	    	<div class='container  mt-1 ' style="display:none;" id='mainContainerSearch_heading'><h2 class='processTypeHeading'>Search Result</h2></div>
		    <div id="mainContainerSearch" style="display:none;" class='container moduleContainer'>
		    	<div class='row' id='rowSearch'>
		    	</div>
		    </div>
	    	
		    <div class='container  mt-1 ' id='mainContainer_Services_heading'><h2 class='processTypeHeading'><span class='processTypeHeadingModule'></span>&nbsp; Services</h2></div>
		    <div id="mainContainer_Services" class='row moduleContainer'>
		    </div>
		    <div class='container  mt-1' id='mainContainer_Reports_heading'><h2 class='processTypeHeading'><span class='processTypeHeadingModule'></span>&nbsp; Reports</h2></div>
		    <div id="mainContainer_Reports" class='row moduleContainer'>
		    </div>
		    <div class='container  mt-1' id='mainContainer_Setup_heading'><h2 class='processTypeHeading'><span class='processTypeHeadingModule'></span>&nbsp; Setup</h2></div>
		    <div id="mainContainer_Setup" class='row moduleContainer'>
		    </div>
	    </div>
	    </div>
  	</div>  
			...
			if(zeroLevelModules!=null){
				...
				for (Map.Entry set : moduleSet ) {
					org.json.JSONObject objModule= new org.json.JSONObject(); 
			  		...
			  		//System.out.println("arrModData === /n  " +arrModData);
					  		...
					  		for (Map.Entry firstLevelSet : columnFirstLevelSet){
								...
								if(firstLevelSet.getValue()  instanceof String){
									...
									String font_icon_name=leafJson.getString("menuClassId")!=null && !leafJson.getString("menuClassId").equals("")?leafJson.getString("menuClassId"):"";
										...
										String vidTutorialUrl=leafJson.getString("vidTutorialUrl");
										String docFileName=leafJson.getString("docFileName");
										...
										objJsonMenu.put("vidTutorialUrl", vidTutorialUrl);
										objJsonMenu.put("docFileName", docFileName);
									 ...
									 for (Map.Entry secondLevelSet : columnSecondLevelSet){
											...
											org.json.JSONObject objJsonMenuLevel2= new org.json.JSONObject();
											 if(secondLevelSet.getValue()  instanceof String){
												...
												String vidTutorialUrl=leafJsonsecondLevel.getString("vidTutorialUrl");
												String docFileName=leafJsonsecondLevel.getString("docFileName");
												System.out.println("vidTutorialUrl leafJsonsecondLevel ===  " + vidTutorialUrl +"docFileName ===  "+ docFileName);
												//noOfLeafNodeInModule++;
												...
												objJsonMenuLevel2.put("vidTutorialUrl", vidTutorialUrl);
												objJsonMenuLevel2.put("docFileName", docFileName);
