...
<script src="/AHIMSG5/hislogin/transactions/js/billingListing.js"></script>
<script src="/AHIMSG5/hislogin/transactions/js/security.js"></script>


<form id="billList" method='POST'>
	<section class="pt-1 mt-1 bg-white"
		...
		<div class='row  hideOnSearch' id='divrowkpis'
			...
			<div class='col-md-12' id='divKpis'>
				<h6>
					<span class='col-2 p-3 text-primary kpi'> Bill Requests
						Pending :<span class='kpiNum' id='kpiNewPatient'></span>
					</span>&nbsp;|&nbsp; <span class='col-2 p-3 text-success kpi'>
						Billing Done : <span class='kpiNum' id='kpiRevisitedPatient'></span>
					</span>&nbsp;|&nbsp; <span class='col-2 p-3 text-success kpi'>Cash
						Collected (Rs.) : <span class='kpiNum' id='kpiCashCollected'>
					</span>
					</span>
				</h6>
			</div>
		...
		<div class="row">
			<div class="table-wrapper">
				...
				<div class="col-md-12  no-more-tables">
					<table class="table table-striped border" id='tbl_Billing_List'>
						<thead></thead>
						<tbody></tbody>
					</table>
				</div>
