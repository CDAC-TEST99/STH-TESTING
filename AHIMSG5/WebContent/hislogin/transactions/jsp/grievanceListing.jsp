  ...
  <script src="/AHIMSG5/hislogin/transactions/js/grievanceListing.js"></script>
...
<section  class="pt-1 mt-1" style='min-height:100vh;letter-spacing: 1px;padding:15px;'> 
	<div class='row'>
	    <div class='col-md-3  mb-2'>
			...
			<div class='input-group'>
				<input type='text' class='form-control' placeholder='Grievance ID/Grievance/City' id='search' name='search' aria-label='Username' aria-describedby='input-group-right'>
		...
		<div class='col-md-6' style='text-align:right' id='divbuttons'></div>
	</div>
	<!-- <div class='row  hideOnSearch' id='divrowkpis' style="text-align: right;display:none;">
   ...
   <div class="row">
       ...
       <div class="col-md-12  no-more-tables">
       	<table class="table table-striped border" id='tbl_Grievance_List'><thead></thead><tbody></tbody></table>
       </div>
       </div>
    </div>
