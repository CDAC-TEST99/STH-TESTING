  <script src="/AHIMSG5/hislogin/transactions/js/pharmacyListing.js"></script>
   <script src="/AHIMSG5/hislogin/transactions/js/security.js"></script> 
   
  
<form id="regList"  method='POST'>
<section  class="pt-1 mt-1 bg-white" style='min-height:100vh;letter-spacing: 1px;padding:15px;'> 
	<div class='row'>
	    <div class='col-md-3  mb-2'>
	    	<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="patDOB">Search :</label>
			<div class='input-group'>
				<input type='text' class='form-control' placeholder='Name/BEN ID./Mobile/ABHA ' id='search' name='search' aria-label='Username' aria-describedby='input-group-right'>
		...
		<div class='col-md-1 mt-5 mb-2' style="display:none"  id='divResetFilter'>
	...
	<div class='row  hideOnSearch' id='divrowkpis' style="text-align: right;">
		...
		<span class='col-2 p-3 text-primary kpi'> New Patient : <span class='kpiNum' id='kpiNewPatient'></span></span>&nbsp;|&nbsp;
		<span class=' col-2 p-3 text-success kpi'> Revisited Patient : <span class='kpiNum' id='kpiRevisitedPatient'></span></span>&nbsp;|&nbsp;
		<span class='col-2 p-3 text-info kpi'>Created ABHA : <span class='kpiNum' id='kpiCreatedABHA'></span></span>&nbsp;|&nbsp;
		<span class='col-2 p-3 text-warning kpi'>Linked ABHA : <span class='kpiNum' id='kpiLinkedABHA'> </span></span>&nbsp;|&nbsp;
		<span class=' col-3 p-3 text-danger kpi'>Cash Collected (Rs.) : <span class='kpiNum' id='kpiCashCollected'> </span></span>		
		</h6></div>
	</div>
   <div class="row">
