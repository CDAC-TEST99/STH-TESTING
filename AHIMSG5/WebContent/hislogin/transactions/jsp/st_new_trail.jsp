...
<script type="text/javascript" src="/AHIMSG5/hissso/js/security.js"></script>
    ...
    <script type="text/javascript">
                       ...
                       current_fs = $(this).closest("fieldset");
                        ...
                        if (current_fs.attr("id") == 'accountfs') {
                           ...
                           // 		alert(JSON.stringify(form.serialize()))
                            		...
                            		$.ajax({
                            	        type:"POST",
                            	        url:'/AHIMSG5/hislogin/saveTrailRequestLgnFtr',
                            	        data:form.serialize(),
        ...
        function validatePhone(id , label) {
            ...
            var regex = /^\(?([7-9]{1})\)?([0-9]{2})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/;
			        ...
			        <div class="card" style="border-radius: 1rem;">
			          <div class="row g-0">
			            <div class="col-md-5 col-lg-4 d-none d-md-block" id='contactimgId'>
			              <img src="/HIS/hisglobal/images/e-clinic/freeTrial.png"
			            ...
			            <div class="col-md-7 col-lg-8  align-items-center" id='contactcontentId'>
			              <div class="card-body">
			                  ...
			                  <h5 class="fw-normal mt-3 mb-3 pb-3 text-center" style="letter-spacing: 1px;">Free Trail Request</h5>
                             ...
                             <div class="col-md-12 col-lg-12  align-items-center">
                             	<fieldset id='accountfs' > 
		                                        ...
		                                        <div class="row justify-content-center">
		                                            <div class="col-7 text-center">
		                                                <h4>Your Enquiry have been registered, your enquiry id is <span id='regId' ></span></h4>
				                                                <h6>
				                                                    <font color='red'>you will receive trail login credentials, once your request have been approved.
				                                                    </font>
				                                                </h6>
		                                            </div>
                                    ...
                                    <input type="button" name="next" id="idCancel" onclick="$('#idCancel').trigger('click');"
                                        class="next action-button" value="Close" />
