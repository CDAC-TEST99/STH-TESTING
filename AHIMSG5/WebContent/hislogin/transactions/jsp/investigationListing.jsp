...
<script src="/AHIMSG5/hislogin/transactions/js/investigationListing.js"></script>
<script src="/AHIMSG5/hislogin/transactions/js/security.js"></script>


<form id="invList"  method='POST'>
<section class="pt-1 mt-1 bg-white"
	...
	<div class='row  hideOnSearch' id='divrowkpis'
		...
		<div class='col-md-12' id='divKpis'>
			<h6>
				<span class='col-2 p-3 text-primary kpi'>Test Orders :<span
					class='kpiNum' id='kpiNewPatient'></span></span>&nbsp;|&nbsp; <span
					class='col-2 p-3 text-success kpi'>Sample Collected : <span
					class='kpiNum' id='kpiRevisitedPatient'></span></span>&nbsp;|&nbsp; <span
					class='col-2 p-3 text-warning kpi'>Report Available : <span
					class='kpiNum' id='kpiCreatedABHA'></span></span>&nbsp;|&nbsp; <span
					class='col-2 p-3 text-danger kpi'>Total Tests : <span
					class='kpiNum' id='kpiCashCollected'></span></span>
			</h6>
		</div>
	</div>
	<div class="row">
	...
	<input type='hidden' id='currentDate' name="currentDate"> <input
		type='hidden' name="fhttf" id='fhttf' />
