...
<nav class="navbar navbar-expand-lg navbar-light  bg-white w-100" style="padding: 0px;border-bottom: 1px solid #e0e0e0;">
   ...
   <div class="container-fluid position-absolute mt-5" id="seatBox">
             		...
             		<div class='col-md-12 col-xl-6 welcomebg' >
             			<div class='row mt-5'>
							 		...
							 		<div class="col-12 text-center mt-1">
							 			<h1 class="mb-4 text-warning">Welcome to Beneficiary User Unlock </h1>
    ...
    <% if(request.getSession().getAttribute("otpValidationKey") != null && request.getSession().getAttribute("otpValidationKey").toString().length() > 0 ){  %>
      ...
      <button class="btn-his"   id="validateButtonBenOTP" >Submit OTP</button>
  
      
      <%}else{
    	 %> 
    	    <button class="btn-his"  style="width: 30%;" type="button" tabindex="4" value="Verify" id="generateButtonBenOTP" >Get OTP</button>
     <% }
    %>
 ...
 $(document).ready(function(event){
	 	...
	 	$("#generateButtonBenOTP").click(function(event) {
		...
		$("#validateButtonBenOTP").click(function(event) {
