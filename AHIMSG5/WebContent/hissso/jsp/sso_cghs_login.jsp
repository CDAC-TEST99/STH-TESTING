             		...
             		<div class='col-md-12 col-xl-6 welcomebg' >
             			<div class='row mt-5'>
							 		...
							 		<div class="col-12 text-center mt-1">
							 			<h1 class="mb-4 text-warning">Welcome to <br/> CGHS Staff Login</h1>
                ...
                <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                     ...
                     if(session.getAttribute("mstatus") == null || session.getAttribute("mstatus").toString().trim().length() == 0){     %>
                        ...
                        <button class="nav-link active" id="nav-user-tab" data-bs-toggle="tab" data-bs-target="#navUser" type="button" role="tab" aria-controls="navUser" aria-selected="false">User Login</button>
                   	<% } %>
                   
                   <% 
                   if(session.getAttribute("PatmobileNumber") == null || session.getAttribute("PatmobileNumber").toString().trim().length() == 0){   
    ...
    <!-- User Login Tab --> 
      ...
      if(session.getAttribute("mstatus") == null || session.getAttribute("mstatus").toString().trim().length() == 0){  %> 
             ...
             <%--        <% if ( session.getAttribute("LoginError") != null) {
                       ...
                       <s:form action="NewloginValidateOTPLogin" method="post" id="loginForm" class="form">
                         <% if(request.getSession().getAttribute("otpValidationKey") != null && request.getSession().getAttribute("otpValidationKey").toString().length() > 0 && request.getSession().getAttribute("USERlOGIN") != null ){  %>
							 ...
							 <div class="row justify-content-center mb-3">
							        ...
							        <div class="col-12">
                               		 ...
                               		 <%--  <div class="col-12" style="display:none;">
	                               		<div class="group">
	                               			<i class="fas fa-mobile icon" ></i>
											<input class="input" type="text" name="varMobileNumber" readonly value="<%=request.getSession().getAttribute("otpValidationKey") %>"  placeholder="Enter Mobile No." maxlength="10" data-validation="mandatory,mobile">
							    ...
							    <div class="row justify-content-center mb-3" id="otPRow" style="display: ;">
							    	<div class="col-6">
                              		 ...
                              		 <div class="col-6">
	                               		 <button class="btn-his"  id="resendButton" onclick="submitLoginForm1('mloginLogin',event);">Resend OTP</button>                        
                              			 <div id='otpCountDisplay'></div>	
                              		 </div>
							    </div>
							       
							        	<div class="text-center">
										 <button class="btn-his"   id="validateButton" onclick="return submitFormOnValidateOtp(submitValidateOtpTest(), 'NewloginValidateOTPLogin');" >Submit OTP</button>
										<button class="btn-his-outline" type="button"   style="width: 30%;"  tabindex="4" value="Home" id="homeId" onclick="return submitFormOnValidate(true,'Login');">Home</button>
                       ...
                       <div class="row justify-content-center mb-3">
                                <div class="col-12">
                               		<div class="group">
										...
										<input class="input" type="text" name="varUserName" id="varUserName" maxlength="50" placeholder="Enter User ID" required autocomplete="off">
									</div>                                   
                                </div>
                            </div>
							  ...
							  <div class="col-3 group">
                                ...
                                <div class="col-9">
                                	<div class="group">
										...
										<input class="input" type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="captchaResponse" id="captchaResponse" maxlength="3" placeholder="Enter Captcha" onclick="return submitFormOnValidate(validate(),'loginLogin');"  required autocomplete="off">
									</div> 
								</div>	
                            </div>
                            	...
                            	<div class="text-center">
										<button class="btn-his" type="button"   style="width: 30%;"  tabindex="4"  value="Login" id="loginid" onclick="return submitFormOnValidate(validate(),'loginLogin');">Login</button>
										<button class="btn-his-outline" type="button"   style="width: 30%;"  tabindex="4" value="Home" id="homeId" onclick="return submitFormOnValidate(true,'Login');">Home</button>
                       	...
                       	<%} else{ %>
                                ...
                                <%} %>  
							 	...
							 	<div class="mt-4" style="text-align: right;">
										...
										<span id='forgetPass' style="color: blue;cursor:pointer;" title="Click Here to Reset Password" >Forgot Password?</span>
...
<% } %>
  ...
  <% if(session.getAttribute("PatmobileNumber") == null || session.getAttribute("PatmobileNumber").toString().trim().length() == 0){  %>
							 ...
							 <div class="row justify-content-center mb-3">
							    ...
							    <div class="row justify-content-center mb-3" id="otPRow" style="display: ;">
							    	<div class="col-6">
                              		 ...
                              		 <div class="col-6">
	                               		 <button class="btn-his" style="background-color: orange; border-color: orange;color: black;"  id="resendButton" onclick="return submitFormOnValidate2(validate(),'mloginLogin');">Resend OTP</button>                        
                              			 <div id='otpCountDisplay'></div>	
                              		 </div>
							...
							<% }    %>
							 ...
							 --%>
							   ...
							   <% if ( session.getAttribute("LoginError") != null && session.getAttribute("LoginError").toString().length() > 1 && request.getSession().getAttribute("USERlOGIN") == null ) { %>
  ...
  <div class="text-center mt-4">
    <% if(request.getSession().getAttribute("otpValidationKey") != null && request.getSession().getAttribute("otpValidationKey").toString().length() > 0 && request.getSession().getAttribute("USERlOGIN") == null ){  %>
      ...
      <button class="btn-his"   id="validateButton" onclick="return submitFormOnValidateOtp(submitValidateOtpTest(),'mloginValidateOtpLogin');" >Submit OTP</button>
      <button class="btn-his-outline" type="button"   style="width: 30%;"  tabindex="4" value="Home" id="homeId" onclick="return submitFormOnValidate(true,'Login');">Home</button>
      ...
      <%} 		 
    	 ...
    	 %> 
    	    <button class="btn-his"   type="button" tabindex="4" value="Verify" id="generateButton" onclick="return submitFormOnValidate2(validate(),'mloginLogin');">Get OTP</button>
    	    <button class="btn-his-outline" type="button"   style="width: 30%;"  tabindex="4" value="Home" id="homeId" onclick="return submitFormOnValidate(true,'Login');">Home</button>
     <% }
    %>
   ...
   <input type="hidden"  id="resendClickCount" value="0"/>
											...
											<%-- <label type="show" name="LoginError" id='LoginError'	<%=( session.getAttribute("LoginError") != null ? session.getAttribute("LoginError") : "" )%>> --%>
