...
<footer>
		<div class="container px-5">
			...
			<div class="item mx-md-3 mx-0 text-center">	<a href="https://www.india.gov.in/national-health-portal?page=1"
					target="_blank"><img
					src="/AHIMSG5/hissso/portal/images/logos/nhp.png" /></a>
					</div>
			...
			<div class="row my-5">
				<div class="col-md-9">
					<div class="footer-links">
						<h4 class="" data-lang-key='ImportantLinks'>Important Links</h4>
						  <ul class="list-unstyled pt-3 mb-1 d-lg-flex d-block align-items-md-center">
							<li class="pe-2"><a href="javascript:void(0)"
								onclick="openCustomPopup('content1')">Privacy Policy </a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content2')">Disclaimer</a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content3')">Hyper Linking Policy</a></li>
								<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content4')">CopyRight Policy </a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content5')">Content Review Policy</a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content6')">Content Contribution</a></li>
						</ul>
					  <ul class="list-unstyled pt-3 mb-1 d-lg-flex d-block align-items-md-center">
							<li class="pe-2"><a href="javascript:void(0)"
								onclick="openCustomPopup('content7')">Content Archival
									Policy </a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content8')">CGHS Password and
									Authentication Policy</a></li>
							<li><a href="javascript:void(0)"
								onclick="openCustomPopup('content9')">Accessibility
									Statement</a></li>
						</ul>
				...
				<div class="col-md-3">
					<div class="box wow fadeInLeft">
						<p class="m-0 fw-semibold me-2 text-white mb-3"
							data-lang-key='AlsoAvailableOn'>Also Available On</p>
						<div
							class="icon  d-flex align-items-center  text-center d-flex align-items-center">
							<img src="/AHIMSG5/hissso/portal/images/google-playstore.png"
								class="me-2"> <img
								src="/AHIMSG5/hissso/portal/images/apple-store.png">
						</div>
					</div>

					<p class="pt-3 disclaimer fst-italic">Last Updated: 20/03/2025
						3:38 PM</p>
		...
		<div class="container-fluid copyright py-2 px-4">

			<div class="row">
				<div class="col-md-12 text-center mb-md-0 p-0">
					<div class=" disclaimer text-center">
						Disclaimer: Website content managed by Ministry of Health and
						Family Welfare, GOI Design, Developed and Hosted by Centre for
						Development of Advanced Computing <a href="#"
							class="fw-bold text-decoration-none text-white" target="_blank">(C-DAC)*</a>
					</div>
