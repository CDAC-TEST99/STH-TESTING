...
<body>
	...
	<HIS_MC:TransactionContainer>	
		<HIS_MC:TitleTag name="Parameter Master>>Modify">
		</HIS:TitleTag>
		<HIS_MC:ContentTag>
				<table width="100%" border="0"  cellspacing="1" cellpadding="0">
						<tr>
							...
							<td width="25%"  class="tdfont">
								<html:text name="ParameterMasterFB" property="paraName"  onkeypress="return validateAlphabetsOnly(event,this)">
								</html:text>
							</td>
						</tr>
			...
			<HIS_MC:ButtonToolBarTag>
				<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style="cursor:pointer" onclick="validate('MODIFYSAVE')" onkeypress="if(event.keyCode==13) validate('MODIFYSAVE')">
				...
				<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" onclick="clearText()" onkeypress="if(event.keyCode==13) clearText()">
