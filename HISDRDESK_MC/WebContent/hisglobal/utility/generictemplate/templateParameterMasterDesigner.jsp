...
<HIS_MC:css src="/hisglobal/css/color_picker.css"/>
<HIS_MC:css src="/hisglobal/utility/generictemplate/css/template_designer.css"/>
<HIS_MC:css src="/hisglobal/utility/generictemplate/css/newDropDownSrch.css"/>
...
<HIS_MC:javascript src="/hisglobal/js/colorPicker.js"/>
...
<HIS_MC:javascript src="/hisglobal/utility/generictemplate/js/templateDesigner.js"/>
...
<HIS_MC:javascript src="/hisglobal/utility/generictemplate/js/commonDesigner.js"/>
<HIS_MC:javascript src="/hisglobal/utility/generictemplate/js/newDropDownSrch.js"/>
	...
	<html:form action="/master/TemplateParameterMaster.cnt">
		...
		<HIS_MC:TransactionContainer>
			...
			<HIS_MC:ButtonToolBarTag>
				<logic:equal name="TemplateParameterMasterFB" property="hmode" value="ADD">
					<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style="cursor:pointer" onkeypress="if(event.keyCode==13) submitFormOnValidate(validateFinalSave(),'SAVE')" onclick="submitFormOnValidate(validateFinalSave(),'SAVE')">
				</logic:equal>
				<logic:equal name="TemplateParameterMasterFB" property="hmode" value="MODIFY">
					<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-mo.png"/>' style="cursor:pointer" onkeypress="if(event.keyCode==13) submitFormOnValidate(validateFinalSave(),'MODIFYSAVE')" onclick="submitFormOnValidate(validateFinalSave(),'MODIFYSAVE')">
				</logic:equal>
				...
				<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-clr.png"/>' style="cursor:pointer" onclick ="submitForm('ADD')" onkeypress="if(event.keyCode==13) submitForm('ADD')">
