function VitalSave(e){
	...
	console.log(data); 
	$.ajax({url:'/HISDRDESK_MC/services/restful/IpdDrDesk/saveVital/',type:'POST',data:{JsonData:data},success:function(result)
    	{
			console.log(result);
...
function ModifyVital(e)
{
	...
	console.log("vital data get =="+CR_No+'=='+episodeCode+'=='+hospitalCode+'=='+admno+'=='+patname+'=='+seatId);
	$("#patName").text(patname);
	$("#crNo").text(CR_No);
	$("#patAge").text(patGenAgeCat);
	$("#patGender").text('');
	//$('input[name=patGeneralDtl]').val(patname+'#'+CR_No+'#'+episodeCode+'#'+patGenAgeCat);
	$.ajax({url:'/HISDRDESK_MC/services/restful/IpdDrDesk/ModifyVital/',type:'POST',data:{JsonData:data},success:function(result)
    	{ 
			console.log('result '+JSON.stringify(result));
			console.log('result.status '+result.status);
			console.log('result.VitalDtls '+JSON.stringify(result.VitalDtls));
				 ...
				 result.VitalDtls.forEach(function(item){
					...
					// console.log(' item.HOPLSTR_SYMPINFO_VAL '+item.HOPLSTR_SYMPINFO_VAL);
						...
						/* $("#Disability").val(item.HOPLSTR_DISABILITY);
						 ...
						 console.log("inside ModifyVital");
						 console.log(''+'^'+CR_No+'^'+episodeCode+'^'+admno+'^'+hospitalCode+'^'+''+'^'+''+'^'+seatId)
						 		
						 
						 $("#strPatHiddenDtlsId").val(''+'^'+CR_No+'^'+episodeCode+'^'+admno+'^'+hospitalCode+'^'+''+'^'+''+'^'+seatId);
