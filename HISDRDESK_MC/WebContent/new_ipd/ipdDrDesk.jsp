...
<script type="text/javascript" src="../../new_opd/assests/jquery.js"></script>
	...
	<script src="/HISDRDESK_MC/new_ipd/js/ipdDrDeskSave.js"></script>
    ...
    <!-- JS Tooltip -->
    <!--   <link href="/HISDRDESK_MC/new_opd/css/tooltip.css" rel="stylesheet" type="text/css" />
    <script src="/HISDRDESK_MC/new_opd/js/tooltip.js" type="text/javascript"></script> -->
...
<!-- 	<link rel="stylesheet" type="text/css" href="/HIS/hisglobal/drDeskAssets/jstree/themes/default/style.min.css" /> -->
	...
	<script src="/HISDRDESK_MC/new_ipd/js/mainDeskScript.js"></script>  
	<script src="/HISDRDESK_MC/new_ipd/js/Opdvital.js"></script>  
	<script src="/HISDRDESK_MC/new_ipd/js/VitalSave.js"></script> 
...
<body style="padding-top:15px; background-color:#eaeef3">
			...
			<div class="modal fade" id="PatientReVisitTemplateModal" >
			  ...
			  <div class="modal fade" id="myModal_motherBabyLinkage"  role="dialog">
				    <div class="modal-dialog modal-lg">
				      <div class="modal-content">
				        <!-- Modal Header -->
				        <div class="modal-header" style="height:45px;">
				        <button type="button" class="close" style="color:red;" data-dismiss="modal">&times;</button> 
				           <h4 class="modal-title"><b id="headerTitle"></b></h4>
				          
				        </div> 
				        <!-- Modal body -->
				        <div class="modal-body" id="myFrameMotherBabyLinkage">
				        	<div class="grid-container">
							    <div class="grid-child" id="col1">
							        <p id="patMotherBabyCrNo"></p>
							        <p id="patMotherBabyGenderAge"></p>
							        <p id="patMotherBabyAdmNo"></p>
							        <p id="patMotherBabyDept"></p>
							        <p id="patMotherBabyCat"></p>
							        <p id="patMotherBabyWard"></p>
							        <p id="patMotherBabyBed"></p>
							    </div>
							
							    <div class="grid-child" id="col2">
							       <p id="patMotherBabyName"></p>
							       <p id="patMotherBabyDob"></p>
							       <p id="patMotherBabyAdmOn"></p>
							       <p id="patMotherBabyUnit"></p>
							       <p id="patMotherBabyStatus"></p>
							       <p id="patMotherBabyRoom"></p>
							       <p id="patMotherBabyDisDt"></p>
							    </div>
...
<div id="mainDeskLoadingMsgDiv" style="display:none;width:100vw;height:100vh;position:fixed;z-index:99999; background-color:rgba(0,0,0,0.6)">
	...
	<html:form action="/transaction/IPDDoctorDeskAction.cnt"  name="IPDDoctorDeskFB" type="new_ipd.transaction.fb.IPDDoctorDeskFB" method="post" >  
	...
	<div class="savePrescAlert alert alert-success alert-dismissible fade in" style="display:none; position:fixed; z-index:9999; top:18vh; left:35vw; color: #fff; background-color: rgb(51, 143, 13); border-color: rgb(103, 183, 37); font-size: 16px; padding: 2% 5% 1% 5%;">
	    ...
	    <div class="text-center">
		    ...
		    <button class="btn btn-warning btn-sm savePrescAlertCancelBtn" type="button" style="display:none;">Cancel</button>
		...
		<div id="patSideListId" class="patSideList">
			...
			<p class="patCatHeader waitingPatHeader">Discharge Prepared<span class="badge" style="background-color: #ED6B75;">5</span></p>
			<ul id="waitingPatList"> 
			</ul>
			<p class="patCatHeader visitedPatHeader">Admitted <span class="badge" style="background-color: #F1C40F;">5</span></p>
...
<!-- 			<img class="img-circle img-responsive" src="/HISDRDESK_MC/new_opd/img/img_avatar3.png" style="margin: 3% 2%;float:left; 
			...
			<p><label style="font-weight: bold; color:#3ba4e3;"> CR No: <%=approvaljsonObj.get("hrgnum_puk") %></label> <a href="#" id=<%=approvaljsonObj.get("hrgstr_req_id") %> class="hideme" onclick='approvalData(<%=approvaljsonObj.toString() %> )' data-toggle="tooltip" title="Click To Approve" ><i class="fa fa-check-circle"  style="float: right;"></i></a></p>
...
<!-- 			<img class="img-circle img-responsive" src="/HISDRDESK_MC/new_opd/img/img_avatar3.png" style="margin: 3% 2%;float:left; 
			...
			<p><label style="font-weight: bold; color:#3ba4e3;"> CR No: <%=approvaljsonObj.get("patcrno") %></label> <a href="#" id="<%=approvaljsonObj.get("fromdepartment") %>" class="hideme" onclick='approvalData1(<%=approvaljsonObj.toString() %> )' data-toggle="tooltip" title="Click To Approve" ><i class="fa fa-check-circle"  style="float: right;"></i></a></p>
...
<div id="wrapper">
      ...
      <div class="row mainTopHeader" style="background-color: #fff;">
        ...
        <div class="col-sm-12 " style="box-shadow: 0 0 10px 3px rgba(0,0,0,0.14); padding-bottom: 0px; padding-top: 15px; padding-right: 0px;padding-left: 5px;margin-bottom: 1px;" >
          <div class="row">
          	<div class="col-sm-2" style="padding-right: 0px;padding-left: 0px;">
          		<h2 style="margin:0px 15px;font-size: 1.6rem;display:inline-block"><i class="fa fa-user" style="color: #1a7bda;"></i> <a style="text-decoration:none;color: rgba(23, 97, 194, 0.74);font-weight: bold;font-size: 20px;" href="javascript:;">IPD DESK</a></h2>
          		<p class="text-center" style="font-size:0.95em;margin-top: 0px;margin-bottom: 0px;float: right;font-weight:bold; margin-right:10px"><font class="visitedPatCount" style="color: rgba(35, 104, 194, 0.8)"></font>  discharge prepared out of <a style="color:black" class="totalPatCount" title="Total : 100 Approx waiting" onclick="$('#patListStatModal').modal('show');"></a> admitted</p>
          	</div> 
                ...
                <div class="col-xs-8 col-sm-7" style="">
          		...
          		<span style="position:absolute;top:-1px;right:1px;color:white;border-radius:25px;display:none;" id="patSideListSpan2" class="blink label label-danger">0</span>
          						...
          						<div class="col-xs-12 col-sm-3 form-horizontal">
									<div class="form-group" style="margin-bottom: 0px;">
										<p style="color: #0b3da1; font-weight: bold; padding-top: 0"
											class="control-label col-xs-4 col-sm-3" for="wardName">WARD
										</p>
										<div class="col-xs-8 col-sm-8" style="">
											<select name="wardName" id="wardName"
												class="form-control"
												style="color: #082b71; border-radius: 0px;"
												onchange="getDeltList(this);">
												<!-- <option value="0#0#0">ALL</option> -->
												<%
													HashMap<String, String> WardCMB = (HashMap) request.getSession().getAttribute("WardDTL");
														//System.out.println("WardCMB" + WardCMB);
														if (WardCMB != null) {
															for (Map.Entry m : WardCMB.entrySet()) {
																String WardCode = (String) m.getKey();
																String WardName = (String) m.getValue();
																 String SelectedWardId=(String)request.getSession().getAttribute("SelectedWardId");
																if(SelectedWardId.equalsIgnoreCase(WardCode))
											            		 {
											            			 %>
											                      	<option value="<%=WardCode%>" selected><%=WardName %></option>
											                     
											                      <% 
											            		 }else
											            		 {
											                   	 %>
											                     	<option value="<%=WardCode%>"><%=WardName %></option>
          	...
          	<div class="col-xs-12 col-sm-3 form-horizontal toggleForFullScreenDeskBtn" style="display:none;">
          	...
          	<div class="col-xs-12 col-sm-1" style="">
          		<button id="patRefreshBtn" onclick="refreshPatientData(this)"  title="" style="float: right;padding:4px 12px; color:#4067c5 ;" class="btn btn-link" type="button">
          		<!-- <i   class="fa fa-list"></i> -->
       ...
       <div class="row">
       	  <!-- <div class="row" style="margin-top: 2px; margin-left: 5px !important; margin-right: 10px !important; background-color: #009fef; box-shadow: 0 4px 10px 1px rgba(0,0,0,0.14)">
       	   ...
       	   <!-- <br> --> 
       	   <input type="hidden" name="strRailTailFlg" id="strRailTailFlgId" value="${IPDDoctorDeskFB.strRailTailFlg}" />
       	   ...
       	   <%
						...
						ArrayList<String> list=null;
							 ...
							 String isNewBornFlag = list.get(63);
							 String motheradmissionNo = list.get(64);
							 String haveNewBorn = list.get(65);
							 String dischargeStatus = list.get(61);
							 System.out.println("motheradmissionNo called --->"+ motheradmissionNo);
							 System.out.println("isNewBornFlag called --->"+ isNewBornFlag);
							 System.out.println("haveNewBorn called --->"+ haveNewBorn);
							 String imgPath ="/HISDRDESK_MC/new_opd/img/img_avatar4.png";
							 int age = Integer.parseInt(list.get(66).split(" ")[0]);
							 if(list.get(3).split("/")[0].equals("F"))
							 {
								if(age>=0 && age<=12 && isNewBornFlag.equals("1"))
									imgPath = "/HISDRDESK_MC/new_ipd/img/infant_f.png";
								else if(age>1 && age<=12)
									imgPath = "/HISDRDESK_MC/new_ipd/img/child_f.png";
								else if(age>12 && age<60)
									imgPath = "/HISDRDESK_MC/new_ipd/img/adult_f.png";
								else if(age>=60)
									imgPath = "/HISDRDESK_MC/new_ipd/img/adult_f.png";
								else
									imgPath = "/HISDRDESK_MC/new_opd/img/img_avatar3.png";
							 }
							 else
							 {
								 if(age>=0 && age<=12 && isNewBornFlag.equals("1"))
										imgPath = "/HISDRDESK_MC/new_ipd/img/infant_m.png";
									else if(age>1 && age<=12)
										imgPath = "/HISDRDESK_MC/new_ipd/img/child_m.png";
									else if(age>12 && age<60)
										imgPath = "/HISDRDESK_MC/new_ipd/img/adult_m.png";
									else if(age>=60)
										imgPath = "/HISDRDESK_MC/new_ipd/img/adult_m.png";
									else
										imgPath = "/HISDRDESK_MC/new_opd/img/img_avatar.png";
							 }
							 
							 String babyDtl="";
							 
							 if(isNewBornFlag.equals("1"))
								{
								 babyDtl ="&nbsp;&nbsp;<i class=\"fa fa-female\" aria-hidden=\"true\" style = \"font-size: 1.5em;color: #ff944d;cursor: pointer;\" data-tooltip=\"tooltip\" title=\"Mother Details\" data-toggle=\"tooltip\"  data-placement=\"top\" onclick = \"getMotherInfo(this,"+motheradmissionNo+","+isNewBornFlag+")\"></i>";
								}
								else if (haveNewBorn !=null && !haveNewBorn.isEmpty())
								{
									String[] haveNewBornList = haveNewBorn.split("#");
									for (int j=0; j<haveNewBornList.length;j++)
										 babyDtl +="&nbsp;&nbsp;<i class=\"fa fa-child\" aria-hidden=\"true\" style = \"font-size: 1.5em;color: #ff944d;cursor: pointer;\" data-tooltip=\"tooltip\" title=\"Baby Details\" data-toggle=\"tooltip\"  data-placement=\"top\" onclick = \"getMotherInfo(this,"+haveNewBornList[j]+","+isNewBornFlag+")\"></i>";
								}
				                       ...
				                       <%-- <%  
				                        ...
				                        <i class="isAttended attended"></i>
				                         ...
				                         <% }
				                          ...
				                          {
				                          %> --%>
				                       <td><img class="img-circle img-responsive patProfileImg" src="<%=imgPath %>" style="width: 30px; min-width: 26px; display:inline-block; /* box-shadow: 0px 0px 15px 2px rgba(0,0,0,0.2); */ border: 1px solid #fff; " title="<%=list.get(66) %>" data-toggle="tooltip" data-tooltip="tooltip" data-placement="top">
										<% if(list.get(24).equals("12"))
				                        { %>
				                        <i class="isAttended attended"></i>
				                          <% } %>
				                        ...
				                        <%--  <% } %> --%>
				                          ...
				                          <% if(list.get(24).equals("12")) { %>
				                          <td class="patStatus"><a style="cursor: default;" class="label label-success">Admitted</a></td>
				                          <% } else {%>
				                          <td class="patStatus"><a style="cursor: default;" class="label label-danger">Discharge Prepared</a></td>
				                          <% } %>
				                          <% if(list.get(11).equals("1"))
				                          {
				                          %>
				                          <td class="patName" style="color:#7896e3; font-weight:bold;"><%=list.get(2) %><%=babyDtl %></td>
				                          <td class="patCrNo" style="color:#7896e3; font-weight:bold;"><%=CrNo%></td>   
				                          <% } else 
				                        	  {%> 
				                          <td class="patName"><%=list.get(2) %><%=babyDtl %></td>
				                          <td class="patCrNo"><%=CrNo%></td>  
				                          <% }%>
				                          <td class="patAdmNo" style="color:#7896e3; font-weight:bold;"><%=list.get(30) %></td>
				                          <td class="patAdmDate"><%=list.get(58) %></td>
				                          <td class="patUmid" style="color:#7896e3; font-weight:bold;"><%=list.get(59) %></td>
				                          <td class="patGenAgeCat"><%=list.get(3)%>/<%=list.get(4)%></td>
				                          <td class="patWard"><%=list.get(53) %>/<% out.print(list.get(7)==null ? "-" : list.get(7)); %></td>
				                          <td>
					                          ...
					                          <font class="patVisitType" style="display:none"><%=list.get(27)==null?"":list.get(27).equals("1")?"OPD General":"" %><%=list.get(27)==null?"":list.get(27).equals("2")?"Emergency MLC":"" %><%=list.get(27)==null?"":list.get(27).equals("3")?"Emergency Non MLC":"" %><%=list.get(27)==null?"":list.get(27).equals("4")?"OPD Special":"" %></font>
					                          ...
					                          <font class="patBed" style="display:none"><%=list.get(54) %></font>
					                          <% 
						                       if(list.get(24).equals("12")){%>
					                        	   <button type="button" id="rxBtn" class="btn btn-outline-success btn-sm prescriptionColBtn" onclick="return showPrescription(this,event)">Rx</button>
					                         <%   } 
					                           else{ %>
					                        	   <button type="button" class="btn btn-referal btn-sm prescriptionColBtn" onclick="return showPrescription(this,event)">View</button>
				                        	   <%    }
					                       		%> 
					                          <input type="hidden" name="patCompleteGeneralDtl" value="<%=list.get(5)+"#"+list.get(6)+"#"+list.get(7)+"#"+list.get(8)+"#"+list.get(11)+"#"+list.get(13)+"#"+list.get(14)+"#"+list.get(17)+"#"+list.get(22)+"#"+list.get(23)+"#"+list.get(19)+"#"+list.get(35)+"#"+list.get(36)+"#"+list.get(37)+"#"+list.get(43)+"#"+list.get(42)+"#"+list.get(45)+"#"+list.get(46)+"#"+list.get(47)+"#"+list.get(48)+"#"+list.get(53)+"#"+list.get(54)+"#" %>" >
				                           ...
				                           <!-- ################ Added for reason for visit from registration end #################### -->					</td>  
									  </tr>
					...
					%> 
					                  ...
					                  <p style="display:inline-block"><i class="fa fa-circle" style="color:#7896e3"></i> New Patient</p>
					                  <p style="display:inline-block; margin-left:20px;"><i class="fa fa-circle"></i> Old Patient</p>
  ...
  <input type="hidden" name="strInitialMode" value="${IPDDoctorDeskFB.strInitialMode}"/>
  <input type="hidden" name="strHospitalAddres" value="${IPDDoctorDeskFB.strHospitalAddres}"/>
  <input type="hidden" name="strHospitalName" value="${IPDDoctorDeskFB.strHospitalName}"/>
  <input type="hidden" name="strSeatId" value="${IPDDoctorDeskFB.strSeatId}"/>
  <input type="hidden" name="strHiddenDeptCode" value="${IPDDoctorDeskFB.strHiddenDeptCode}"/>
  <input type="hidden" name="strHiddenWardCode" value="${IPDDoctorDeskFB.strHiddenWardCode}"/>
  <input type="hidden" name="strHiddenUsrName" value="${IPDDoctorDeskFB.userName}"/>
