...
<script type="text/javascript" src="../../new_opd/assests/jquery.js"></script>
	...
	<script src="/HISDRDESK_MC/new_opd/js/opdDrDeskSave_profile.js"></script>
...
<!-- 	<link rel="stylesheet" type="text/css" href="/HIS/hisglobal/drDeskAssets/jstree/themes/default/style.min.css" /> -->
	...
	<script src="/HISDRDESK_MC/new_opd/js/mainDeskScript_profile.js"></script>  
...
<!-- 			<img class="img-circle img-responsive" src="/HISDRDESK_MC/new_opd/img/img_avatar3.png" style="margin: 3% 2%;float:left; 
			...
			<p><lable style="font-weight: bold; color:#3ba4e3;"> BEN ID: <%=approvaljsonObj.get("hrgnum_puk") %></lable> <a href="#" id=<%=approvaljsonObj.get("hrgstr_req_id") %> class="hideme" onclick='approvalData(<%=approvaljsonObj.toString() %> )' data-toggle="tooltip" title="Click To Approve" ><i class="fa fa-check-circle"  style="float: right;"></i></a></p>
      ...
      <div class="row mainTopHeader" style="background-color: #fff;">
        ...
        <div class="col-sm-12 " style="box-shadow: 0 0 10px 3px rgba(0,0,0,0.14); padding-bottom: 0px; padding-top: 15px; padding-right: 0px;padding-left: 5px;margin-bottom: 1px;" >
          <div class="row">
          	...
          	<!-- <button id="sampleDiv1"  title="" style="float: right;padding:4px 12px; color:#4067c5 ;" class="btn btn-link" type="button" onclick="showIpdList('SHOWIPDLIST');">
       	   ...
       	   <%
				                           ...
				                           <td>
					                        ...
					                        <% 
						                       if(list.get(31)==null){ //out.print(list.get(31)); %>
						                       		<button type="button" class="btn btn-outline-success btn-sm prescriptionColBtn prescriptionColBtn11" data-toggle="tooltip" title="click for patient Precription" onclick="return showPrescription(this,event)">Rx</button>
					                         <%   } 
					                           else if(list.get(31).equals("0")){ //out.print(list.get(31)); %>
					                        	   <button type="button" class="btn btn-outline-success btn-sm prescriptionColBtn prescriptionColBtn11" onclick="return showPrescription(this,event)">Rx</button>
					                         <%   } 
					                           else{ //out.print(list.get(31)); %>
					                        	   <button type="button" class="btn btn-referal btn-sm prescriptionColBtn prescriptionColBtn11" onclick="return showPrescription(this,event)">Rx</button>
				                        	   <%    }
					                        %> 
					...
					%> 
   								...
   								<div class="col-sm-12 uk-card uk-card-default uk-card-hover rightPanel" style="display: none;background-color: #eaeef3;">
						      		<button style="display:none; float: right;padding:4px 12px;" class="btn btn-danger btn-sm rightPanelClose  rightPanelClose111" type="button" onclick="hidePrescription(this,event)">x</button>
						      		<button style="display:none;float: right;padding:4px 12px;" class="btn btn-link shortcutInfoRightPanel" onclick="$('#shortcutKeysModal').modal('show');" type="button"><i class="fa fa-info"></i></button>
						      		<button style="display:none;float: right;padding:4px 12px; color:#87c540" class="btn btn-link patSearchRightPanel" onclick="$('#patientSearchModal').modal('show');" type="button"><i class="material-icons">search</i></button>
						      		<button id="patSideListBtn" style="display:none;float: right;padding:4px 12px; color:#4067c5" class="btn btn-link" type="button"><i class="fa fa-users"></i></button>						       		
						       		<button id="patientSumBtn" style="display:none; float: right;padding:4px 12px; color:#4067c5" class="btn btn-link patientSumBtn" type="button" onclick="patientSumBtnToggleFun()"><i class="fa fa-wheelchair"></i></button>	
						       		<button style="display:none;float: right;padding:4px 12px; color:#4067c5" class="btn btn-link fullScreenDeskBtn" type="button" onclick=""><i class="glyphicon glyphicon-fullscreen"></i></button>
						       		<button style="display:none;float: right;padding:4px 12px; color:#4067c5" class="btn btn-link videocallList" type="button" onclick="videocallList(this)"><i class="glyphicon glyphicon-facetime-video"></i></button>						       		
						       	</div>  
						       </div>  
						    </div>
						  </div>
...
<button id="emrModalTriggerBtn" style="display: none;" class="btn btn-default" type="button" data-toggle="modal" data-target="#emrModal"></button>
  ...
  <div class="modal fade" id="emrModal" role="dialog">
   ...
   <div class="modal fade " id="VitalIDModal" role="dialog" style="display: none;">
 <!--   <div class="modal-dialog modal-lg"> -->
