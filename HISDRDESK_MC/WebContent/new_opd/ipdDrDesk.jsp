...
<script type="text/javascript" src="../../new_opd/assests/jquery.js"></script>
	...
	<script src="/HISDRDESK_MC/new_opd/js/ipdDrDeskSave.js"></script>
...
<!-- 	<link rel="stylesheet" type="text/css" href="/HIS/hisglobal/drDeskAssets/jstree/themes/default/style.min.css" /> -->
	...
	<script src="/HISDRDESK_MC/new_opd/js/mainDeskScript_new.js"></script>  
...
<div id="mainDeskLoadingMsgDiv" style="width:100vw;height:100vh;position:fixed;z-index:99999; background-color:rgba(0,0,0,0.6)">
	...
	<html:form action="/transaction/IpdDoctorDeskAction.cnt"  name="IpdDoctorDeskFB" type="new_opd.transaction.controller.fb.DoctorDeskFB" method="post" >  
	...
	<div class="savePrescAlert alert alert-success alert-dismissible fade in" style="display:none; position:fixed; z-index:9999; top:18vh; left:35vw; color: #fff; background-color: rgb(51, 143, 13); border-color: rgb(103, 183, 37); font-size: 16px; padding: 2% 5% 1% 5%;">
		...
		<div id="patSideListId" class="patSideList">
		 ...
		 <div id="patSideListId1" style="top: 5vh !important;" class="patSideList">
			<legend class="text-center totalPatHeader" style="text-transform: capitalize  !important;">TeleConsultancy Request (Today) <span class="badge" style="background-color: #36c6D3;"></span></legend>
			<a href="#" class="closee-consultancy"  data-toggle="tooltip" title="Close Patient Approval List" > <p class="patCatHeader waitingPatHeader" style="padding: 15px !important"><span class="badge" style="background-color: #fb6767;;">
			<i class="far fa-window-close"></i>
			</span></p>
			</a>
			<ul id="waitingPatList" style="overflow-y: auto;overflow-x: hidden;height: 80%;"> 
			<%
...
<div id="wrapper">
      ...
      <div class="row mainTopHeader" style="background-color: #fff;">
        ...
        <div class="col-sm-12 " style="box-shadow: 0 0 10px 3px rgba(0,0,0,0.14); padding-bottom: 0px; padding-top: 15px; padding-right: 0px;padding-left: 5px;margin-bottom: 1px;" >
          <div class="row">
          	...
          	<div class="col-xs-12 col-sm-3 form-horizontal">
                ...
                <div class="col-xs-8 col-sm-9" style="">
          	...
          	<div class="col-sm-2">
          <!-- <button id="sampleDiv1"  title="" style="float: right;padding:4px 12px; color:#4067c5 ;" class="btn btn-link" type="button" onclick="showIpdList('SHOWOPDLIST');">
          		<i   class="fa fa-list"></i>&nbsp;&nbsp;IPD Desk</button> -->
          	<p style="display:none">
                          <label>IPD</label>
                          <label class="switch" style="vertical-align: middle;">
                             <input type="checkbox" onclick="showIpdList('SHOWOPDLIST');">
                             <span class="slider round"></span> 
                          </label>
                          &nbsp;<label>OPD</label>
                        </p>
       ...
       <div class="row">
       	  <!-- <div class="row" style="margin-top: 2px; margin-left: 5px !important; margin-right: 10px !important; background-color: #009fef; box-shadow: 0 4px 10px 1px rgba(0,0,0,0.14)">
       	   ...
       	   <!-- <br> --> 
       	   <div class="col-sm-12 uk-card uk-card-default leftPanel"  style="height: 130vh; padding-top: 5px">  
       	   ...
       	   <%
						HashMap<String ,List> map= (HashMap) request.getSession().getAttribute("IPDDRDESKDATA");
					              ...
					              <tr class="patientListBlock isAttended_<%=list.get(24) %> visitType_<%=list.get(27) %>" attended="<%=list.get(24) %>">
				                       ...
				                       <td><img class="img-circle img-responsive patProfileImg" src="/HISDRDESK_MC/new_opd/img/img_avatar.png" style="width: 30px; min-width: 26px; display:inline-block; /* box-shadow: 0px 0px 15px 2px rgba(0,0,0,0.2); */ border: 1px solid #fff;">
				                         ...
				                         <% } %>
				                          ...
				                          <td class="patBed"><%=list.get(53) %></td>
				                         <%--  <td class="patBalance" style="display:none;"><%=list.get(55) %></td> --%>
				                         <td class="patAdmNo"><%=list.get(30) %></td>
				                         <td class="patAdmDate"><%=list.get(57) %></td>
				                         <td class="patBalance"><%=list.get(54) %></td>
				                          <td>
  ...
  <input type="hidden" name="strHiddenWardCode" value="${DoctorDeskFB.strHiddenWardCode}"/>
...
<div class="modal-content">       
				...
				<div class="form-group col-md-3 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-7 col-xs-6 alignLeftPaddingLeftZero">
							...
							<input  type="radio" name="Disability" value="No" checked="checked">No
						</div>
					</div>
					...
					<div class="form-group col-md-3 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-7 col-xs-6 alignLeftPaddingLeftZero">
							...
							<input  type="radio" name="Smoking" value="No" checked="checked">No
						</div>
					</div>
					...
					<div class="form-group col-md-3 col-sm-6 col-xs-12">
						...
						<div class="col-md-6 col-sm-7 col-xs-6 alignLeftPaddingLeftZero">
							...
							<input  type="radio" name="Anemic" value="No" checked="checked">No
						</div>
					</div>
