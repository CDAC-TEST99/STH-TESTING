...
const styleVars=` 
	 <link rel="stylesheet" type="text/css" href="/HISDRDESK_MC/hisglobal/template/css/jqui_1_9_2.css"/>
 <link rel="stylesheet" href="/HISDRDESK_MC/hisglobal/template/css/bs_45.css">
 <link rel="stylesheet" href="/HISDRDESK_MC/hisglobal/template/css/fa_5.css">
...
const scriptVars=` 
	<script src="/HISDRDESK_MC/hisglobal/template/js/jq_3_5_1.min.js"></script>
 <script src="/HISDRDESK_MC/hisglobal/template/js/jqui_1_12_1.js"></script>
 <script src="/HISDRDESK_MC/hisglobal/template/js/poper.min.js"></script>
 <script src="/HISDRDESK_MC/hisglobal/template/js/bs_45.js"></script>
 <script src="/HISDRDESK_MC/hisglobal/template/js/fa_5.min.js"></script>
 ...
 <script type="text/javascript" src="/HISDRDESK_MC/new_opd/assests/jqte.js"></script>
 <script type="text/javascript" src="/HISDRDESK_MC/new_opd/js/fb.js"></script>
...
const editor_mod=`
	...
	<div class="modal-dialog modal-xl" style="max-width:82vw">
		<div class="modal-content" >
			<div class="modal-header">
				<h5 class="header-cont-edit">Edit Image 
					&nbsp;<i  onclick="toggleEditor(this)" style="cursor:pointer;color:#2B83B9" class="fas fa-expand-alt"></i>	
				</h5>
...
function addOpt(obj){
if($(obj).closest(".el_Options").find('[id*=el_OptionsIn]').last().find("input[name='option']").val().trim()==""){
...
if(parseInt(currId.split("-")[1]) > 1)
	$(obj).closest(".el_Options").find("#el_OptionsIn-"+currId.split("-")[1]).find(".rmOptDiv").css("display","none");
...
function addUnit(obj){
	...
	if($(obj).closest(".contDrag").find(".dropdown-menu").find("#dropdown-item-"+id).length > 0 )
		...
		let inpEl=document.createElement("a");  
				  $(inpEl).attr("href","#");
				  $(inpEl).attr("onclick","unitSelect(this,event)");
...
function callEditor(obj){
	if($(obj).closest(".contDrag").find(".imgEditorModal .imgEditorModalFrame").length==0)
			$(obj).closest(".contDrag").find(".imgEditorModal .modal-body").html('<iframe class="imgEditorModalFrame" src="/HISDRDESK_MC/hisglobal/mini-paint-js-master/demo/imgEdit.jsp" style="min-width:100%;min-height:22vw;border-radius:10px;border:none;" ></iframe>');
...
function toggleEditor(obj){
	editmodal=$(obj).closest(".contDrag").find(".imgEditorModal");
	if(!expand()){
		$(editmodal).find(".modal-body").css("min-height","32rem");
		$(editmodal).find(".imgEditorModalFrame").css("min-height","32rem");
	}else{
		$(editmodal).find(".modal-body").css("min-height","23rem");
		$(editmodal).find(".imgEditorModalFrame").css("min-height","22rem");
	}
	toggleExpand(editmodal[0]);
...
function expand(){return  document.fullscreenElement||document.mozFullscreenElement||document.webkitFullscreenElement||document.msFullscreenElement;}
