$(document).ready(function(){
	...
	$("#txt-snomed-ct-search_VR3").on('keypress', function (e) {
 		//console.log('1');
 		if (!e) e = window.event;
 	    var keyCode = e.keyCode || e.which;
 	    if (keyCode == '13'){ 	    	
 	    	 $('.chronicDiseaseAddRows').trigger('click');
 	    }
	});
...
var count=0;
      ...
      $('#allergicOrNotId').change(function() {
        ...
        $('.allergiesDtlAddRows').click(function(){
            ...
            if(allergynamecode[0].trim()==""){
				allergynamecode[0]="0";
			}
			var strSensivityName=$("[name='allergiesSensitivityCode'] option:selected").text();
			if($("[name='allergiesSensitivityCode'] option:selected").val()=="-1"){
				strSensivityName="";
			}
            var chkBoxId ={
            		...
            		"strSensivityName" : strSensivityName ,
          ...
          if(allergyName.trim()!=''/* && duration.trim()!='' && allergySite.trim()!='' && allergySymptoms.trim()!='' && remarks.trim()!='' && sensitivityCode!= '-1'*/){
        	  count1++;
        	  allergydata1='<tr>'+ 
                '<td><input type="checkbox" class="allergiesDtlChkAll" id="allergyDtlChkId" checked name="allergiesDtlChk" value="">'+
