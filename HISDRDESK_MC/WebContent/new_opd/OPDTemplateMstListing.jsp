...
<script type="text/javascript" src="/HISDRDESK_MC/hisglobal/template/js/dtable.min.js"></script>
<script type="text/javascript" src="/HISDRDESK_MC/hisglobal/template/js/dtable_fixedCol.min.js"></script>
<script type="text/javascript" src="/HISDRDESK_MC/hisglobal/template/js/dtable_select.min.js"></script>

 <script src="/HISDRDESK_MC/hisglobal/template/js/fa_5.min.js"></script>
 <script src="/HISDRDESK_MC/hisglobal/template/js/jqui_1_12_1"></script>
...
<script src="/HISDRDESK_MC/new_opd/js/templateListing.js"></script>
<style>
