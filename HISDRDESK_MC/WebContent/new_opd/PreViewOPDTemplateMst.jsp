...
<%@ taglib uri="/WEB-INF/struts-bean.tld" prefix="bean"%> 
    ...
    <head>
        ...
        <link rel="stylesheet" href="/HISDRDESK_MC/new_opd/css/draggableStyle.css"/>
        ...
        $(document).ready(function(){
        	...
        	var EsstentialJson;
        	  ...
        	  if(localStorage.getItem("FormattedHTML"))
        	  { 
            	 myJSON = localStorage.getItem("OPDTemplateJson");
        		 myHTML = localStorage.getItem("FormattedHTML");
        		 $("#rednderHtmlForm").html(myHTML);
        		 EsstentialJson = localStorage.getItem("OPDTemplateEssentialJson");
        		 document.forms[0].strEssentilaJson.value=EsstentialJson;
        		 document.forms[0].strJsonParaMetereIdString.value=myJSON;
                 document.forms[0].strHtmlString.value=myHTML ;
