...
<link rel="stylesheet" href="/HIS/hisglobal/js/jquery/multiselect/css/bootstrap-multiselect.css">
  <script type="text/javascript" src="/HIS/hisglobal/js/jquery/bootstrap-multiselect.js"></script>
   -->
<script type="text/javascript" src="/HISDRDESK_MC/new_opd/js/myScript_profile.js"></script> 
<script type="text/javascript" src="/HISDRDESK_MC/new_opd/js/prescrptionProfile.js"></script> 
  ...
  <div class="modal fade" id="drugAdvicesInstructionsModal1" role="dialog">
    <div class="modal-dialog">       <!-- Modal content-->
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align: left;">
          <textarea class="form-control" onblur="" id="strDrugsRemarksId" name="strDrugsRemarks" maxlength="2000"></textarea>
        
        </div>
       <!--  <input type="button" class="btn btn-primary btn-sm" onclick="getDrugAdvice()" value="Submit">Submit  -->
  ...
  <div class="modal fade" id="drugAdvicesInstructionsModal2" role="dialog">
    <div class="modal-dialog">       <!-- Modal content-->
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align: left;">
          <textarea class="form-control" onblur="" id="strDrugsRemarksId1" name="strDrugsRemarks1" maxlength="2000"></textarea>
...
<!--   <div class="modal fade" id="patPrescViewModal" role="dialog" aria-labelledby="modalLabel">
    ...
    <!-- Prescription Code Starts here -->
        ...
        <h2 style="text-align: left; margin-bottom: 0; margin-top:0">Create Rx Bookmarks
        ...
        <h5 id="prescrightPanelHeaderPat" style="display:none; text-align: center; text-transform: uppercase; margin-right: 5px;line-height: 1em;margin-top: 0;letter-spacing: 3px;margin-bottom: 0;">
        	...
        	<img src="/HISDRDESK_MC/new_opd/img/patIcon.png" style="height: 3em;vertical-align: text-bottom;padding-right: 10px;">
            ...
            <div class="container-fluid prescriptionContainer" style="padding-left: 10px;padding-right: 10px;background-color: #eaeef3; ">
              <div class="row">
                ...
                <div id="prescriptionTileContainer" class="col-sm-12 col-md-12" style="padding-left: 0px;padding-right: 10px;">
                 <p  id="prescriptionPanelPatStatus" style="display:none"></p>
                 
                 
                 
                 <div class="prescriptionTile" >
                 	<p class="vitalsAdded" style="display: none">
                    </p>
                    <div class="row"> 
                        <div class="col-sm-10 col-md-11 prescriptionTileRowFirstCol" style="display: none">
                          ...
                          <!--  <p class="hba1c col-sm-3 col-md-3 opdVitalsTile opdVitalsLabel" id="Pregnancyid"><i class="material-icons">pregnant_woman</i> Pregnancy : <span id="PregnancyIdvalue"  data-toggle="tooltip" ></span></p>    -->                         
                           ...
                           <div style="display: none;"> <p class="otherInfo col-sm-12 col-md-12 opdVitalsTile opdVitalsLabel" id="RegReasonForVisitId"><i class="fa fa-clinic-medical"></i> Reason for Visit : <span id="ReasonVisitFromRegistrationId"></span></p></div>
                     ...
                     <div class="row" >    
                        <div class="col-sm-1 col-md-1 prescriptionTileRowFirstCol " style="display:none">
                        	 <button style="display:none" id="eteleconsultancyViewDocLinkClassID"  disabled="disabled" class="btn btn-warning dropdown-toggle dropdown-toggle-split" type="button" data-toggle="dropdown"><i class="glyphicon glyphicon-picture"></i> Uploads <span class="caret"></span></button>
									<ul class="dropdown-menu" id="eteleconsultancyViewDocLinkClassUl">
									</ul>
                        	<button style="display:none" type="button" id="opdEmrBtnId"  class="btn btn-info opdEmrBtn AddToggleClass" tabindex="0" data-toggle="tooltip" onclick="$('#opdEmrModal').modal('show');" title="Past Rx">Past Rx </button>
                        	<button style="display:none" type="button" id="treeStructurePrescBtnId"  class="btn btn-info treeStructurePrescBtn AddToggleClass" tabindex="0" data-toggle="tooltip" onclick="$('#TreeStructurePrescriptionModal').modal('show');" title="Patient OPD EMR">OPD EMR</button>
                            <button style="display:none" type="button" id="vitalModify"class="btn btn-info vitalModifyBtn AddToggleClass" onclick="ModifyVital(this,event)" tabindex="0" data-toggle="tooltip" title="Modify Vital">Modify Vital/GE</button>
                       ...
                       <p style="color: #0b3da1; font-weight: bold;padding-top:0;" class="control-label col-xs-1 col-sm-1">DEPT/UNIT </p>
                       <div class="col-sm-4 col-md-4 prescriptionTileRowFirstColll " style="">
                        	 <!-- <button style="display:none" id="eteleconsultancyViewDocLinkClassID"  disabled="disabled" class="btn btn-warning dropdown-toggle dropdown-toggle-split" type="button" data-toggle="dropdown"><i class="glyphicon glyphicon-picture"></i> Uploads <span class="caret"></span></button>
									<ul class="dropdown-menu" id="eteleconsultancyViewDocLinkClassUl">
									</ul>
                        	<button style="display:none" type="button" id="opdEmrBtnId"  class="btn btn-info opdEmrBtn AddToggleClass" tabindex="0" data-toggle="tooltip" onclick="$('#opdEmrModal').modal('show');" title="Past Rx">Past Rx </button>
                  ...
                  <select name="deptUnitNamePB" id="deptUnitNamePB" class="form-control" style="color: #082b71;border-radius: 0px;" onchange="">
               ...
               <!--  </div>	 -->                 
                      ...
                      <div class="col-sm-7 col-md-5" style="margin-top:5px;">                    
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
       ...
       <!--  <button type="button" class="btn btn-primary" onclick="Save('printSave',this , 0)">Skip</button> -->
        <button type="button" class="btn btn-success" onclick="SaveRxProfileData('printSave',this , 1)">Save Bookmark</button>
      </div>
    </div>
       ...
       <table class="table table-bordered" id="example12">
          <thead>
            <tr>
              ...
              <!-- <th style="background-color:#ddd;color:black">Department</th> -->
     	...
     	//			JSONObject js=new JSONObject(strPrescriptionProfileJSON.get(i));
            ...
            <tr>
             ...
             <!--  <button type="button" class="dtHide" ><i class="fas fa-minus"></i></button> -->
              ...
              <%-- <td><%= (((JSONObject)((JSONObject)strPrescriptionProfileJSON.get(ii)).get("HJOSN_RX_COMPLETE")).get("PatCompleteGeneralDtl")).toString().split("#")[1]  %></td> --%>
...
$(document).ready(function() {
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="">Close</button>
                  ...
                  <div class="prescriptionTile" style="/* padding: 1% 3% 3% 3%; */">
                    ...
                    <div class="row" style="display:none">
                        ...
                        <div class="form-group col-xs-12 col-md-11 col-sm-12">
                          <textarea class="form-control" onblur="abortMic(this)" id="hopiId" name="hopi" maxlength="3000" ></textarea>
                          <div class="micDiv">
           ...
           <!--
               ...
               -->  
                      ...
                      <button type="button" id="strDyanmicHistoryTemplateId" value="46#1" class="btn:hover:focus btn-sm vitalModifyBtn AddToggleClass" onclick="OpenTemplate(this)" tabindex="0" data-toggle="tooltip" style="margin: 5px; float:right;color:#f8fbff;font-weight: bold;border-radius: 50%;background-color: #2361f7;" title="" data-original-title="History Template">HT</button>
                      <button type="button" id="strDyanmicExaminationTemplateId" value="47#1" class="btn:hover:focus btn-sm vitalModifyBtn AddToggleClass" onclick="OpenTemplate(this)" tabindex="0" data-toggle="tooltip" style="margin: 5px; float:right;color:#f5f7f9;font-weight: bold;border-radius: 50%;background-color: #ff7f00;" title="" data-original-title="Examination Template">ET</button>                                                      
                      <button type="button" class="btn:hover:focus btn-sm " value="48#1" onclick="OpenTemplate(this)" style="margin: 5px; float:right;color:#f5f7f9;font-weight: bold;border-radius: 50%;background-color: #0fd508; " data-toggle="tooltip" title="Complaint Template">CT</button>                          
                                                </div>
                    ...
                    <div id="completeHistoryDiv" style="display:none;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-11 col-sm-12">
                              <textarea class="form-control" onblur="abortMic(this)" id="pastHistoryId" name="pastHistory" maxlength="2000"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-11 col-sm-12">
                              <textarea class="form-control" onblur="abortMic(this)" id="personalHistoryId" name="personalHistory" maxlength="2000"></textarea>
                          <div class="micDiv" style="right:17px;">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;color:darkolivegreen;font-size:1.2em" class="stop-btn fas fa-microphone  blink"></i>
							</div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-11 col-sm-12">
                              <textarea class="form-control" onblur="abortMic(this)" id="familyHistoryId" name="familyHistory" maxlength="2000"></textarea>
                          <div class="micDiv" style="right:17px;">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-11 col-sm-12">
                              <textarea class="form-control" onblur="abortMic(this)" id="treatmentHistoryId" name="treatmentHistory" maxlength="2000"></textarea>
                             <div class="micDiv" style="right:17px;">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
							</div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-11 col-sm-12">
                              <textarea class="form-control" onblur="abortMic(this)" id="surgicalHistoryId" name="surgicalHistory" maxlength="2000"></textarea>
                           <div class="micDiv" style="right:17px;">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
							</div>
 ...
 -->
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-md-11 col-sm-12">
                        <textarea class="form-control" onblur="abortMic(this)" id="diagnosisNoteId" name="diagnosisNote" maxlength="2000"></textarea>
                        <div class="micDiv">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
						</div>
                  ...
                  <div class="prescriptionTile" style="/* padding: 1% 3% 3% 3% */">
                    <div class="row">
                      ...
                      <div class="col-sm-2 col-md-1 prescriptionTileRowsCol" style="display:none">
...
<div class="clearfix visible-xs" style="margin-top:5px;"></div>
                   ...
                   <!-- <button class="btn btn-info" type="button" onclick="$('#externalInvestigationInput').slideToggle();$(this).find('i').toggleClass('fa-plus fa-minus');"><i class="fa fa-plus"></i> Add External Investigation</button> -->
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-md-11 col-sm-12">
                        <textarea class="form-control" onblur="abortMic(this)" id="investigationNoteId" name="investigationNote" maxlength="2000"></textarea>
                         <div class="micDiv">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
						</div>
                  ...
                  <div class="prescriptionTile" style="/* padding: 1% 3% 3% 3%; */">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-10 col-md-11 prescriptionTileRowFirstCol">
                        <p class="clinicalProceduresAdded"><b>Procedure(s) advised/Treated :</b> 
                          <a style="text-decoration: none;" class="clearLnk">
                            <img style="width: 22px;" alt="" src="/HIS/hisglobal/drDeskAssets/img/clear3.png">
                          </a>
                    ...
                    <div class="row ClinicalPrcoeduresDiv">
                      <div class="clearfix visible-xs" style="margin-top:5px;"></div>
                       ...
                       <div class="col-xs-8 col-sm-4 col-md-2 clinicalProcedureCol">
                          <select class="form-control" name="clinicalServiceArea" id="clinicalServiceAreaId" autocomplete="off">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-xs-12 col-md-11 col-sm-12">
                        <textarea class="form-control" onblur="abortMic(this)" id="treatmentAdviceId" name="treatmentAdvice" maxlength="2000" placeholder="Do not advice drugs here..,drugs are to be prescribed drug advice section"></textarea>
                         <div class="micDiv">
                                 <i  class="start-btn fas fa-microphone-slash" ></i>
                                 <i  style="display:none;" class="stop-btn fas fa-microphone  blink"></i>
						</div> 
                    ...
                    <div class="row">
                      <div class="col-sm-12" style="padding-left: 7px;">
                        ...
                        <a style="text-decoration: none;" class="clearLnk">
						  ...
						  <button type="button" class="btn btn-info" style="display:none" data-toggle="modal" data-target="CimsIntegrationId" style="float:Right;background-color:#ed6c68; border:0px;" onclick="loadDoc()">Drug Health Alert</button>
						  &nbsp;<button type="button" class="btn btn-info" style="display:none" data-toggle="modal" data-target="CimsAlleryId" onclick="CimsAlleryDoc()" style="float:right;margin-right: 11px;">Drug Interactions</button>
						</p>
                        <br>
                        <%
                     ...
                     if(DrugProfile!=null)
                   	...
                   	for(String key : keys){ 
                   		...
                   		%>
                   		 <button class="btn btn-primary btn-xs investigationTestTriggerBtn" type="button" onclick="$('#investigationTestBundle<%=key.split("#")[0] %>').modal('show');"><%=key.split("#")[1] %></button>		
                   		<%
                   ...
                   <button id="externalDrugBtn" class="btn btn-info" type="button" onclick="if($('#allergiesModal').is(':visible')){$('#allergiesAddBtn').click();}
                    ...
                    <button id="allergiesAddBtn" style="display:none" class="btn btn-info" type="button" onclick="if($('#externalDrugInput').is(':visible')){$('#externalDrugBtn').click();}
          ...
          <div id="BrandMonogramResponse"> </div>    
                 ...
                 <!--  <div class="col-xs-1 col-sm-1">
                       ...
                       <!--  <div class="col-sm-2" align="right"> -->
                         ...
                         <!--  <div class="col-xs-2 col-sm-2" style="padding: 0 1px"> -->
                          <div class="col-sm-2 col-md-2">
                           ...
                           <option value="4"> External Hospital</option>
                           <!-- <option value="5">Associated Hospital</option> -->
                           <option value="5">Private Empanelled Hospital</option>
                           </select>
                          </div> 
                          
                          
                          <!-- <div class="col-xs-2 col-sm-2" style="padding: 0 1px ; display: none;"  id="strExternalrefferalHospitalDivId"> -->
				  ...
				  <option value="0">Select Hospital</option>				                  <%
                           ...
                           <!-- <div class="col-xs-2 col-sm-2" style="padding: 0 1px; display: none;" id="strExternalrefferalInstituteDivId"> -->
                           <div class="col-sm-2 col-md-2" style="display: none;" id="strExternalrefferalInstituteDivId">
            			 <select class="form-control"  id="strExternalrefferalInstituteId" name="strExternalrefferalInstitute" >
                          ...
                          <!-- <div class="col-xs-3 col-sm-3" id="refferlPatientDeptDivId" style="display: block;" > -->
                     ...
                     <!-- <div class="col-xs-3 col-sm-3" style="display: none;" id="strExternalDepartmentListDiv" > -->
                          ...
                          <!--  <div class="col-xs-3 col-sm-3" style="padding: 0 1px ; display: none;" id="strOtherHospitalNameDivId"> -->
                      ...
                      <!--      <input type="text" class="form-control" onkeypress="" name="refferalResonId"  id="refferalResonId" value="" placeholder="Enter Referral Reason"> --> 
                            <textarea class="form-control" name="refferalResonId" id="refferalResonId" rows="1" style="height:34px;" placeholder="Enter Referral Reason"></textarea>
                          </div>
                  ...
                  <div class="prescriptionTile" style="/* padding:1% 3% 3% 3% */">
                     ...
                     <br><br>
                     <p><b>Follow Up And Visit Summary : </b></p>
                     <div class="row">
                       <div class="col-sm-2">
                      ...
                      <div class="row followUpPlannedVisit">
                        ...
                        <div class="clearfix visible-xs" style="margin-top:5px;"></div>
                        <div class="col-sm-1">
                          <label><input type="checkbox" name="followUpPlannedVisitSos" id="followUpPlannedVisitSosId">  SOS</label>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4">
                          <div class="col-xs-8 col-sm-8" style="padding: 0 1px" >
                            <input class="form-control" type="date" style="line-height: normal;display:none" name="followUpPlannedVisitDate" id="followUpPlannedVisitDateId">
                          </div>
                          <div class="col-xs-4 col-sm-4" style="padding: 0 1px">
                            <label style="color:rgba(75,75,75, 0.7); letter-spacing:0.5; font-size:14px;display:none">Scheduled Date</label>
                          </div> 
                        </div>
                        <div class="clearfix visible-xs" style="margin-top:5px;"></div>
                        <!-- <div class="col-sm-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-9 col-sm-9">
                          <textarea class="form-control" onblur="abortMic(this)" id="progressNote" name="progressNote" rows="7" maxlength="5000" placeholder="Enter Clinical Notes"  tabindex="13"></textarea> 
						<div class="micDiv">
                                 <i style="display:none" class="stop-btn fas fa-microphone blink" ></i>
                                 <i   class="start-btn fas fa-microphone-slash"></i>
                      ...
                      <div class="row">
                        <div class="col-sm-9 col-sm-offset-3">
                         ...
                         <!--   	<div class="col-md-8 col-md-8 text-center">
                            	...
                            	<button type="button" class="btn btn-primary" style="display: none;" onclick="Save('printSave',this , 0)">Preview Bookmark</button>
                            	 <a  class="prescPrintBtn1" data-toggle="modal"  style="display:none"><button class="btn btn-primary">Save</button></a> 
                            	 <a  class="prescPrintBtn" data-toggle="modal" ><button class="btn btn-primary btn-lg">Save</button></a> 
                            	<br><br><br><br><br><br>
...
function endTreatmentFun(e){
	...
	else
	{
		...
		$('.followUpPlannedVisit').hide();
                 ...
                 <div class="col-sm-3 col-md-3 patSummaryTile" style="display:none; padding: 0px; background: url('/HISDRDESK_MC/new_opd/img/bg2.png') no-repeat; background-size: cover;margin: 2% 0 0 0; min-height: 618px;">
