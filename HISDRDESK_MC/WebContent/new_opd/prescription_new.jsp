...
<link rel="stylesheet" href="/HIS/hisglobal/js/jquery/multiselect/css/bootstrap-multiselect.css">
  <script type="text/javascript" src="/HIS/hisglobal/js/jquery/bootstrap-multiselect.js"></script>
   -->
<script type="text/javascript" src="/HISDRDESK_MC/new_opd/js/myScript_new.js"></script> 
...
<!-- Buttons and Image tag for Uploaded Prescriptions starts here --> 
  ...
  <img id="prescImgFixed" src=""  style="position:fixed; display:none; right:0; z-index:9999;top:0px; width:auto;height:100vh"/> <!-- /HISDRDESK_MC/new_opd/img/pat_presc.jpg -->
                  ...
                  <div class="prescriptionTile" style="/* padding: 1% 3% 3% 3%; */">
                    ...
                    <div class="row">
                      <div class="col-sm-10 col-md-11 prescriptionTileRowFirstCol">
                        ...
                        ><i class="fa fa-plus" style="color:#2196F3 "></i><b>&nbsp;Procedure(s) advised/Treated :</b> 
                          <a style="text-decoration: none;" class="clearLnk">
                            <img style="width: 22px;" alt="" src="/HIS/hisglobal/drDeskAssets/img/clear3.png">
                          </a>
	...
	else
	{
		...
		$('.followUpPlannedVisit').hide();
                 ...
                 <div class="col-sm-3 col-md-3 patSummaryTile" style="display:none; padding: 0px; background: url('/HISDRDESK_MC/new_opd/img/bg2.png') no-repeat; background-size: cover;margin: 2% 0 0 0; min-height: 618px;">
                  <img id="patSummaryTileImg" src="/HISDRDESK_MC/new_opd/img/img_avatar.png" class="img-circle img-responsive" style="width: 70px; float: right;">
