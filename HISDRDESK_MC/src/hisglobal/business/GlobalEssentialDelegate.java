...
public class GlobalEssentialDelegate extends Delegate
{
	 ...
	 * GlobalEssentialBOi serviceBO = (GlobalEssentialBOi)
	 * super.getServiceProvider(); return (serviceBO.getSoftwareList(softwareVO));
	 * 
	 * }
	 */
	...
	public List getPatientAuditLogEssentials(UserVO userVO) {
		GlobalEssentialBOi serviceBO = (GlobalEssentialBOi) super.getServiceProvider();
		return (serviceBO.getPatientAuditLogEssentials(userVO));
	}

	/*
	 * public Map getPatientAuditLogDataList(List<PatientAuditLogMstVO>
	 * patientAuditLogVOList, String patCrNo, UserVO userVO) { GlobalEssentialBOi
	 * serviceBO = (GlobalEssentialBOi) super.getServiceProvider(); return
	 * (serviceBO.getPatientAuditLogDataList(patientAuditLogVOList,patCrNo,userVO));
	 * }
	 */
