...
public List<Report> getReportList(String crNo,String hosCode){
	...
	//getInvestigationListMoblie
	
	
public List<InvestigationData> getInvestigationListMoblie(String crNo,String hosCode){
		
		//System.out.println("Calling..Service");
    	String err = "";
    	String status="";
        String proc_name1 = "{call pkg_webservices_inv.getreportrawdatamoblie(?,?,?,?)}";
            ...
            if ((ws = dao.getWebRowSet(procIndex1, "resultset")) != null && ws.size() > 0) {
                ...
                while (ws.next()) {
                	...
                	if(tempTestCode != null && tempTestCode.equals(ws.getString(1)) && tempEntryDate != null && tempEntryDate.equals(ws.getString(7))){
    					ParamDetails p = new ParamDetails(ws.getString(4),ws.getString(5) ,ws.getString(6),ws.getString(3));
    					param.add(p);
    					//System.out.println("Data>>"+ws.getString(4)+ws.getString(5) +ws.getString(6)+ws.getString(3)+ws.getString(7));
                	}else{
    					param = new ArrayList<ParamDetails>();
    					tempTestCode = ws.getString(1);
    					tempEntryDate = ws.getString(7);
    					ParamDetails p = new ParamDetails(ws.getString(4),ws.getString(5) ,ws.getString(6),ws.getString(3)+ws.getString(8)+ws.getString(9));
    					param.add(p);
    					p.setReqDNo(ws.getString(8));
    					p.setHospCode(ws.getString(9));
    					p.setParameterCode(ws.getString(3));
    					lst.add(new InvestigationData(ws.getString(2), ws.getString(7),param));
    					//System.out.println("Data>>"+ws.getString(8));
    				//	System.out.println("Data>>"+ws.getString(4)+ws.getString(5) +ws.getString(6)+ws.getString(3)+ws.getString(7)+ws.getString(2));
    				}
