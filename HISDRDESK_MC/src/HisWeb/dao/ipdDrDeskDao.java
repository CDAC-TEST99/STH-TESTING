...
public class ipdDrDeskDao {
	...
	public static String SaveDrugAdviceData( String JsonData)
	{
        ...
        try {
		   			...
		   			for (int i=0 ;i<DrugObjArray.length();i++)
		   			{
		   				try {
								...
								dao.setProcInValue(procIndex1, "deptcode", PatCompleteGeneralDtl.split("#")[6],28);
		   						...
		   						HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveDrugAdviceData() inside forloop -->", "lineNumber -> "+lineNumber+" : "+"JSON -> "+DrugObjArray.get(i)+" :: "+e.getMessage() + "-->" + e);
		   						e.printStackTrace();
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveDrugAdviceData()-->", "lineNumber : "+lineNumber+" :: "+e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String SaveAdmDrugAdviceData( String JsonData)
	{
        ...
        try {
		   			...
		   			for (int i=0 ;i<DrugObjArray.length();i++)
		   			{
		   				try {
								...
								lineNumber++;
		   						...
		   						HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveAdmDrugAdviceData() inside forloop -->", "lineNumber -> "+lineNumber+" : "+"JSON -> "+DrugObjArray.get(i)+" :: "+e.getMessage() + "-->" + e);
		   						e.printStackTrace();
		   						// return "Something Went Wrong";
		   					}
		   	    	}
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveAdmDrugAdviceData()-->", "lineNumber : "+lineNumber+" :: "+e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String SaveInvData(String JsonData) {
        ...
        try {
		   ...
		   //}
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveInvData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String SaveGenralData(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveGenralData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String SaveVisitReasonData(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveVisitReasonData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String FollowUpDTL(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.FollowUpDTL()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String SaveAllergyData(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveAllergyData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String SaveChronicData(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveChronicData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String SaveHistoryOfPresentIllNess(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveHistoryOfPresentIllNess()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String SaveCompleteHistoryData(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveCompleteHistoryData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String SaveExamniationData(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveExamniationData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String saveReferPatientDetails(String JsonData) {
		...
		//System.out.println("admissionNo"+object.get("admissionNo"));
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.saveReferPatientDetails()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "2";
        }
        finally {
	...
	public static String SaveVitalData(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveVitalData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "0";
        }
        finally {
     ...
     //System.out.println("method called for ipd savePrecriptionProfileData for table check--->");
        ...
        try {
   		...
   		Integer strStatus=(Integer) object.get("strStatus");
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SavePrescriptionBookMarkData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "0";
        }
        finally {
	...
	public static String SaveEMRVitalData(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveEMRVitalData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "0";
        }
        finally {
	...
	public static String getModifyVitalData(String JsonData) throws JSONException {
        ...
        try {
          ...
          mainObj.put("VitalDtls", jsonolist);
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.getModifyVitalData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
	...
	public static void SaveGenralDataFormattedData(String JsonData) {
       ...
       //System.out.println("method called for ipd SaveGenralDataFormattedData for data check---->");
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveGenralDataFormattedData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return ;
        }
        finally {
	...
	public static String SaveChiefComplaintData( String JsonData)
	{
        ...
        try {
   			...
   			if(reasonOfVisitArr!=null)
			{
				...
				for (int i = 0; i < reasonOfVisitArr.length(); i++) {
					try {
						...
						HisException eObj = new HisException("OPD Ver-2.0",
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveChiefComplaintData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String saveOperationDetails(String JsonData)
	{
		...
		try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.SaveDrugAdviceData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String saveClinicalProcedure(String JsonData)
	{
		...
		try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.saveClinicalProcedure()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "Something Went Wrong";
        }
        finally {
	...
	public static String getDrugRoute(String drugItemTypeId){
		...
		mainObj.put("drugRoute_details", jsonolist);
			...
			e.printStackTrace();
			HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.getDrugRoute()-->", e.getMessage() + "-->" + e +" Status -->"+status);
            e.printStackTrace();
            return "Something Went Wrong";
			//return mainObj.toString();
		}
	...
	public static String getMotherAdmDtl(String patAdmNo,String hospCode){
		...
		mainObj.put("json_details", jsonolist);
			...
			e.printStackTrace();
			HisException eObj = new HisException("OPD Ver-2.0","opdDrDeskDao.getMotherAdmDtl()-->", e.getMessage() + "-->" + e +" Status -->"+status);
            e.printStackTrace();
            return "Something Went Wrong";
			//return mainObj.toString();
		}
	...
	public static String revokeDrugData(String JsonData) {
        ...
        try {
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","ipdDrDeskDao.revokeDrugData()-->", e.getMessage() + "-->" + e);
            e.printStackTrace();
            return "0";
        }
        finally {
