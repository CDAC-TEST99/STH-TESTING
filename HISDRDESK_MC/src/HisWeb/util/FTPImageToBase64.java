...
public class FTPImageToBase64 {
	 ...
	 public static String getImageAsBase64( String strFileName,String subFolderName) {
		 	URL urlftp = null;
	        ...
	        try {
	        	urlftp = new URL(ftpUrl + "/" + folderName + "/" + subFolderName + "/" + strFileName);
	        	//System.out.println("Retrieve file: " + urlftp );
