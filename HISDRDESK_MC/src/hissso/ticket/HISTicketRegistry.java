...
public final class HISTicketRegistry implements TicketRegistry
{
	...
	public HISTicketRegistry()
	{
		...
		//System.out.println("HIS_MC Ticket Registry --> Registry Initalized");
	}

	public void addTicket(final Ticket ticket)
	{
		//System.out.println("HIS_MC Ticket Registry --> Ticket Added::" + ticket.getTicketId());
	...
	public Ticket getTicket(final String ticketId)
	{
		...
		//System.out.println("HIS_MC Ticket Registry --> Retrieving Ticket ::" + ticketId);
	...
	public boolean deleteTicket(final String ticketId)
	{
		...
		//System.out.println("HIS_MC Ticket Registry --> Removing Ticket::" + ticketId);
		final Ticket ticket = this.cache.get(ticketId);
		if(ticket != null)
		{
	...
	public Ticket getTicketBasedOn(final String userId)
	{
		...
		//System.out.println("HIS_MC Ticket Registry --> Retrieving Ticket By User ID ::" + userId);

		final Ticket ticket = this.userTicketCache.get(userId);
		if (ticket == null)
			System.out.println("HIS_MC Ticket Registry --> Ticket Not Found By User ID ::" + userId);
	...
	public Ticket getTicketBasedOn(final String grantingTicketId, final HISService objService)
	{
		...
		//System.out.println("HIS_MC Ticket Registry --> Retrieving Ticket By TGT ID and Service Context ::" + grantingTicketId + " & " + objService.getContext());

		final Ticket ticket = this.tgtServiceTicketCache.get(grantingTicketId+"#"+objService.getContext());
		if (ticket == null)
			System.out.println("HIS_MC Ticket Registry --> Ticket Not Found By TGT ID and Service Context ::" + grantingTicketId + " & " + objService.getContext());
