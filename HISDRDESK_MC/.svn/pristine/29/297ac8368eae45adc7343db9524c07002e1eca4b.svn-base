...
public class Utility {
	...
	public static  byte[] getReportMongo(String filename, String hosCode ) 
	{
		byte[] byteArray=null;
	...
	//    String strPdfPath = patientcreatefileftpaddress+"/"+filename.substring(0,5)+"/"+ "20"+year+"/"+insideyear+"/"+count+"/"+filename.substring(0,15)+"/"+filename;
		// String strPdfPath = patientcreatefileftpaddress+"/"+crno+"/"+filename.substring(0,15)+"/"+hosCode;
		 String strPdfPath = patientcreatefileftpaddress+"/"+hosCode+"/"+crno+"/"+filename;
		try {
