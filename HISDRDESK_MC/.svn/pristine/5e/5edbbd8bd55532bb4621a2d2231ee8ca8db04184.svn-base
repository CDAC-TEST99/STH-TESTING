			...
			<tr>
				<td>
					<HIS_MC:ButtonToolBarTag>
						<img style="cursor: pointer" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' onKeyPress="if(event.keyCode==13) validateOnSave('MODIFYSAVE')" onClick='validateOnSave("MODIFYSAVE");' tabindex="1" />
