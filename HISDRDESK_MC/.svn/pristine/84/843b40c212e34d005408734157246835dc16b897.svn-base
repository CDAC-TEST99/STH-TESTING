...
<table width="80%" align="center">
       <tr>
	   <td align="right">
	   <img src='<HIS_MC:path src="/hisglobal/images/e_sushrut_header.gif"/>'> 
	   </td>		
			<td height="19" valign="bottom">
				<div align="right">
					<a href="/startup/cnt_login.jsp?loginMode=LOGOUT&uid=null">
						<img src='<HIS_MC:path src="/hisglobal/images/btn-logout.png"/>' border="0">
					</a>
				</div>
			</td>
		</tr>
 ...
 %>
  ...
  <tr>
        <td  colspan="5" class="addtoolbar" style="border-top:outset 2px black; border-bottom:inset 2px black">	
          <div align="center">
          <logic:notEmpty name="<%=Config.ROSTER_SEQUENCE_DETAILS_ARR%>"> 
		        <a style=cursor:pointer><img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' class="link"  tabindex="1"  onClick="finalSave('SAVE')" /></a>
         </logic:notEmpty>
	            <a style=cursor:pointer><img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' width="60" height="20" tabindex="0" onKeyPress="if(window.event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");'/></a>
             </div>    
	     </td>      
