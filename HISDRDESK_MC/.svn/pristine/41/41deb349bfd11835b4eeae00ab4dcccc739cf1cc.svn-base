...
public interface Config {
	...
	String CR_NO_FORMAT_SIZE = CR_NO_FORMAT_SIZE_FIFTEEN;
	...
	// -- HIS_MC Resource Bundle
	String RESOURCE_BUNDLE_PROPERTY_FILE_PATH = "hisglobal.hisconfig.hisResourceBundle";

	// **** Storage Paths ************************************************
	// Registration
	String PATIENT_IMAGE_FILE_STORAGE_PATH = "C:/PHDM/HISDRDESK_MC/PatientImages";
	String PATIENT_IMAGE_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/PatientImages";
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH = "c:/PHDM/HISDRDESK_MC/MlcDocImages";
	String MLC_DOC_IMAGE_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/MlcDocImages";
	...
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/PatientExaminationEditorImageDIR";
	//String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_WINDOWS = "E:/VASU/WORKSPACES_VASU/NIMS_23_AUG_2017/.metadata/.plugins/org.jboss.ide.eclipse.as.core/JBoss_6.x_Runtime_Server1503464848285/deploy/HIS.war/hisglobal/images/testSave";
	
	String IMAGE_EDITOR_EXAMINATION_PATIENTS_IMAGES_PATH_LINUX = "/PHDM/HISDRDESK_MC/PatientExaminationEditorImageDIR";
	...
	// Document Upload
	String OPD_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/PatDocumentUploadFiles";
	String OPD_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/PatDocumentUploadFiles";

	// Data Source
	String NOSQL_MONGO_DATASOURCE_DOCUMENT_UPLOAD = "nosqlmongohispatdocs";
	String NOSQL_MONGO_DATASOURCE_PATIENT_IMAGE_UPLOAD = "nosqlmongohispatimages";
	String NOSQL_MONGO_DATASOURCE_GENERATED_PATIENT_PROFILE_UPLOAD = "nosqlmongohispatprofilegenerated";
	String NOSQL_MONGO_DATASOURCE_MORTUARY_PATIENT_IMAGE_UPLOAD = "nosqlmongohismortuarypatimages";

	
	
	// Image Editor
	String IMAGE_EXAMINATION_IMAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/ImageExaminationFiles";
	String IMAGE_EXAMINATION_IMAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/ImageExaminationFiles";
	...
	String OPD_AUDIO_VIDEO_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/AudioVideoPlayerFiles";
	String OPD_AUDIO_VIDEO_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/AudioVideoPlayerFiles";

	// Generic Template
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/GenericTemplateDIR";
	String GENERIC_TEMPLATE_HTML_DOCUMENT_FILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/GenericTemplateDIR";
	...
	String PATIENT_PROFILE_STORAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/PatientProfileDIR";
	String PATIENT_PROFILE_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/PatientProfileDIR";
	String PATIENT_PROFILE_FILE_STORAGE_EXT = ".htm"; // concatenated with
														// Patient Profile Id

	// /Mortuary Patient Image
	String MORTUARY_PATIENT_IMAGE_PATH_WINDOWS = "C:/PHDM/HISDRDESK_MC/Mortuary";
	String MORTUARY_PATIENT_IMAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/Mortuary";
	...
	// //////////////User for prompting and forcing the user to change HIS_MC
	...
	// printing////////////////////////////////////
	String PRINT_PDF_FILE_PATH_WINDOWS = "C:/HMIS_Sikkim/printFile";
	String PRINT_PDF_FILE_PATH_LINUX = "/opt/Arunachal_PHDM/printFile";
	...
	String DISASTER_PLAN_STORAGE_PATH_WINDOW = "C:/PHDM/HISDRDESK_MC/DisasterPlan";
	String DISASTER_PLAN_STORAGE_PATH_LINUX = "/PHDM/HISDRDESK_MC/DisasterPlan";
	...
	String QUERY_FILE_FOR_DAO ="hisglobal.persistence.globalQuery"; //Added by Vasu on 14.Nov.17
	
	// treatment advice type for advice at discharge
		String TREATMENT_ADVICE_TYPE_DEFUALT = "1";  // Treatment given by TREATMENT ADVICE process
		String TREATMENT_ADVICE_TYPE_DISCHARGE = "2";  // Treatment given by  ADVICE AT DISCHARGE process
