...
<body>
	...
	<HIS_MC:TransactionContainer>	
		<HIS_MC:TitleTag name="Parameter Master>>Add">
		</HIS:TitleTag>
		<HIS_MC:ContentTag>
				...
				<!-- 	<img  class="button" src='/HIS/hisglobal/images/snomedct.png' style="cursor:pointer;vertical-align: middle;"
				 ...
				 -->
					...
					<HIS_MC:ButtonToolBarTag>
						<img class="button" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' style="cursor:pointer" onclick="validate('SAVE')" onkeypress="if(event.keyCode==13) validate('SAVE')">
