...
<div style="z-index: -1">
	      <div id="printPrescPage" class="container printPrescPage"> 
           <div class="row Logoimg" id="LogoimgId">
				<div style="float:left">
					<img alt="" src="/HIS/hisglobal/assets/img/logo.png" style="height: 56px"></div><br>
			...
			<div class="row divPrintPrescPatDtlTbl" id="divPrintPrescPatDtlTblId"  style="border-top: 1px solid grey; border-bottom: 1px solid grey;">
				<table class="table table-condensed printPrescPatDtlTbl">
					<tbody>
						...
						<tr>
							<th>Visit Date</th><td class="patVisitDate"></td></td><th>Consultant</th><td class="consultantName"></td>
						</tr>
						<tr>
			...
			<br>
			<p style="margin-left: 0%;"><small class="investigationNoteID"></small></p>
			<br>
			...
			<h5 style="margin-top:1"><%=request.getSession().getAttribute("UserName").toString() %> </h5> 
	...
	$(document).ready(function(){
	  ...
	  if(myJSON==undefined)
		...
		$('.printPrescPage .visitDateonsultannt').text(datef.split('/')[2]+'/'+datef.split('/')[1]+'/'+datef.split('/')[0]);
