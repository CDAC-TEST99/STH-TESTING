...
<div style="z-index: -1">
	...
	$(document).ready(function(){
	  ...
	  if(myJSON==undefined)
		...
		if($('input[name=strRailTailFlg]').val() == '1')						//don't show consultantName in case of Railtel 
...
<input type="hidden" name="strRailTailFlg" value="${DoctorDeskFB.strRailTailFlg}"/>
</body>
</html>