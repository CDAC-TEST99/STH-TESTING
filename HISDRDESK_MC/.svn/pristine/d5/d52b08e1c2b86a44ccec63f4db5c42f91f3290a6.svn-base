...
public class HISConfig {
		...
		public static String IMAGE_FOR_HEADER_WINDOWS="C:/HMIS_Sikkim/AHIMSG5/reportimage/nimsHeaderForDesk.jpg";
		public static String IMAGE_FOR_HEADER_LINUX="/opt/Arunachal_PHDM/AHIMSG5/reportimage/nimsHeaderForDesk.jpg";
}
