...
public class FormFieldValidationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		else if(uri.contains("DynamicReportsTransCNT") ||uri.contains("DynamicReports") || uri.contains("/HBIMS/ipd/transactions/AdmissionAdviceTransCNT.cnt")|| uri.contains("/HBIMS/ipd/transactions/PatientFinalDischargeCNT.cnt"))
		{
			chain.doFilter(request, response);
		}
		else
