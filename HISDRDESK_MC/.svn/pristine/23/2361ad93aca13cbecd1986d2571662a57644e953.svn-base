...
<HIS_MC:css src="/hisglobal/utility/generictemplate/css/generic_chart.css"/>
				...
				<tr>
					<td width="100%" class="tdfonthead">
						<div align="left">
							...
							<img src='<HIS_MC:path src="/hisglobal/images/btn-pnt.png"/>' onKeyPress="if(window.event.keyCode==13) printPage();" onClick='printPage();'>
							&nbsp;&nbsp;
							<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' onKeyPress="if(window.event.keyCode==13) window.close();" onClick='window.close();'>
						</div>
					</td>
				</tr>
			</table>
