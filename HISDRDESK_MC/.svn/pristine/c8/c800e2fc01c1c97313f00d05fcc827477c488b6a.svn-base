package QMS.transaction.controller.util;
...
public class QmsUTIL extends ControllerUTIL {

	public static StringBuffer getPatientsCount(QmsFB objFB, HttpServletRequest request, HttpServletResponse response) 
	{
	...
	public static boolean getSetDoctorDashboardEssentials(QmsFB objFB, HttpServletRequest request, HttpServletResponse response) 
	{
		boolean flg = true;
		StringBuffer sbAjaxRes = new StringBuffer();
		//System.out.println("BackgroundQuery.doGet()");
	...
	public static void AJX_G_PATIENTS_COUNT_NEW(QmsFB opdPatientDeskFB,	HttpServletRequest objRequest, HttpServletResponse objResponse,ActionMapping objMapping_p) 
	{		
