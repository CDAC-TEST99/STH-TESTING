...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<HIS_MC:javascript src="/hisglobal/js/MastersAddModifyValidations.js" />
		<HIS_MC:javascript src="/hisglobal/js/time.js" />
		<HIS_MC:javascript src="/hisglobal/js/validationCommon.js" />
		<HIS_MC:javascript src="/hisglobal/js/validationCalls.js" />
					...
					<td>
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							...
							<tr>
								...
								%>
								<HIS_MC:date name="<%=c%>" dateFormate="%d-%b-%Y" value="<%=val%>" />
								<%
										}
										else
										{
			...
			<tr>
				<td>
					<HIS_MC:ButtonToolBarTag>
						<img style="cursor: pointer" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-sv.png"/>' onKeyPress="if(event.keyCode==13) validateOnSave('ADDSAVE')" onClick="validateOnSave('ADDSAVE');" tabindex="1" />
						<img style="cursor: pointer" src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' onKeyPress="if(event.keyCode==13) submitpage('CANCEL')" onClick='submitpage("CANCEL");' tabindex="1" />
