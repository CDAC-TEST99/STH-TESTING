 ...
 %>
  ...
  <tr>
      <td  colspan="3" class="addtoolbar" style="border-top:outset 2px black; border-bottom:inset 2px black">	
          <div align="center">
          <logic:notEmpty name="<%=Config.SEQUENCE_DETAILS_ARR%>">
		  	 <a style=cursor:hand><img src="<HIS_MC:path src='/../HIS/hisglobal/images/btn-sv.png'/>"   class="link"  tabindex="1"  onKeyPress="if(window.event.keyCode==13)finalSave('SAVE');" onClick="finalSave('SAVE')"></a>
       	  </logic:notEmpty>
	      <a style=cursor:hand><img src="<HIS_MC:path src='/../HIS/hisglobal/images/buttons/btn-ccl.png'/>" class="link"  tabindex="1"  onKeyPress="if(window.event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");'/>
	      </a>
	      </div>
	  </td>          
