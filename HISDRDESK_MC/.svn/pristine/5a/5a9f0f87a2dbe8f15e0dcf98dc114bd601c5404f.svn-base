...
<html:form action="/transaction/IPDDoctorDeskAction.cnt"  name="IPDDoctorDeskFB" type="new_ipd.transaction.fb.IPDDoctorDeskFB" method="post" enctype="multipart/form-data"> 
<%-- <table>
<tr>
  ...
  <input type="button" onclick="save_file()" value="Upload">
    ...
    <div class="container-fluid">
	    ...
	    <div class="row" style="margin-top:2rem;margin-left:2.5rem;">
	   	 	...
	   	 	<div class="col-md-11">
	   	 		<span style="color: red;">(only *.pdf files, size less than 5 MB will be uploaded.  Don't use any special characters in filename.)</span>
	   	 	</div>
	   	 </div>
      ...
      <input type="hidden" name="strFileData" value="${IPDDoctorDeskFB.strFileData}"/>
         <input type="hidden" id="strMsgTypeid" name="strMsgType" value="${IPDDoctorDeskFB.strMsgType}"/>
  </html:form>
