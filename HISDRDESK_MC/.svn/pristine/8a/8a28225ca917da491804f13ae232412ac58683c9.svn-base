...
public class HISSSOClientRequestFilterDrDesk implements Filter
{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
	{
		...
		try
		{
			...
			//System.out.println("DR Desk URI HISSSOClientRequestFilter "+strURI);
			...
			if (strURI.contains("/sse")  ||  strURI.contains("/new_opd/transaction/OPDDisplayBoard.cnt")|| strURI.contains("/new_opd/transaction/OPDQueueDisplayForPatient.cnt")  || strURI.contains(HISSSOClientConfig.SSO_ST_SERVICE_URL) || strURI.contains("/op/pb") || strURI.contains("rest") ||strURI.contains("service") || strURI.contains("QMS/QMS.jsp") || strURI.contains("websocket") )
			{
				// Forward as-it-is
