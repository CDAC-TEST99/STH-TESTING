...
public class IPDDoctorDeskVO {
	...
	private WebRowSet strWardWb=null;
	private String strHiddenWardCode;
	...
	private WebRowSet strOperationListweb=null;
	private WebRowSet strSurgeonListweb=null;
	...
	public WebRowSet getStrWardWb() {
		return strWardWb;
	}

	public void setStrWardWb(WebRowSet strWardWb) {
		this.strWardWb = strWardWb;
	}

	public String getStrHiddenWardCode() {
		return strHiddenWardCode;
	}

	public void setStrHiddenWardCode(String strHiddenWardCode) {
		this.strHiddenWardCode = strHiddenWardCode;
	}
	...
	public WebRowSet getStrOperationListweb() {
		return strOperationListweb;
	}

	public void setStrOperationListweb(WebRowSet strOperationListweb) {
		this.strOperationListweb = strOperationListweb;
	}

	public WebRowSet getStrSurgeonListweb() {
		return strSurgeonListweb;
	}

	public void setStrSurgeonListweb(WebRowSet strSurgeonListweb) {
		this.strSurgeonListweb = strSurgeonListweb;
	}
