...
public class OPDTemplateMstUtil {
	 ...
	 public static String getPrintBase64(String printData, HttpServletRequest request ,String myJSON , String varid,String imgs) throws Exception {
		 String logoPath="/opt/Arunachal_PHDM/investigationReportEssential/sikkimlogo.jpg"; //linux path by default
		 Map<String,Object> tmpData=null;byte[] encodedBytes=null;
		 try {
			 	 
			 if(System.getProperties().getProperty("os.name").startsWith("Win"))
				 logoPath =	"C:\\HMIS_Sikkim\\investigationReportEssential\\sikkimlogo.jpg" ;  //if windows
...
String patDtlIpd=  ""
				/*+"<table>"
						...
						+"<td>"
							...
							+"<td colspan='3'><h3>"+obj.get("strHospitalName")+"</h3><h5 align='center'>"+obj.get("strHospitalAddres")+"</h5></td>"
							+"</tr></table>"
							+"<table><tr><td align='center'><u><font color='blue'>IPD Prescription</font></u></td></tr></table>"
							+"<p>_____________________________________________________________________________</p>"*/
							+"<table width='100%' style='font-size:small;font-family:Arial'>"
							+"<tr >"
							+"<td style='font-weight: bold;'>Patient Name:</td>" 
					...
					//	+"<p><font align='left' size='x-large;'><b>"+"Rx: "+obj.get("tempName")+"</b></font><br><br>";
						+"<p style='font-size:medium;font-family:Arial;font-weight: bold'>"+"Rx: "+obj.get("tempName")+"</p><br><br>";
						if(!obj.get("patQueueNo").equals("") && !obj.get("patQueueNo").equals("0"))
							printData=patDtl+printData;
						else
							printData=patDtlIpd+printData;
	...
	public static void  UplodaHTML(OPDTemplateMstVO vo) {
		...
		//commented by ashutoshk to save tmeplate html globally i.e. at hospital code 100
		...
		final	String ftpfilepath=OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+"100"+"/"+vo.getStrTemplateNo()+".html";	
		setCreantials(OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+"100");
	...
	public static void  UplodaModifyHTML(OPDTemplateMstVO vo) {
		...
		final	String ftpfilepath1=OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+"100"+"/"+vo.getStrTemplateNo()+"_Modify.html";
		URL urlftp=null;
		URLConnection urlc=null;
		//FileInputStream inputStream = null;
	...
	public static String  getHtmlFileFromFTP(String strTemplateFileCode , String HospCode) {
		...
		final	String ftpfilepath=OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+"100"+"/"+strTemplateFileCode.trim()+".html";
		URL urlftp=null;
		URLConnection urlc=null;
		//FileInputStream inputStream = null;
	...
	public static String  getModifyHtmlFileFromFTP(String strTemplateFileName , String HospCode) {
		...
		final	String ftpfilepath=OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+"100"+"/"+strTemplateFileName.trim()+"_Modify.html";
		URL urlftp=null;
		URLConnection urlc=null;
		//FileInputStream inputStream = null;
		StringBuilder content = new StringBuilder();
...
public static String getFTPServerIP() {
	...
	public static void  uploadpdf(byte[] data , String myJSON , String varid) throws JSONException {
		...
		if(object.getString("admNo")!=null && !object.getString("admNo").equals("0"))
			fileName = object.getString("CR_No")+"_"+object.getString("episodeCode")+"_"+object.getString("episodeVisitNo")+"_"+object.getString("strDate")+"_"+varid;
		else
			fileName = object.getString("CR_No")+"_"+object.getString("episodeCode")+"_"+object.getString("episodeVisitNo")+"_"+varid;
		
		//System.out.println("fileName=="+fileName);
		
		final	String ftpfilepath=OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+object.getString("Hosp_Code")+"/"+fileName+".txt";
		setCreantials(OPDTemplateMstUtil.getFtpPath()+"/OPDLiteTemplate/"+object.getString("Hosp_Code"));
		URL urlftp=null;
		URLConnection urlc=null;
 ...
 //HIS_FTPSERVER_USERNAME_
	 ...
	 public static String  uploadFileFromDrDeskIPD(FormFile myFile , IPDDoctorDeskFB formBean) {
			OutputStream ios=null;
			final	String ftpPath = OPDTemplateMstUtil.getFtpPath()+"/OPDLitePatientDocs/"+formBean.getStrFileData().split(",")[1]+"/";
			String filename = myFile.getFileName();
			if(filename != null)
