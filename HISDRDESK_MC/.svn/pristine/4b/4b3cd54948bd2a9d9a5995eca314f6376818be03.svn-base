...
public class OPDReferralVO {
	...
	private String strPatReferred;
	private String isScriber;
	private String hospitalType;
	private String isSmartQMSEnabled;
	...
	private WebRowSet strGroupTestWb=null;
	...
	private ArrayList<JSONObject> strPrevChronicDtlJSON=null;
	private ArrayList<JSONObject> strPrevAllergyDtlJSON=null;
	...
	private WebRowSet strEmpanelledDepartmentListweb=null;
	private ArrayList<JSONObject> strLastThreeVisit=null;
	private ArrayList<JSONObject> strPatRefferalDtls=null;

	private ArrayList<JSONObject> strInvDrugPrevCodeJSON=null;
	...
	public WebRowSet getStrGroupTestWb() {
		return strGroupTestWb;
	}

	public void setStrGroupTestWb(WebRowSet strGroupTestWb) {
		this.strGroupTestWb = strGroupTestWb;
	}

	public ArrayList<JSONObject> getStrLastThreeVisit() {
		return strLastThreeVisit;
	}

	public void setStrLastThreeVisit(ArrayList<JSONObject> strLastThreeVisit) {
		this.strLastThreeVisit = strLastThreeVisit;
	}

	public String getStrPatReferred() {
		return strPatReferred;
	}

	public void setStrPatReferred(String strPatReferred) {
		this.strPatReferred = strPatReferred;
	}

	public ArrayList<JSONObject> getStrPatRefferalDtls() {
		return strPatRefferalDtls;
	}

	public void setStrPatRefferalDtls(ArrayList<JSONObject> strPatRefferalDtls) {
		this.strPatRefferalDtls = strPatRefferalDtls;
	}

	public ArrayList<JSONObject> getStrPrevChronicDtlJSON() {
		return strPrevChronicDtlJSON;
	}

	public void setStrPrevChronicDtlJSON(ArrayList<JSONObject> strPrevChronicDtlJSON) {
		this.strPrevChronicDtlJSON = strPrevChronicDtlJSON;
	}

	public ArrayList<JSONObject> getStrPrevAllergyDtlJSON() {
		return strPrevAllergyDtlJSON;
	}

	public void setStrPrevAllergyDtlJSON(ArrayList<JSONObject> strPrevAllergyDtlJSON) {
		this.strPrevAllergyDtlJSON = strPrevAllergyDtlJSON;
	}

	public ArrayList<JSONObject> getStrInvDrugPrevCodeJSON() {
		return strInvDrugPrevCodeJSON;
	}

	public void setStrInvDrugPrevCodeJSON(ArrayList<JSONObject> strInvDrugPrevCodeJSON) {
		this.strInvDrugPrevCodeJSON = strInvDrugPrevCodeJSON;
	}

	public WebRowSet getStrEmpanelledDepartmentListweb() {
		return strEmpanelledDepartmentListweb;
	}

	public void setStrEmpanelledDepartmentListweb(WebRowSet strEmpanelledDepartmentListweb) {
		this.strEmpanelledDepartmentListweb = strEmpanelledDepartmentListweb;
	}

	public String getIsScriber() {
		return isScriber;
	}

	public void setIsScriber(String isScriber) {
		this.isScriber = isScriber;
	}
	...
	public String getIsSmartQMSEnabled() {
		return isSmartQMSEnabled;
	}

	public void setIsSmartQMSEnabled(String isSmartQMSEnabled) {
		this.isSmartQMSEnabled = isSmartQMSEnabled;
	}
