...
public class DrugListDAO  {
	...
	public static void getInitilaData(DrugListVO vo) {
		...
		String strproc_name = "{call pkg_opdDrDesk_view.Proc_patient_dtl1(?,?,?,?,?,?,?,?)}";
		HisDAO dao = null;
		HisUtil util = null;
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getInitilaData()-->", _Err.getMessage() + "-->" + _Err);
	...
	public static void getInvestogation(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getInvestogation()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static void getdrugdtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getdrugdtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static void getdrug_dosage_dtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getdrug_dosage_dtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static void getMacrosDtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getMacrosDtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static void getDeptDtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getDeptDtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static void getBookMarksTestDtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getBookMarksTestDtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
	...
	public static String getPrevData(DrugListVO vo) {
        ...
        try {
          ...
          if(ws != null){
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getPrevData()-->", e.getMessage() + "-->" + e);
        	vo.setStrMsgType("1");
            e.printStackTrace();
            return jsonolist.toString();
        }
	...
	public static String getPrevDataInv(DrugListVO vo) {
        ...
        try {
          ...
          if(ws != null){
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getPrevDataInv()-->", e.getMessage() + "-->" + e);
        	vo.setStrMsgType("1");
            e.printStackTrace();
            return jsonolist.toString();
        }
	...
	public static String getPrevVisitReason(DrugListVO vo) {
        ...
        try {
          ...
          if(ws != null){
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getPrevVisitReason()-->", e.getMessage() + "-->" + e);
        	vo.setStrMsgType("1");
            e.printStackTrace();
            return jsonolist.toString();
        }
	...
	public static String getPrevDiagnosisDtl(DrugListVO vo) {
        ...
        try {
          ...
          if(ws != null){
        	...
        	HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getPrevDiagnosisDtl()-->", e.getMessage() + "-->" + e);
        	vo.setStrMsgType("1");
            e.printStackTrace();
            return jsonolist.toString();
        }
	...
	public static void getDIAGNOSISDtl(DrugListVO vo) {
		...
		try {
			...
			HisException eObj = new HisException("OPD Ver-2.0","DrugListDAO.getDIAGNOSISDtl()-->", _Err.getMessage() + "-->" + _Err);
			_Err.printStackTrace();
			vo
