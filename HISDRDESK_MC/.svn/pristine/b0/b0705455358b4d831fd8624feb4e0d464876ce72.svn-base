			...
			<%-- <tr>
				<td>
					<div align="right" id="noPrint">
						<a>
							<img src='<HIS_MC:path src="/hisglobal/images/btn-pnt.png"/>' onKeyPress="if(window.event.keyCode==13)printPage();" onClick='printPage();' tabindex="1">
						</a>
						<a>
							<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-ccl.png"/>' onKeyPress="if(window.event.keyCode==13)submitpage('CANCEL');" onClick='submitpage("CANCEL");' tabindex="1">
						</a>
					</div>
				</td>
			</tr>
