...
<HIS_MC:javascript src="/hisglobal/masterutil/js/master.js"/>
...
<html>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<HIS_MC:javascript src="/hisglobal/js/masters.js" />
		<HIS_MC:javascript src="/hisglobal/js/time.js" />
		<HIS_MC:css src="/hisglobal/css/masterXml.css" />
		...
		<table width=80%>
			<tr>
				...
				<td class="MasterXMLDataLabel">
					...
					<a style="cursor: hand">
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/avai/arrow_up.gif"/>' style="cursor: pointer" width='10' height='10' border=0 alt='Ascending order' onkeypress="if(event.keyCode==13) sortOnColasc('<%=colno%>'); " onClick="sortOnColasc('<%=colno%>')" tabindex="1" >
					</a>
					<a style="cursor: hand">
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/avai/arrow_down.gif"/>' style="cursor: pointer" width='10' height='10' border=0 alt='Desccending order' onkeypress="if(event.keyCode==13) sortOnColdsc('<%=colno%>'); " onClick="sortOnColdsc('<%=colno%>')" tabindex="1">
					</a>
				</td>
				<%
					}
			...
			<tr>
				<td class="MasterXMLDataLabel" style="vertical-align: middle">
					<div align="right" style="vertical-align: middle">
						...
						<img src='<HIS_MC:path src="/hisglobal/images/btn-search.png"/>' style="cursor: pointer;" onKeyPress="if(window.event.keyCode==13) submitpage('SEARCH');" onClick="submitpage('SEARCH');" tabindex="1">
					</div>
				</td>
			</tr>
		</table>
				...
				<td>
					<HIS_MC:ButtonToolBarTag>
						<logic:equal name="mstHandlerListForm" property="isActive" value="1">
							<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-add.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) add(event);" onClick='add(event);' tabindex="1">
						</logic:equal>
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-mo.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) edit(event);" onClick='edit(event);' tabindex="1">
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-del.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) del(event);" onClick='del(event);' tabindex="1">
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-view.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) view(event);" onClick='view(event);' tabindex="1">
						<img src='<HIS_MC:path src="/../HIS/hisglobal/images/buttons/btn-rpt.png"/>' style="cursor: pointer;" onKeyPress="if(event.keyCode==13) report(event);" onClick='report(event);' tabindex="1">
						<%
...
<div align="center"><b><HIS_MC:status /></b></div>
</body>
