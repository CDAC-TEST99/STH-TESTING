...
function AjaxGetLabList() {
  ...
  var url = "/HISInvestigationG5/new_investigation/PatientDiagnosisReport.cnt?hmode=" + _mode;
...
function AjaxGetMachineList(labCode) {
  ...
  var url = "/HISInvestigationG5/new_investigation/PatientDiagnosisReport.cnt?hmode=" + _mode + "&labCode=" + labCode;
...
if(machineId=="1")
  ...
  var table = $('#DataTable1').DataTable({
    ...
    "ajax": {
      "url": "/HISInvestigationG5/new_investigation/PatientDiagnosisReport.cnt?hmode=" + _mode + "&labCode=" + labCode + "&testCode=" + machineId + "&fromDate=" + fromDate + "&toDate=" + toDate,
      sync: true,
      postData: "",
      handleAs: "text",
