...
<head>
  <title>Sample Rejection Report List</title>
  ...
  <!--Custome Resources----->
  <script type="text/javascript" src="media/reports/js/SampleRejection.js"></script>
...
<body>
  <html:form action="/SampleRejectionReportList" enctype="multipart/form-data">
    ...
    <div class="mx-md-0 shadow rounded bg-white no-gutters">
      <div class=" row p-3 p-md-1 align-items-center shadow rounded bg-white no-gutters d-flex justify-content-center">
        ...
        <div class="col-md-3.5 mr-md-2 ml-md-1 ">
          <p class="" style="font-weight: bold;font-size: 21px;"><span><img height="42" width="42" src='media/images/medical-history.svg'></span> Sample Rejection Report </p>
        </div>
      ...
      <table id="DataTable1" class="table table-sm table-condensed table-striped table-bordered table-hover dt-responsive nowrap mx-md-0 shadow rounded bg-white" style="width:100%">
        <thead>
          <tr>
            ...
            <th>Cr. No.</th>
            <th>Dept(Ward)Name</th>
            <th>Sample No.</th>
            <th>Patient Name</th>
            
            <th>Sample Rejection Reason</th>
            <th>Sample Rejection Date/Time</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
