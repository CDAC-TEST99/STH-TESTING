...
<head>
  ...
  <!--Custome Resources----->
  <script type="text/javascript" src="media/reports/js/PatientDiagnosisReport.js"></script>
...
<body>
  <html:form action="/PatientDiagnosisReport" enctype="multipart/form-data">
    ...
    <div class="mx-md-0 shadow rounded bg-white no-gutters">
      <div class=" row p-3 p-md-1 align-items-center shadow rounded bg-white no-gutters d-flex justify-content-center">
        ...
        <div class="col-md-3.5 mr-md-2 ml-md-1 ">
          <p class="" style="font-weight: bold;font-size: 21px;"><span><img height="42" width="42" src='media/images/medical-history.svg'></span>Patient Diagnosis Report </p>
        </div>
      ...
      <table id="DataTable1" class="table table-sm table-condensed table-striped table-bordered table-hover dt-responsive nowrap mx-md-0 shadow rounded bg-white" style="width:100%">
        <thead>
          <tr>
            ...
            <th>Lab No.</th>
            <th>Patient History/Diagnosis</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
