...
<body class="">
 ...
 %>
		...
		<div class="container-fluid px-1 px-sm-3 mb-2 noUserSelect" id="container2">
			<div class="mx-md-1 mx-md-point5 row  p-2 px-3 align-items-center shadow rounded-lg bg-white no-gutters hover-shadow collapse show" id="container2Row1">
				<div class="col-md-12 " >

					<div class="mx-md-0 row  no-gutters d-flex justify-content-center">
						<div class="col-12 col-md-3 mr-md-2 mt-md-2  form-group ">
              				<div class='input-group d-flex flex-nowrap'>
								<div class="input-group-append">
									<select class="form-control" id="inputTypeBC">
										<option value="1">Ben Id :</option>
								...
								<input type="text" class="form-control" id="crNoInput" placeholder="Enter Ben.Id"  value="">
								<!--961011900000758 961011900012918 961011900005024 961011900005083 961011900000952 961011900014945-->
						...
						<div class='col-12 col-md-2 mr-md-2 mt-md-2 inputDates d-none'>
						...
						<div class="col-md-1 mt-md-2 pl-md-4 getDataBtnDiv">
							<button id="getData" type="button" class="btn btn-primary ">
								<i class="text-nowrap"> Track </i>
							</button>
					...
					<div class="mx-md-0 row align-items-center no-gutters d-flex justify-content-center">

						<div class="divArchivalbtn1 mx-md-3 mt-2 pr-4 pr-md-1">
							<label><h6 class="card-subtitle mb-2 text-muted">
									The request shown below is from last three months [<%=mDate%>]
									of Lab Request.<!-- , To view request older than three months -->
								</h6></label>
							<button id="btnDataFromArchival1" type="button" class="btn btn-sm btn-warning d-none">
								<a class="text-nowrap ">Click Here</a>
							</button>
						</div>

						<div class="divArchivalbtn2 mx-md-3 mt-2 pr-4 pr-md-1 d-none">
							<label><h6 class="card-subtitle mb-2 text-muted">
								The request shown below is from and beyond three months of Lab
								Request, To view request of only last three months</h6></label>
							<button id="btnDataFromArchival2" type="button" class="btn btn-sm btn-warning">
								<a class="text-nowrap">Click Here</a>
							</button>
						</div>
			...
			<div id='app1' class="mx-md-1 mx-md-point5 p-2 shadow rounded-lg bg-white hover-shadow">
				...
				<table id="DataTable4"
					...
					<thead>
						<tr>
							<th class="all"><i
								class="fas fa-chevron-circle-up text-danger d-none collapseButton"></i>
		...
		<%-- <html:hidden name="InvTrackingReportFB" property="hospitalCode_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="crNo" />
		<%-- <html:hidden name="InvTrackingReportFB" property="crNo_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="billNo" />
		<%-- <html:hidden name="InvTrackingReportFB" property="billNo_url" /> --%>
		...
		<%-- <html:hidden name="InvTrackingReportFB" property="searchType_url" /> --%>
		 
		<html:hidden name="InvTrackingReportFB" property="isGroup" />
		<%-- <html:hidden name="InvTrackingReportFB" property="isGroup_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="testCode" />
		<%-- <html:hidden name="InvTrackingReportFB" property="testCode_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="groupCode" />
		<%-- <html:hidden name="InvTrackingReportFB" property="groupCode_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="requisitionNo" />
		<%-- <html:hidden name="InvTrackingReportFB" property="requisitionNo_url" /> --%>
		
		<html:hidden name="InvTrackingReportFB" property="requisitionDNo" />
		<%-- <html:hidden name="InvTrackingReportFB" property="requisitionDNo_url" /> --%>
	
		<html:hidden name="InvTrackingReportFB" property="forTestOrGroupOrAll" />
		<%-- <html:hidden name="InvTrackingReportFB" property="forTestOrGroupOrAll_url" /> --%>
