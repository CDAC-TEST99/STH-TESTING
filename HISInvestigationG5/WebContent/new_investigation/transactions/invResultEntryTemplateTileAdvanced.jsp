...
<script type="text/javascript"
	src="/HISInvestigationG5/new_investigation/js/ckeditor/ckeditor.js"
...
<!-- <link rel="icon" href="/HISInvestigationG5/hisglobal/snomedct/css/images/csnotk.ico">
 <script type="text/javascript" src="/HISInvestigationG5/hisglobal/snomedct_1/ext/js/jquery.js"></script> -->
<!-- <script type="text/javascript" src="/HISInvestigationG5/hisglobal/snomedct_1/ext/js/jquery.autocomplete.js"></script> -->
<!-- <script type="text/javascript" src="/HISInvestigationG5/hisglobal/snomedct_1/js/searchtool.js"></script> -->
<!-- <script type="text/javascript" src = "/HISInvestigationG5/new_investigation/js/invsnomed.js"></script> -->

<!-- <link href="/HISInvestigationG5/hisglobal/snomedct/css/searchtoolnew.css" rel="stylesheet"> -->
<link href="/HISInvestigationG5/hisglobal/snomedct/css/jquery-ui.css"
	rel="stylesheet">

<!-- <script type="text/javascript" src="/HISInvestigationG5/hisglobal/snomedct/js/searchtoolnewautocomplete.js"></script> -->

<!-- <script type="text/javascript" src="/HISInvestigationG5/hisglobal/snomedct/js/jquery-1.11.2.js"></script>
 -->
<link rel="stylesheet"
	href="/HISInvestigationG5/hisglobal/snomedct/ext/js/jquery.autocomplete.js">
<link rel="stylesheet"
	href="/HISInvestigationG5/hisglobal/snomedct/ext/js/jquery-ui.custom.min.js">
<!-- <link href="/HISInvestigationG5/hisglobal/snomedct/css/searchtool.css" rel="stylesheet"> -->

<script language="JavaScript" type="text/javascript"
	src="/HIS/hisglobal/js/jquery/jquery.searchabledropdown-1.0.8.min.js"></script>
<script language="JavaScript" type="text/javascript"
...
<%@page import="new_investigation.InvestigationConfig"%>
<!-- added by Harshita khare on 12/02/2019  -->
	<his:javascript src="/new_investigation/js/specialCharacterRemover.js" />
...
/* function hyper(thiss,url1)
{
	 ...
	 openPopup('/HISInvestigationG5/new_investigation/antibioticprocesss.cnt',300,700)
 ...
 */
 ...
 /* 
  function loadDependentControlTempl(obj)
  {
  //  alert("loadDependentControlTempl"+obj.value);
      //  alert("loadDependentControlTemplname"+obj.name);

           var val=obj.name.split("#")[3]+""+obj.value;
           alert("val"+val);
        var IsparameterDependent=checkIsparameterDependent(val);

        alert("IsparameterDependent"+IsparameterDependent);

        if(IsparameterDependent!='0')
            {
            alert("inside");
        /*  for(var a=0;a<document.getElementsByName("chkResultEntryPatient").length;a++)
         {
            ...
            document.getElementsByName("chkResultValidationPatient")[a].checked=true;
            	 
          } */

         
         /*   var strStoreId=obj.name;
           strStoreId=strStoreId.split("#")[3]+""+obj.value;
           document.getElementsByName('dependentelementcode')[0].value=strStoreId;
          alert("aa"+document.getElementsByName('dependentelementcode')[0].value); */
         //var val=document.forms[0].strStoreId[document.forms[0].strStoreId.selectedIndex].text;
           //   alert(val);
             // return null;
  		//var testCode = document.getElementsByName("dependentelementcode")[0].value;
         //     alert(testCode);
              //return null;

  			//submitPage('SHOWPATDETAILS');
  			 /*    var testCode=document.getElementsByName('testCode')[0].value;
  	var labCode=document.getElementsByName('labCode')[0].value;
         alert("testCode"+testCode+"labCode"+labCode); */
...
//  	var reqformtestcodes=document.getElementsByName('reqformtestcodes')[0].value;
  		...
  		/* var cbs =document.getElementsByName('selectedCheckbox')[0].value;
...
function newtestraised(val)
{
 ...
 //  alert("new est"+val);
  // var	concatenateChkBoxVal="961011800000181$9610110001180731100002$961011000118073110000201$null$10002$10001$@";
      ...
      var table = document.getElementById("tbll");
           ...
           if(checktest=='')
            ...
            var cell1 = row.insertCell(0);
            		var cell2 = row.insertCell(1);
            		cell1.innerHTML = (document.getElementsByName("chkResultEntryPatient")[a].value).split("#")[17]; 
          //alert("xx"+(document.getElementsByName("chkResultEntryPatient")[a].value).split("#")[27]);
            		if((document.getElementsByName("chkResultEntryPatient")[a].value).split("#")[27]=="1")
            			cell2.innerHTML = "<img height='20px' title='Requisition Form' src='/HISInvestigationG5/hisglobal/images/reqForm.png' onClick='ShowRequistionForm("+"\""+(testCode)+"\""+","+"\""+(testName)+"\""+","+"\""+(labCode)+"\""+","+"\""+(labName)+"\""+","+"\""+(dNo)+"\""+","+"\""+(reqNo)+"\""+")'>";
...
//		var elementCode=thisobj.name.split('#')[3];
		mywindow=window.open (url1+"?requisitionDNo="+values[0]+"&showStatus="+status+"&testParaCode="+values[3],"_blank","scrollbars=1,directories=no, status=no,width=700, height=500,top=200,left=500");
...
function hyper(thiss,url1)
{
	...
	//alert(a);
      ...
      if(url1!=null && url1!=""  && url1.includes("/HISInvestigationG5/new_investigation/echo.cnt"))
          {
                 var idd=thiss.id;
                 alert("idd"+idd);
             	document.getElementById(idd).id=idd+"$$echo";
                
                // this.idd=idd+"@@echo";
          }
        
//	var elementCode=thisobj.name.split('#')[3];
	mywindow=window.open (url1+"?requisitionDNo="+values[0]+"&showStatus="+status+"&testParaCode="+values[3],"_blank","scrollbars=1,directories=no, status=no");
	/*mywindow.moveTo(300,300); */
             ...
             if(id.indexOf("template")!=-1)
                 {
            	  ...
            	  if(id.includes("$$echho")==false  ) // not to add file upload view hyperlink option by chandan 
                  {
                       id=id.split("$$")[0];
                  }
          ...
          /*   //alert(name);
           ...
           /*     if(id.contains('auto'))    
             ...
             /*   if(typ!=checkboxcheck)
               ...
               */    //alert("1 " +name);
               var orderingValue="1";
               if(document.getElementsByName(id+"#order")[0]!=undefined)
                orderingValue= document.getElementsByName(id+"#order")[0].value;

               var resultEntryTemplateValue="";
               if(document.getElementsByName('hyperLinkTableSession')[0]!=undefined)
                 resultEntryTemplateValue=document.getElementsByName('hyperLinkTableSession')[0].value;
                        // alert("id"+id);
...
<!-- <body onload="autovalue();checkEntryType();onloadHideShow();openLastPage();"> --> 
 <body onload="updateSelctBox();autovalue();checkEntryType();onloadHideShow();"> 

	<html:form action="/invResultEntryTemplateTileAdvanced"
		...
		<input type="hidden" name="echodata" value="" />
		...
		<%-- <his:ContentTag> --%>
		 ...
		 <logic:equal name="InvResultEntryFB" property="showStatus" value="0">
			...
			<logic:present name="<%=InvestigationConfig.LIST_SAMPLE_COLLECTION_VO%>">
				<logic:notEqual name="InvResultEntryFB" property="isSampleAreaSelected" value="1">
				   ...
				   <div class="container">
					...
					<table width="100%">
						...
						<tr align="right">
							...
							<td align="left">
						        <span class="dropdown">
									 <html:select name="InvResultEntryFB" property="sampleAreaCode" tabindex="1" onchange="showSearchDiv(this)">
					...
					<logic:equal name="InvResultEntryFB" property="isSampleAreaSelected" value="1">
                           ...
                           <table>
                              <tbody>
								...
								<td><html:radio
										...
										value="1"></html:radio> <font
															color="#ffffff" size="2" 
															face="Verdana, Arial, Helvetica, sans-serif"><strong><bean:message key="newEntry" />&nbsp;</strong></font>

									<html:radio name="InvResultEntryFB" tabindex="1"
										property="newEntry" value="2"></html:radio>  <font
															color="#ffffff" size="2" 
															face="Verdana, Arial, Helvetica, sans-serif"><strong><bean:message
										key="entered" />&nbsp;</strong></font>
										
									<html:radio name="InvResultEntryFB" tabindex="1" property="newEntry"
										value="3"></html:radio> <font
															color="#ffffff" size="2" 
															face="Verdana, Arial, Helvetica, sans-serif"><strong> Drafts &nbsp;</strong></font>
								</td>
								</tr>
									</tbody>
								</table>
						...
						<tr>
							...
							<td>
								<logic:present	name="<%=InvestigationConfig.LAB_COMBO_FOR_RESULT_ENTRY%>">
									...
									<html:select name="InvResultEntryFB" property="labCode" tabindex="1" onchange="labBased()" >
							...
							<td>
									...
									<html:select name="InvResultEntryFB" property="searchBy" tabindex="1" onchange="showReqDate();callGetDetails();" >
			...
			<!-- -----------------------------------START: Unused code  ------------------------------------------------------------ -->		
					...
					<tr id="trReqDate" style="display: none;">
			...
			<logic:present name="<%=InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO%>">
			    ...
			    <thead style="background-color: #1E90FF">
					<tr>
						...
						<th width="7%" align="left"><b> <font color="#FFFFFF"
								size="2" face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
										key="patStatus" /></font></b></th>
											<th align="left">
										<b> 
											<font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
												<logic:equal name="InvResultEntryFB" property="searchBy" value="1">  
													Requisition Date
												</logic:equal>
												<logic:equal name="InvResultEntryFB" property="searchBy" value="0">  
													Acceptance Date
												</logic:equal>
											</font>
										</b>
						...
						<th width="5%" align="left" class="no-sort"><b> <font color="#FFFFFF"
				...
				<tbody>
						...
						<tr>
							...
							<td width="10%" align="left" style="display: none"><font color="#000000" size="2"
							...
							<td width="10%" align="left"><font color="#000000" size="2"
								face="Verdana, Arial, Helvetica, sans-serif"> <%=voPat.getGroupName().equals("NA")?voPat.getTestName():voPat.getGroupName()%></font>
					...
					<logic:equal name="InvResultEntryFB" property="israisingsave"
						value="1">
			...
			<table width="100%">
					<tr>
						...
						<td class="tdfonthead" width="79%">
							<div align="left">
								<font color="#000000" size="2"
									face="Verdana, Arial, Helvetica, sans-serif"> <%=invresultentryvo.getVisitReason()==null?"":invresultentryvo.getVisitReason()%>
								</font>
							</div>
						</td>
					</tr>
		...
		<his:ButtonToolBarTag>
			...
			<logic:equal name="InvResultEntryFB" property="newEntry" value="1">
				<%-- <img class="button"
					...
					<!--   <a id="nextDiv" href="#" onclick="displaySamplePatDetails();"
						 onkeypress="if(event.keyCode==13)  displaySamplePatDetails();"
										 	class="btn btn-info btn-sm">
											<span class="glyphicon glyphicon-print"></span>Enter Results
        								</a>  -->
        			<a id="nextDiv" href="#" class="btn btn-info btn-sm" style="display: none;" onclick="displaySamplePatDetails();">
          			<span class="glyphicon glyphicon-print"></span> Enter Results
        				</a>
					...
					onkeypress="if(event.keyCode==13)  displaySamplePatDetails();"> --%>
					  <a id="nextDiv" href="#" onclick="displaySamplePatDetails();"
						 onkeypress="if(event.keyCode==13)  displaySamplePatDetails();"
											...
											<span class="glyphicon glyphicon-print"></span>Modify
        								</a> 
			<%-- </logic:equal> --%>
			...
			<logic:present
				...
				<logic:equal name="InvResultEntryFB" property="newEntry" value="1">
					...
					<img class="button"
						...
						onkeypress="if(event.keyCode==13) onoSave();" tabindex="1"
						onclick="onSave();">
					...
					<img class="button"
						...
						onkeypress="if(event.keyCode==13) onSaveToDraft();" tabindex="1"
				...
				<logic:equal name="InvResultEntryFB" property="newEntry" value="3">
					...
					<img class="button"
						...
						id="saveDivDraft" onkeypress="if(event.keyCode==13) onModifyAndDraft();"
						tabindex="1" onclick="onModifyAndDraft();">
