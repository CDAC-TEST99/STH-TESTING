...
var jsonResponse = jQuery.parseJSON('<%= session.getAttribute("jsonResponse") %>');
'<% session.setAttribute("jsonResponse", null); %>'
	...
	if(jsonResponse != null && jsonResponse.isResultEntryResponse=="1") {
		...
		var interWinEvent = new CustomEvent('resultEntryResponse', { detail: jsonResponse })
...
<!-- <body onload="autovalue();checkEntryType();onloadHideShow();openLastPage();"> --> 
 <body onload="actionOnSessionVariables(); autovalue(); checkEntryType(); onloadHideShow();"> 

	<html:form action="/invResultEntryResp"
		...
		<html:hidden name="InvResultValidationRespFB" property="selectValuemapping"
			value="" />
		<html:hidden name="InvResultValidationRespFB" property="Counter" value="0" />
		...
		<html:hidden name="InvResultValidationRespFB" property="sizeOfFile" value="0" />
						...
						<div align="left">
							<font color="#000000" size="2"
								face="Verdana, Arial, Helvetica, sans-serif"> <html:text
									property="cannedCode" name="InvResultValidationRespFB"></html:text>
							</font>
						</div>
					</td>
				...
				<tr>
					...
					<td width="25%" class="tdfont">
						<div align="left">
							<font color="#000000" size="2"
								face="Verdana, Arial, Helvetica, sans-serif"> <html:text
									property="cannedName" name="InvResultValidationRespFB"></html:text> <input
		...
		<his:ContentTag>
			...
			%>
			<bean:define name="InvResultValidationRespFB" property="fromDate" id="frDate"
				type="java.lang.String" />
			<bean:define name="InvResultValidationRespFB" property="toDate" id="tDate"
				type="java.lang.String" />
			<bean:define name="InvResultValidationRespFB" property="fromCollDate"
				id="frCollDate" type="java.lang.String" />
			<bean:define name="InvResultValidationRespFB" property="toCollDate"
			...
			<logic:equal name="InvResultValidationRespFB" property="showStatus" value="0">
				...
				<logic:present
					...
					<table width="100%">
						...
						<tr>
							...
							<td class="tdfont" width="25%"><logic:notEqual
									name="InvResultValidationRespFB" property="isSampleAreaSelected"
									value="1">
									<span class="custom-dropdown small"> <html:select
											name="InvResultValidationRespFB" property="sampleAreaCode"
								...
								</logic:notEqual> <logic:equal name="InvResultValidationRespFB"
					...
					<!-- end chandan -->
					<logic:equal name="InvResultValidationRespFB"
						property="isSampleAreaSelected" value="1">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							...
							<tr>
								...
								<td width="25%" class="tdfont"><logic:present
										...
										<div align="left">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="labCode" tabindex="1"
													onchange="labBased()">
								...
								<td width="25%" class="tdfont"><html:radio
										name="InvResultValidationRespFB" tabindex="1" property="newEntry"
										value="1"></html:radio> <bean:message key="newEntry" />&nbsp;

									<html:radio name="InvResultValidationRespFB" tabindex="1"
										property="newEntry" value="2"></html:radio> <bean:message
										key="entered" />&nbsp;
										
									<html:radio name="InvResultValidationRespFB" tabindex="1" property="newEntry"
							...
							<tr>
								...
								<td width="25%" class="tdfont"><bean:message
									...
									<html:radio name="InvResultValidationRespFB" property="searchBy"
							...
							<tr>
								...
								<td width="25%" class="tdfont" colspan="3">
									<div align="left">
										&nbsp;&nbsp;&nbsp;
										<logic:equal name="InvResultValidationRespFB" property="generationType"
											value="P">

											<input type="radio" name="patientWise"
												onclick="getDetails(this)" checked="checked" value="P" />
										</logic:equal>
										<logic:notEqual name="InvResultValidationRespFB"
										...
										<logic:notEqual name="InvResultValidationRespFB" property="patientType"
											value="2">                                                                        
						&nbsp;&nbsp;&nbsp;
						<logic:equal name="InvResultValidationRespFB" property="generationType"
												value="S">
										...
										<logic:equal name="InvResultValidationRespFB" property="patientType"
											value="2">
																					&nbsp;&nbsp;&nbsp;
										<logic:equal name="InvResultValidationRespFB" property="generationType"
											value="L">
							...
							<tr>
									...
									<div align="right">
										<font color="RED" size="2"
											...
											face="Verdana, Arial, Helvetica, sans-serif"> <logic:equal
												...
												<bean:message key="crNO" />&nbsp;
								</logic:equal> <logic:equal name="InvResultValidationRespFB" property="generationType"
												value="T">
												<font color="RED" size="2"
								...
								<td width="25%" class="tdfont">
									...
									<div align="left" id="patientwise">
										...
										<div align="left" id="testwise" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="testWiseCode"
													tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
										...
										<div align="left" id="samplenowise" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="fromSampleNo"
													tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
										...
										<div align="left" id="labnowise" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="fromLabNo" tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
										...
										<div align="left" id="testGrpWise" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="testGroupCodeWise"
													tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
								...
								<td width="25%" class="tdfont">
									...
									<div align="right" id="toLabSampleNo" style="display: none;">
										<font color="#000000" size="2"
											...
											value="2">
											<logic:equal
												name="InvResultValidationRespFB" property="generationType" value="L">
												<font color="RED" size="2"
													face="Verdana, Arial, Helvetica, sans-serif"> * </font>
								...
								<td width="25%" class="tdfont"><logic:present
										...
										<div align="left" id="labnowise2" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="toLabNo" tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
														collection="<%=InvestigationConfig.LABNO_WISE_COMBO_FOR_RESULT_ENTRY%>"
														property="value" labelProperty="label" />
										...
										<div align="left" id="samplenowise2" style="display: none;">
											&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
													name="InvResultValidationRespFB" property="toSampleNo" tabindex="1">
													<html:option value="-1">Select Value</html:option>
													<html:options
														collection="<%=InvestigationConfig.SAMPLENO_WISE_COMBO_FOR_RESULT_ENTRY%>"
														property="value" labelProperty="label" />
		...
		<%-- <%
			//Pagination Logic
					...
					fbPage.setCurrentPage(((InvResultValidationRespFB)request.getAttribute("InvResultValidationRespFB")).getCurrentPage());
		...
		<logic:equal name="InvResultValidationRespFB" property="showStatus" value="0">
			...
			<logic:present name="<%=InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO%>">
				 ...
				 <thead>
					<tr>
						...
						<th width="12%" align="left"><b><font color="#000000"
								size="2" face="Verdana, Arial, Helvetica, sans-serif"> Ben ID </font></b></th>
				...
				<logic:equal name="InvResultValidationRespFB" property="israisingsave" value="1">
		...
		<logic:present name="<%=InvestigationConfig.LIST_RESULT_ENTRY_RESP_TEST_TEMPLATE_VO%>">
			...
			<%
				Map<String,List<ResultEntryVO>> _mpp=(Map<String,List<ResultEntryVO>>)session.getAttribute(InvestigationConfig.LIST_RESULT_ENTRY_RESP_TEST_TEMPLATE_VO);
					
			Map<String,String> pidmap=(Map<String,String>)session.getAttribute(InvestigationConfig.LIST_RESULT_ENTRY_RESP_TEST_TEMPLATE_VO_PID);
...
<html:hidden name="InvResultValidationRespFB" property="sampleAreaCode" />
 ...
 --%>
  		 ...
  		 --%>
							</div> <%-- 	 <html:file property="fileUpload" name="InvResultValidationRespFB" ></html:file> --%>
						</td>
					</tr>
				</table>
			</div>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td width="2%" class="tdfonthead">
						...
						<html:hidden name="InvResultValidationRespFB" styleId="<%=reqDno%>"
							value="<%=labCode%>" property="cannedLabCode" /> <html:hidden
							name="InvResultValidationRespFB" property="cannedOrMacroCheck" />
				...
				<tr>
					...
					<td width="78%" class="tdfonthead">
						<div align="left">
							...
							<html:hidden name="InvResultValidationRespFB"
					...
					<td width="78%" class="tdfonthead">
						<div align="left">
							...
							<logic:present
								...
								<html:select name="InvResultValidationRespFB" property="empNameWise"
									tabindex="1">
		...
		<tr>
				  				...
				  				<div align="left">
				      				...
				      				<html:select name="InvResultValidationRespFB" property="empNameWise"    tabindex="1"   >
				       					<html:option value="0">All</html:option>
 ...
 -->
		...
		<his:ButtonToolBarTag>
			...
			<logic:present
				name="<%=InvestigationConfig.LIST_RESULT_ENTRY_RESP_TEST_TEMPLATE_VO%>">
		...
		<html:hidden name="InvResultValidationRespFB" property="israisingsave" />
