...
<body onload="updateSelctBox(); checkEntryType(); ">
	<html:form action="/invResultValidationTemplateTileAdvanced">
										...
										<tr>	
											...
											<td>
												...
												<font
												 ...
												 <bean:message key="validate" />&nbsp; </strong></font>
												 <html:radio
												name="InvResultValidationFB" tabindex="1" property="newEntry"
												value="2"></html:radio> <font
															color="#ffffff" size="2" 
															face="Verdana, Arial, Helvetica, sans-serif"><strong><bean:message key="modifyValidate" />&nbsp;</strong></font>
												 <html:radio
												name="InvResultValidationFB" tabindex="1" property="newEntry"
							...
							<td>
	    						<table>
									<tr id="filter_col1" data-column="1">
								        ...
								        <td width="50%" align="left"><select id="grpNameFltr" style="width: 160px"><option value="">Select Groupname</option></select></td>
								   </tr>
								</table>   
	    					</td>
						    <td>
						    	<table>
									<tr id="filter_col2" data-column="2">
								        ...
								        <td width="50%" align="left"><select id="testNameFltr" style="width: 160px"><option value="">Select Testname</option></select></td>
								   </tr>
								</table>   
						    </td>
						</tr>
						...
						<table  id="table2" class="display cell-border responsive">
							<thead style="background-color: #1E90FF">
								<tr>
									...
									<!-- <th width="10%" align="left" style="display: none;"> -->
								...
								<tbody>
									...
									%>
												...
												<tr data-child-value="<%=childRowTable%>" style="background-color: <%=colorMap.get(voPat.getPatCRNo())%>">
													...
													<td align="left">
														<div>
															<font color="<%=color%>" size="2" face="Verdana, Arial, Helvetica, sans-serif">  <%=voPat.getGroupName().equals("NA")?voPat.getTestName():voPat.getGroupName() %></font></font>
														</div>
													</td>
													<!-- <td width="10%" align="left"> -->
													<td align="left">
													...
													<td align="left">
														<div>
															<font color="<%=color%>" size="2" face="Verdana, Arial, Helvetica, sans-serif">  <%=voPat.getTempSampleNo()==null?voPat.getLabNo():voPat.getTempSampleNo() %></font>
														</div>
													</td>
													<!-- <td width="10%" align="left"> -->
													<td align="left">
													...
													<td align="center">
														<div>
															...
															%>
																	...
																	%>
																		face="Verdana, Arial, Helvetica, sans-serif"> <%=voPat.getMachineCode()==null?"-":voPat.getMachineCode() %>
																	</font>
															<%
																}else{
															%>
													...
													<!-- <td width="5%" align="center"> -->
													<td align="center">
															<a href="#" onclick="displaySamplePatDetailsPopUp('<%=chkVal%>')">
																<span style="font-size: 15px;" class="glyphicon glyphicon-list-alt"></span>
															</a>
													</td>
		...
		<his:ButtonToolBarTag>
				...
				<logic:present
					...
					<logic:equal name="InvResultValidationFB" property="newEntry"
						...
						onkeypress="if(event.keyCode==13) onSaveValidationToDraft();" tabindex="1"
						onclick="onSaveValidationToDraft();">
