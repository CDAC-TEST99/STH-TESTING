...
<body onload="getPateintandTestDetails();getEpisodeDetails()">
...
<!----------------------------------------------------------------------End  ----------------------------------------------------------------->
<div class="container-fluid mb-2  patDetails" id="patDetails">
...
<bean:write name="NEWOfflineResultEntryFB" property="strMsgString" filter="false"/> 
              ...
              <div class="box-body" style="padding: 10px 3px 0px 3px;">
                ...
                <div id="newOfflineTestsListId" class="container-fluid mb-2 d-none "> 
                 ...
                 <div class="box-header" style="padding: 10px 0 10px 10px;;">
                   ...
                   <div class="box-body">
                  <div id="divtestdtl" style="font-size: 15px;">
 ...
 <input type="hidden" id="patCrNum" name="patCrNum"  value="<%=request.getAttribute("patCrNo")%>"> 
...
function getPateintandTestDetails(){
	...
	/// alert('isbillingreq'+$('#isbillingreq').val())
	  $.ajax({
        type: "POST",
        //url: "/HISInvestigationG5/new_investigation/NEWOfflineResultEntry.cnt?hmode="+_mode+"&varSSOTicketGrantingTicket="+ticket,
        //url: "/HISInvestigationG5/new_investigation/NEWOfflineResultEntry.cnt?hmode="+_mode+"&isbillingreq="+$('#isbillingreq').val()+"&varSSOTicketGrantingTickets="+ticket,
        url: "/HISInvestigationG5/new_investigation/NEWOfflineResultEntry.cnt?hmode="+_mode+"&isbillingreq="+$('#isbillingreq').val()+ "&patCRNo="+$('[name=patCrNum]').val()+"&varSSOTicketGrantingTickets="+ticket,
       // url: "/HISInvestigationG5/new_investigation/NEWOfflineResultEntry.cnt?hmode="+_mode+"&isbillingreq="+$('#isbillingreq').val()+ "&patCRNo="+$("[name=patCrNum]").val(),
    ...
    // console.log("fthfyt");
       /* if (crno.length == crnonew.length) { */
         ...
         //    alert("1.13");
		  ...
		  //	alert('patcrnum'+$('[name="patCrNum"]').val());
		 /// 	alert('patVisitNo'+$('[name="patVisitNo"]').val());
		  	$('.patDetails').removeClass("d-none");
		 ...
		 // 	alert("inside 34 ShowCheckboxTestDtl")
		   // console.log("patCrNum12: " + patCrNum); 
