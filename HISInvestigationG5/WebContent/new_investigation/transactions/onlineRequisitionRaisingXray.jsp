...
<div class="row-md-2" align="center">
			...
			<div class="row-md-2" align="center">
				<select style="" id="pregnantt"  class="form-control custom">
					<option>No</option>
					<option>Yes</option>
     ...
     <%}else{} %>
			...
			<div class="row-md-2" align="center">
				<input name="cheifcomplaints" type="text" class="form-control">
			</div>
			<div class="row-md-2" align="center">
				<b>Diagnosis :</b>
			</div>
			...
			<div class="row-md-2" align="center">
				<select style="" id="company" class="form-control custom">
					<option>No</option>
					<option>Yes</option>
...
<div class="row-md-2" align="center">
  ...
  <%
	...
	List<LabTestVO> _mppprevreq=(List<LabTestVO>)session.getAttribute(InvestigationConfig.LIST_PREV_REQ_XRAY);
