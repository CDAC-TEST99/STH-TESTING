...
<head>
  ...
  <!--Custom Resources----->
  <script type="text/javascript" src="media/services/js/invResultEntryResp.js"></script>
  <link rel="stylesheet" href="media/services/css/invResultEntryResp.css" />
...
<fieldset class="m-2 px-1">
			...
			<div class="row align-items-center no-gutters"><!--  px-1 px-md-2  -->
				<div class="col-9 col-sm-7 col-md-5 col-lg-3 textFit">
					<p class="text-nowrap" style="font-family: 'averta-extrabolduploaded_file';">
						<span class="text-primary"><img height="35" width="35" src='media/images/resultEntry.svg'></span>
	...
	<html:form action="/invResultEntryResp" enctype="multipart/form-data">
 ...
 %>
			...
			<div class="mx-md-1 mx-md-point5 row  p-2 pt-lg-0 align-items-center shadow rounded-lg bg-white filertsGradient  hover-shadow collapse show" id="container2Row1">
				<div class="col-12 col-lg-4 rounded border-right-lg border-primary noUserSelect mt-lg-2">
					...
					<div class="input-group d-flex flex-nowrap mb-2 mb-md-0">
						<div class="input-group-prepend">
							<div class="input-group-text">ResultEntry Status</div>
						</div>
						<select class="form-control custom-select" id="valStatusSelectInput">
							<option value="-1" disabled>Choose ResultEntry Status</option>
							<option selected value="1">Yet To Enter</option>
							<option value="2">ResultEntred</option>
						...
						<div class="col-12 col-lg-4 ml-auto ml-md-0 mr-md-auto mb-2 mb-md-0">
							<div class='input-group d-flex flex-nowrap input-group_inputFilterType'>
								<div class="input-group-append">
								 ...
								 <input type="text" class="form-control" id="crNoInput" placeholder="Enter Ben Id." maxlength="7" minlength="7" value="" disabled> 
							        <%--   <div id="inptCrid" class="">
        ...
        <div class="d-flex justify-content-center">
				...
				<div id="allEntryReqnList" class="col-12 pt-3 d-none" >
              ...
              <tr>
				...
				<div id="patEntryReqnList" class="col-12 pt-3 d-none" >
		...
		<html:hidden name="InvResultValidationRespFB" property="resultEntryStatusCode" />
		<html:hidden name="InvResultValidationRespFB" property="jsonResponse" value='{"isResultEntered":"0","isResultEntryResponse":"0","errorMsg":" "}' />
