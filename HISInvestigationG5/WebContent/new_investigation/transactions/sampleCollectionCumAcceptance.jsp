...
{
	///alert("callThisOnload2>>");
	if(document.getElementsByName("saveConfirmFlag")[0].value!="")
		{
		//alert("saveConfirmFlag>>");
	var url="/HISInvestigationG5/new_investigation/sampleCollectionCumAcceptance.cnt?hmode=PRINT";
...
{   ///alert("sample>>");
		var chkBoxSample=document.getElementsByName("chkSamplePatient");
		///alert("chkSamplePatient>>"+chkBoxSample);
		...
		for(var i=0;i<chkBoxSample.length;i++)
			{
				...
				{
					alert("Please Enter D2aily Sample No");
...
function onClickReqNoChkBox(obj, k, j) {
  //  alert("submit>>4");
    ...
    for (var i = 0; i < chkBoxSample.length; i++) {
       ...
       // document.getElementsByName("testBasedMachine")[i].value = "100001"; // this will now affect all checkboxes
...
// To update the value for all checkboxes with the name "testBasedMachine"
 /* var testBasedMachineElements = document.getElementsByName("testBasedMachine");
for (var i = 0; i < testBasedMachineElements.length; i++) {
    testBasedMachineElements[i].value = "100001"; // Update the value for all checkboxes
} */
...
function CheckAutoSampleNoFormate(LabCode,TestCode,patType,tempSampleNo,sampleArea)
{
	...
	//+"&varSSOTicketGrantingTicket="+document.getElementById("varSSOTicketGrantingTicket").value
	var flg = false;
	var autoGenFormate = "";
...
function setUmoValue() {
	
    // Get all input elements with a specific name attribute
    var inputElements = document.querySelectorAll('select[name^="defaultUOMCode"]');

    // Loop through each input element
    inputElements.forEach(function(selectElement) {
      // Get the value of the current input
      var inputValue = selectElement.options[selectElement.selectedIndex].text;
 
      var idVal = selectElement.id.split('defaultUOMCode')[1];

      document.querySelector('#umoSpan'+idVal).innerHTML = inputValue;
...
.textBoxCss {
    ...
    display: block; /* Ensures proper styling */
}
}
</style>
...
<%
								      ...
								      val=val.substring(2,val.length());
			                           ...
			                           %>
										    ...
										    <td width="25%" class="tdfont">
										      ...
										      <div align="left">                                                                                                           
											<%--  <input type="text" class="textBoxCss" name="tempPatCRNo" value="<%=val %>" maxlength="16" size="20" onkeypress="return validateNumeric(event,this)" tabindex="1" /> --%>
											  <input type="text" class="textBoxCss" name="tempPatCRNo"  maxlength="16" size="20" onkeypress="return validateNumeric(event,this)" tabindex="1" />
											  </div>
										     </td>
										     		<td class="tdfont" width="25%">
									        		<div id='divfromDate' style='<%=VisitDateLabel %>' align="right">
												...
												<td class="tdfonthead" width="25%">
										    		<div id='divfromDateControl' style='<%=VisitDateControl %>'align="left">	               		 
											...
											<tr>            
									 			<td class="tdfont" width="25%">
									        		<div id='divfromDate' style='<%=VisitDateLabel %> display: none;'' align="right">
										        		<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
										        		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
															<bean:message key="VisitDate"/>
														</font>
												...
												<td class="tdfonthead" width="25%">
										    		<div id='divfromDateControl' style='<%=VisitDateControl %>display: none;''align="left">	               		 
														<his:date name='fromDate' dateFormate="%d-%b-%Y" value="<%=frDate%>"/>
													</div>
									 			...
									 			<td class="tdfont" width="25%" >
									        		<div id='divfromDate' style='<%=toDateLabel %> display: none;' align="right">
										        		<font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif\">*</font>
										        		<font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">
												...
												<td class="tdfonthead" width="25%">
										    		<div id='divfromDateControl' style='<%=toDateControl %> display: none;'align="left">	               		 
	...
	<%-- 				<td width="5%" align="left">	
				...
				<%-- 	<td width="15%" align="left">
					...
					<td width="5%" align="left">
						<b><font color="#000000" size="2"
							face="Verdana, Arial, Helvetica, sans-serif"><bean:message key="age" /> / Gender</font></b>
					</td>
					<td width="10%" align="left">
						<b><font color="#000000" size="2"
			...
			<logic:notEmpty name="<%=InvestigationConfig.LIST_SAMPLE_PATIENT_VO %>">
					...
					String chkVal= voSam.getRequisitionNo().replace("!!!", ""+j);
					...
					<tr>
						...
						<td width="10%" align="left">
						 <div align="left">
				  		...
				  		<font color="#000000" size="2"
							face="Verdana, Arial, Helvetica, sans-serif">
						 	<%=voSam.getPatAge()+" / "+voSam.getPatGenderCode() %></font>
						 </div>
				  		</td>
				  		<td width="10%" align="left">
	 					...
	 					<%-- 		<td class="tdfont" >
					 		...
					 		<%-- 	<td class="tdfonthead" >
					 			...
					 			<div align="left">
					 			 ...
					 			 <td class="tdfont" width="10%" style='display:none;'>
					 			<div align="left">
					 					<bean:message key="sampleNo"/>/ Vial Number &nbsp;
					 				</div>
					 			</td> 
					 			<td class="tdfont" width="5%" style='display:none;'>
					 			<div align="left">
					 				Lab Number
					 				</div>
					 			</td>
	 		...
	 		%>
		 			   ...
		 			   <select  id="<%=k%>machine" name='testBasedMachine' tabindex='1'>
		 					<%=testWiseMachineCombo%>
					 			...
					 			<td class="tdfonthead" rowspan="<%=rowSpanSize%>" width="10%" style="display:none;">
					 			<div align="left">
					 				<font color="<%=color%>">	
					 			...
					 			<td class="tdfonthead" rowspan="<%=rowSpanSize%>" width="5%" style="display:none;">
					 			<div align="left">
					 			...
					 			<td class="tdfonthead" rowspan="<%=rowSpanSize%>" width="10%">
					 				<div align="left">
					 					<span><html:text name="SampleCollectionCumAcceptanceFB" property="sampleQnty"  maxlength="10" size="10"  value='<%=voSampleCollection.getSampleQnty()==null?"":voSampleCollection.getSampleQnty() %>'  onkeypress="return validateNumeric(event)" tabindex="1"></html:text>
					 					</span>
					 					<span class='umoSpan' id='<%="umoSpan"+j%>'></span>
					 				</div>
					 			</td>
					 			<td class="tdfonthead" rowspan="<%=rowSpanSize%>" width="10%" style="display:none;"  >
					 			<div align="left" >
	 								  <span class="custom-dropdown small">
	 								<html:select name="SampleCollectionCumAcceptanceFB" property="defaultUOMCode" styleId='<%="defaultUOMCode"+j %>'  value="<%=voSampleCollection.getDefaultUOMCode() %>" tabindex="1"  >
	       								<html:option value="-1">Select Value</html:option>
			...
			<html:hidden name="SampleCollectionCumAcceptanceFB" property="isSampleAreaSelected" />
			 <html:hidden name="SampleCollectionCumAcceptanceFB" property="currentPage" />
              <html:hidden name="SampleCollectionCumAcceptanceFB" property="patCRNo" />
                            <html:hidden name="SampleCollectionCumAcceptanceFB" property="saveConfirmFlag"/>
                   <html:hidden name="SampleCollectionCumAcceptanceFB" property="barCodeGenSize"/>
