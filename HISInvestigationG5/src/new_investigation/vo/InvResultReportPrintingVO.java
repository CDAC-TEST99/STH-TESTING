...
public class InvResultReportPrintingVO extends ValueObject
{
	...
	private String dateFiltersOrBothh ;
...
public String getPriorityColor() {
	...
	public String getRequisitionNo() {
		this.requisitionNo=requisitionDNo.substring(0, 21);
	...
	public void setPendinggroup(String pendinggroup) {
	...
	public String getPendinggrptest() {
		return pendinggrptest;
	}
	public void setPendinggrptest(String pendinggrptest) {
		this.pendinggrptest = pendinggrptest;
	}
	public String getDateFiltersOrBothh() {
		return dateFiltersOrBothh;
	}
	public void setDateFiltersOrBothh(String dateFiltersOrBothh) {
		this.dateFiltersOrBothh = dateFiltersOrBothh;
	}
