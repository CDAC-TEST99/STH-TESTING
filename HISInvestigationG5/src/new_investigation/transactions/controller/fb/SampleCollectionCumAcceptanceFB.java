...
public class SampleCollectionCumAcceptanceFB extends ActionForm {
	...
	private String[] arrSelectedRequisitions;
	
	
	
	
	public String[] getArrSelectedRequisitions() {
		return arrSelectedRequisitions;
	}
	public void setArrSelectedRequisitions(String[] arrSelectedRequisitions) {
		this.arrSelectedRequisitions = arrSelectedRequisitions;
	}
