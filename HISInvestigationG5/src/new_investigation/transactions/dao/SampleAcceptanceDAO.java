...
public class SampleAcceptanceDAO extends DataAccessObject implements SampleAcceptanceDAOi
{
	...
	public List<SampleAcceptanceVO> getSampleAcceptanceDetail(SampleAcceptanceVO sampleAcceptanceVO, UserVO _UserVO)
	{
		...
		try
		{
			...
			if(sampleAcceptanceVO.getSampleNumber()!=null && !sampleAcceptanceVO.getSampleNumber().equals("")){
				
				sampleAcceptanceVO.setSampleNumber(sampleAcceptanceVO.getSampleNumber().trim());
				}
			
			if(sampleAcceptanceVO.getSampleNumber()!=null && !sampleAcceptanceVO.getSampleNumber().equals("")){
				query +=  " and UPPER(hivnum_temp_sample_no) = "+"UPPER('"+sampleAcceptanceVO.getSampleNumber()+"')"; 
			}
