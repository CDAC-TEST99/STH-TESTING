...
public class InvResultEntryRespDAO
  extends DataAccessObject
{
  public InvResultEntryRespDAO(JDBCTransactionContext _tx) { super(_tx); }




  public List<InvResultValidationRespVO> AjaxGetEntryReqnList(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
	    ResultSet rs = null;
	    String query = "";
     ...
     String firstPart = parts[1];
      ...
      if (invResultValidationRespVO.getDateFiltersOrBoth()!=null & (invResultValidationRespVO.getDateFiltersOrBoth().equals("0") || invResultValidationRespVO.getDateFiltersOrBoth().equals("1"))) {
      	...
      	if(invResultValidationRespVO.getDateTypeCode().equals("1")){
      		...
      		orderByDateClause = " a.hivdt_requisition_date_reqd desc";
      	}
     ...
     //Condition for filtering by Requisition Status
      ...
      if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("1")) {
      	reqnStatusClause = " and hivnum_reqdtl_status in (6) ";
      } else if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("2")) {
      	reqnStatusClause = " and hivnum_reqdtl_status in (7,13,26) ";
      } else if (invResultValidationRespVO.getResultEntryStatusCode() != null && invResultValidationRespVO.getResultEntryStatusCode().equals("3")) {
      	reqnStatusClause = " and hivnum_reqdtl_status in (27) ";
      }
      ...
      //Order by Clause
      query = String.valueOf(query) + " ORDER BY "+orderByDateClause+",gbnum_priority_code desc, hivnum_temp_sample_no, grp";
      ...
      Sequence sq = new Sequence();
        ...
        //populateMAP.put(sq.next(), _UserVO.getUserSeatId())s;
        populateMAP.put(sq.next(), firstPart);
        populateMAP.put(sq.next(), _UserVO.getHospitalCode());
        ...
        rs = HelperMethodsDAO.executeQuery(getTransactionContext().getConnection(), query, populateMAP);
	      if (rs.next())
	      {
	        ...
	        for (int i = 0; i < valueObjects.length; i++)
	        {
	          ...
	          {
	            if (((InvResultValidationRespVO)lstInvResultValidationRespVO.get(i)).getReportAvailableAfter().equals("1"))
  ...
  public void updateResultEntryInRequisitionDtl(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
    ...
    //  populateMAP.put(sq.next(), _UserVO.getSeatId());
      ...
      String emcode = "0";
      if(invResultValidationRespVO.getCrNoReqNoString()!=null)
      for (int i = 0; i < invResultValidationRespVO.getCrNoReqNoString().length; i++) {

        if (invResultValidationRespVO.getCrNoReqNoString()[i].contains(invResultValidationRespVO.getRequisitionNo())) {
          emcode = invResultValidationRespVO.getEmpNameWise()[i];
        }
      }
...
String firstPart = parts[1];
  ...
  public void insertResultEntryDtl_textareaeditor(ResultEntryVO voResultEntry, UserVO _UserVO,String testcode,String paracode,String defaultval) {
	    String query = "";
	    Map populateMAP = new HashMap();
	    Sequence sq = new Sequence();
	    String filename = "new_investigation.transactions.investigationTransactionQuery";
  ...
  public void insertResultEntryDtlInJobWorkorderData(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    Sequence sq = new Sequence();
    String filename = "new_investigation.transactions.investigationTransactionQuery";
    ...
    try {
      ...
      populateMAP.put(sq.next(), (invResultValidationRespVO.getSampleNo() == null) ? "" : invResultValidationRespVO.getSampleNo());
      populateMAP.put(sq.next(), (invResultValidationRespVO.getPatAge() == null) ? "" : invResultValidationRespVO.getPatAge());
  ...
  public void insertUserEnterCode(InvResultValidationRespFB fb, UserVO _UserVO, String code) {
    ...
    String seatId = _UserVO.getUserSeatId();
    String[] parts = seatId.split("\\^");
    String firstPart = parts[1];
  ...
  public List<String> setEmployeeNameComboEssentials(InvResultValidationRespVO invResultValidationRespVO, UserVO _UserVO) {
    String query = "";
    Map populateMAP = new HashMap();
    ResultSet rs = null;
    String filename = "new_investigation.transactions.investigationTransactionQuery";
...
String firstPart = parts[1];
  ...
  //  populateMAP.put(sq.next(), _UserVO.getUserSeatId());
    ...
    if (invResultValidationRespVO.getLabCode().equals("%")) {
      conditionLab = " gnum_lab_code like '%' )";
    } else {
      conditionLab = " gnum_lab_code=" + invResultValidationRespVO.getLabCode() + " )";
    }
