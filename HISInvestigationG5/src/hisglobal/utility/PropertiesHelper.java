...
public class PropertiesHelper {
    ...
    PropertiesHelper() {
           ...
           config  = ResourceBundle.getBundle("hisglobal.utility.investigationjobproperties");
    ...
    {
        instantiateProperties();
        boolean isDebug = config.getString("ISDEBUG").equals("true");
        return isDebug;
    }
    ...
    public static String getReportRightLogoPath()
    {
         instantiateProperties();
         String strReportRightPath = config.getString("REPORTLOGOPATHRIGHT");
         return strReportRightPath;
    }
    ...
    {
         instantiateProperties();
         int nThreads = Integer.parseInt(config.getString("NTHREADS"));
         return nThreads;
    }
      ...
      {
           instantiateProperties();
           int Frequency = Integer.parseInt(config.getString("ReportHistorySaveFrequency")); 
           return Frequency;
      }
     ...
     /* public static int getDeletepdffrequency()
      ...
      {
           instantiateProperties();
           int Frequency = Integer.parseInt(config.getString("SchedulerRunDeletePdfInHour")); 
           return Frequency;
      }
      ...
      {
           instantiateProperties();
           int Frequency = Integer.parseInt(config.getString("SchedulerRunDeletePdfInMin")); 
           return Frequency;
      }
   ...
   {
       instantiateProperties();
       boolean isDebug = config.getString("ISMONGO").equals("true");
       return isDebug;
   }
   ...
   {
       instantiateProperties();
       boolean isDebug = config.getString("FETCH_NORMAL_TEMPLATE_TESTWISE").equals("true"); 
       return isDebug;
   }
   ...
   {
        instantiateProperties();
        int Frequency = Integer.parseInt(config.getString("BILLSCHEDULERFREQUENCY")); 
        return Frequency;
   }
   ...
   {
       instantiateProperties();
       boolean isDebug =  config.getString("ISBILLSCHEDULER").equals("true"); 
       return isDebug;
   }
   ...
   {
       instantiateProperties();
       boolean isDebug =  config.getString("is_data_insert_hprms").equals("true"); 
       return isDebug;
   }
   ...
   {
       instantiateProperties();
       boolean isDebug =  config.getString("IS_DATA_MOVE_IN_SAME_DB").equals("true"); 
       return isDebug;
   }
   ...
   {
       instantiateProperties();
       boolean isDebug = config.getString("IS_DATA_MOVE_IN_KOPRAN_DB").equals("true");
       return isDebug;
   }
