	...
	public static String getParameterFromHisPathXML(String _Param){
		...
		try{
			...
			if(osType.startsWith("Win")){
				...
				paramValue = getParameterFromXML("C:/CGHS/AHIMSG5/hisPath.xml", _Param);
				//paramValue = "C:/CGHS/AHIMSG5/hisPath.xml";
			}else{
				_Param += "_LIN";
		    	paramValue = getParameterFromXML("/opt/Arunachal_PHDM/AHIMSG5/hisPath.xml", _Param);
			}
		}catch(Exception e){
			e.printStackTrace();
		}
