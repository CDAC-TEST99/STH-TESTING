...
public class UserMasterVO extends ValueObject
{
	...
	private String varClientJson;
	private String varClientStartYear;

	private String varIsBen = "0";
	
	
	public String getVarIsBen() {
		return varIsBen;
	}

	public void setVarIsBen(String varIsBen) {
		this.varIsBen = varIsBen;
	}
	...
	public String getVarClientId() {
		return varClientId;
	}

	public void setVarClientId(String varClientId) {
		this.varClientId = varClientId;
	}
	...
	public String getVarClientJson() {
		return varClientJson;
	}

	public void setVarClientJson(String varClientJson) {
		this.varClientJson = varClientJson;
	}
