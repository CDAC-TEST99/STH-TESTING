...
public class PGPDFProcessing {
    ...
    public boolean processingData(Connection conn,String hospcode, String Labcode, String crno,boolean compulsory,String isdeptEntry,UserVO _userVO ) {
        ...
        try {
        	 System.out.println("PDF File Creation");
		
			  daoObj = new HisDAO("Cash Collection Transaction",
			  "CashCollectionTransDAO.getClientPatientNumber");
			  
			/*
			 * int nProcIndex = daoObj.setProcedure(QueryConfig.P_GET_PDF_WORKORDERLIST);
			 * 
			 * 
			 * daoObj.setProcInValue(nProcIndex, "lastnumber", crno, 1);
			 * daoObj.setProcInValue(nProcIndex, "labcode", Labcode, 2);
			 * daoObj.setProcInValue(nProcIndex, "hospitalcode", hospcode, 3);
			 * daoObj.setProcInValue(nProcIndex, "isdeptentry", isdeptEntry, 4);
			 * daoObj.executeProcedureByPosition(nProcIndex);
			 */
            processingData =crno;
            processinglaboratoryCode = Labcode;
            hospitalCode = hospcode;
            isDeptEntry = isdeptEntry;

            if (processingData != null) {
                  
                jobprocessContinue = true;

                Log(Level.INFO, "Calling count1234:::::::::::::::::::::::::::::::::" + processingData);
                System.out.println("processingToGenerateReport>>>");
                processingToGenerateReport(conn, hospitalCode, processinglaboratoryCode, processingData, false,isDeptEntry, _userVO);
    ...
    public void processingToGenerateReport(Connection conn, String hospitalCode, String labCode, String crOrRequisitionNo, boolean compulsory,String isDeptEntry,UserVO _userVO) {
        ...
        try {
        	 ...
        	 System.out.println("processingToGenerateReport>>415>nandini");
        	daoObj = new HisDAO("Cash Collection Transaction", "CashCollectionTransDAO.getClientPatientNumber");

			int nProcIndex = daoObj.setProcedure(QueryConfig.P_GET_PDF_WORKORDERLISTDATA_RESENTRY);
        	
			System.out.println("nProcIndex resultpdf :::::::"+nProcIndex);
        	System.out.println("conn>>"+conn);
        	System.out.println("hospitalCode>>"+hospitalCode);
        	System.out.println("labCode>>"+labCode);
        	System.out.println("crOrRequisitionNo>>"+crOrRequisitionNo);
        	   //  conn.setAutoCommit(false);
         
        	daoObj.setProcInValue(nProcIndex, "labcode", labCode, 1);
        	daoObj.setProcInValue(nProcIndex, "requisitionnos", crOrRequisitionNo, 2);
        	daoObj.setProcInValue(nProcIndex, "hospitalcode", hospitalCode, 3);
        	daoObj.setProcOutValue(nProcIndex, "s_refcursor", 2, 4);
        	daoObj.setProcOutValue(nProcIndex, "errormsg", 1, 5);
        	daoObj.setProcOutValue(nProcIndex, "errorcode", 1, 6);
        	daoObj.setProcOutValue(nProcIndex, "errormsg1", 1, 7);
        	daoObj.setProcInValue(nProcIndex, "deptentry", isDeptEntry, 8);
        	
        	daoObj.executeProcedureByPosition(nProcIndex);
        	
        	rs = daoObj.getWebRowSet(nProcIndex, "s_refcursor");
             
        	System.out.println("rs>dffg78gf>"+rs);
            ...
            Log(Level.INFO, "processingToGenerateReport REPORTING ENGINGE QUERY123-->INV_REPORTENGINE.getWorkOrderList::" +labCode+crOrRequisitionNo + hospitalCode);
            ...
            String reqno="";
            String isgroup="0";
            for (ResultEntryVOGroupByValidatedBy resBy : reportGroupByList) { // to group reqno n sampleno wise report
            	
            	System.out.println("reqno :::65::::"+resBy.getRequisitionNo());
            	
            	System.out.println("reqno :::::::"+resBy.getTestgroupname());
            	System.out.println("reqno :::::::"+resBy.getLaboratoryCode());
            	/*if(resBy.getGroupCode()==null || resBy.getGroupCode().equals(""))
            	{*/
            	if((reqno.equals("")))
            	{
            		
            		//reqno+=resBy.getRequisitionNo()+resBy.getSampleNo()+"#"+"0";
            		//reqno+=resBy.getRequisitionNo()+resBy.getSampleNo();
            		reqno+=resBy.getRequisitionNo();
            	}
            	else 
            	{
            		if(!reqno.contains(resBy.getRequisitionNo()))
            			reqno+=","+resBy.getRequisitionNo();
            			//    reqno+=","+resBy.getRequisitionNo()+resBy.getSampleNo()+"#"+"0";
            		//reqno+=","+resBy.getRequisitionNo()+resBy.getSampleNo();
            		//reqno+=","+resBy.getRequisitionNo();
             ...
             //  }
            	/*else
            	{
                	...
                	if((reqno.equals("") ))
                	{
                		//reqno+=resBy.getRequisitionNo()+"#"+"1";;
                	}
                	else 
                	{
                		if(!reqno.contains(resBy.getRequisitionNo()))
...
/*                  if(reqno.split("#")[1].equals("0"))
*/              
            	daoObj = new HisDAO("Cash Collection Transaction", "CashCollectionTransDAO.getClientPatientNumber");

    			  nProcIndex = daoObj.setProcedure(QueryConfig.P_GET_PDF_WORKORDERLISTDATA_NEW);
    			  System.out.println("nProcIndex resultpdf :::::::"+nProcIndex);
                
        /*          if(reqno.split("#")[1].equals("1"))
                 	 cstmt1 = conn.prepareCall(QueryConfig.P_GET_PDF_WORKORDERLISTDATA_NEW_GROUP);*/
    	        	...
    	        	daoObj.setProcOutValue(nProcIndex, "errormsg1", 1, 7);
    	        	daoObj.setProcInValue(nProcIndex, "deptentry", isDeptEntry, 8);
    	        	daoObj.setProcInValue(nProcIndex, "reqno", reqno, 9);
    	        	
    	        	daoObj.executeProcedureByPosition(nProcIndex);
    	        	
    	        	rs1 = daoObj.getWebRowSet(nProcIndex, "s_refcursor");
            ...
            Log(Level.INFO, "processingToGenerateReport After1 reportGroupByList1524  size ::" + reportGroupByList.size());
            ...
            if (reportGroupByList != null && reportGroupByList.size() != 0) {
                ...
                if (reportGroupByList != null && reportGroupByList.size() != 0) {
                	...
                	Log(Level.INFO, "htmlcreate::::::::::::::" + reportGroupByList.size());
                	 System.out.println("reportGroupByList>>>"+reportGroupByList);
                    PrintingHelper.createHTMLReportForListOfWorkOrders(reportGroupByList, compulsory,_userVO);
                }
    ...
    public boolean printReportInPdfFormatFTP(List<ResultEntryVOGroupByValidatedBy> reportGroupByList, String hospitalCode, Connection conn) throws SQLException {
        ...
        for (ResultEntryVOGroupByValidatedBy resBy : reportGroupByList) {
        	System.out.println("resBy>>"+resBy.getGroupTemplateString());
        ...
        try {
            ...
            for (ResultEntryVOGroupByValidatedBy resultEntryVOGroupByValidatedByObj : registeredValidatedByList) {
            	System.out.println("Result Dtl>>"+resultEntryVOGroupByValidatedByObj.getGroupTemplateString());
                ...
                */
                     ...
                     String originalStringCrNO = resultEntryVOGroupByValidatedByObj.getPatCRNo();
                     String crno = originalStringCrNO.replaceAll("/", "_");
                        System.out.println("crNo>>>>"+crno);
                    
                     String pdfFileName = crno + "_"+
                    ...
                    if(resultEntryVOGroupByValidatedByObj.getOldReportUrl()!=null && !resultEntryVOGroupByValidatedByObj.getOldReportUrl().equals("-"))
                    {
                    	...
                    	else
                    	{
                    		...
                    		String OriginalStringCrNo = resultEntryVOGroupByValidatedByObj.getPatCRNo();
                            //String PatCrNo = originalStringCrNO.replaceAll("/", "-");
                    		String PatCrNo =OriginalStringCrNo;
                                System.out.println("PatCrNo>>>>"+crno);
     				    ...
     				    // String ftpfilepath=PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+"20"+year+"/"+insideyear+"/"+count+"/"+PatCrNo+"/"+resultEntryVOGroupByValidatedByObj.getOldReportUrl();
     				     
                                String ftpfilepath=PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+PatCrNo+"/"+resultEntryVOGroupByValidatedByObj.getOldReportUrl();
                    ...
                    if(resultEntryVOGroupByValidatedByObj.getDisplayHeader().equals("0"))
                    {
                    	...
                    	String headerheight=getfinalheaderheight(Config.HEADER_HEIGHT_WITHOUT_HEADER,resultEntryVOGroupByValidatedByObj.getIslabeldoubleline());
                    ...
                    if (resultEntryVOGroupByValidatedByObj.getPrintingType() != null && resultEntryVOGroupByValidatedByObj.getPrintingType().equals("1")) {
                    	...
                    	if(resultEntryVOGroupByValidatedByObj.getIsdynamicTestTemplate()!=null && resultEntryVOGroupByValidatedByObj.getIsdynamicTestTemplate().equals(1))
                    	{
                    		...
                    		{
                            	 String headerheight = getfinalheaderheight(Config.HEADER_HEIGHT_WITH_HEADER,resultEntryVOGroupByValidatedByObj.getIslabeldoubleline());
                        	resultEntryVOGroupByValidatedByObj.setHeaderheight(Float.parseFloat(headerheight));
                    		}
                 ...
                 ///    System.out.println(crNo.substring(5,7));
                  ...
                  //  String insideyear=PGDataHelper.getInsideYear(crNo);
                  //  String count=  PGDataHelper.getcount(crNo);
                    String originalStringcrNo=crNo;
                    String PatcrNo = originalStringcrNo.replaceAll("/", "_");               
                    System.out.println(crNo);
                    
                    
                    
                    String pdfFtpurl = PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+crNo;
                    String pdfFileurl= PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+crNo;
                   
                    
					/*
					 * String originalStringcrNo=resultEntryVOGroupByValidatedByObj.getPatCRNo();
					 * String crNo = originalStringcrNo.replaceAll("/", "-");
					 * System.out.println(crNo.substring(5,7)); System.out.println(crNo); String
					 * year= crNo.substring(5,7);
					 */
                  
                  // String pdfFtpurl = PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+"20"+year+"/"+insideyear+"/"+count+ "/"+crNo;
                   //String pdfFileurl= PropertiesHelper.getFTPConnectionURI()+"/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+"20"+ year+"/"+insideyear+"/"+count+"/"+crNo;
                  
                 //   String pdfFtpurl = PropertiesHelper.getFTPConnectionURI()+"/opt"+"/ftp"+"/hmis/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+"20"+year+"/"+insideyear+"/"+count+"/"+resultEntryVOGroupByValidatedByObj.getPatCRNo();
                 //   String pdfFileurl= PropertiesHelper.getFTPConnectionURI() +"/opt"+"/ftp"+"/hmis/"+resultEntryVOGroupByValidatedByObj.getHospitalCode() +"/"+"20"+ year+"/"+insideyear+"/"+count+"/"+resultEntryVOGroupByValidatedByObj.getPatCRNo();
            
            
                    System.out.println("pdfFileurl>>"+pdfFileurl);
                    System.out.println("pdfFtpurl>>>"+pdfFtpurl);
                    String saveStatus ="";
                    boolean flg=PropertiesHelper.getISFtporMongo();
                	...
                	{
                 System.out.println("getGroupTemplateStringh21>>"+resultEntryVOGroupByValidatedByObj.getGroupTemplateString());
                         
                		//System.out.println("nadu "+resultEntryVOGroupByValidatedByObj.getHeader());
                	   // System.out.println("nanda"+resultEntryVOGroupByValidatedByObj.getFooterHeight()); 
                	   // System.out.println("nand"+resultEntryVOGroupByValidatedByObj.getHeaderWidth()); 
                	    System.out.println("Testname>>>"+resultEntryVOGroupByValidatedByObj.getTestName()); 
                	    System.out.println("Testgroupname>>>"+resultEntryVOGroupByValidatedByObj.getTestgroupname()); 
                		saveStatus =  SavePDF.saveFileToFTPLocationnew(resultEntryVOGroupByValidatedByObj.getHeader(), 
                		resultEntryVOGroupByValidatedByObj.getFooter(), resultEntryVOGroupByValidatedByObj.getGroupTemplateString(),
                		pdfFileName, Float.parseFloat(resultEntryVOGroupByValidatedByObj.getFooterHeight()),
                		...
                		((resultEntryVOGroupByValidatedByObj.getPageSize().startsWith("A4")) ? null : resultEntryVOGroupByValidatedByObj.getPageSize()),
                		((resultEntryVOGroupByValidatedByObj.getPageSize().startsWith("A4")) ? null : Config.pagewidthprinting), oldFilePdf,
                		resultEntryVOGroupByValidatedByObj.getFileuploaddata(),resultEntryVOGroupByValidatedByObj.getIsfileuploaddadd(),
                		resultEntryVOGroupByValidatedByObj.getIsfirstpagereq(),pdfFtpurl,pdfFileurl,resultEntryVOGroupByValidatedByObj.getTestgroupname());
                	}
                   ...
                   // String base64bytearraynew = org.apache.commons.codec.binary.Base64.encodeBase64String(pdfData1);
                    ...
                    String base64bytearraynew = "";
                    String CrNo=resultEntryVOGroupByValidatedByObj.getPatCRNo();
                    List<String> patDetails = PGDataHelper.getInstance().getPatientDetails(CrNo);
               //     System.out.println("MNo : "+patDetails.get(0)+" : email : "+patDetails.get(1)+" : name : "+patDetails.get(3));
                    ...
                    //10003_07022024030429.850PM.pdf
                    if (saveStatus != null) {
                        String query =QueryConfig.Q_SAVE_PDF_WORKORDERS;
                        		//QueryConfig.Q_SAVE_PDF_WORKORDERS;
                        //chanks
                    ...
                    //    PreparedStatement pstmt11 = conn.prepareStatement(QueryConfig.Q_UPDATE_REQ_STATUS_DAILY_TABLE);
                     ...
                     /*        pstmt10.setString(1, resultEntryVOObj.getRequisitionDNo());
                      ...
                      ///  conn.commit();
                        ...
                        //if(email != null){
                        boolean checkMail = false;						//mail sending stopped.
                        if(checkMail){
    ...
    private List<ResultEntryVOGroupByValidatedBy> resultsetProcessingForGroupingWorkOrder(WebRowSet rs1, List<ResultEntryVOGroupByValidatedBy> workOrderGroupListForresultEntry) {
        ...
        try {
        	System.out.println("samplecode--nandinisingh");
               int count=0;
            ...
            while (rs1.next()) {
                //if (rs.getString("isTestReady").equals("READY")) 
                {
                    if (resultEntryVO == null) {
                        //Log(Level.INFO, " laboratoryCode::" + rs1.getString("laboratorycode") + ",groupCode::" + rs1.getString("groupcode") + ",testCode::" + rs1.getString("testcode") + ",hospitalCode" + rs1.getString("hospitalcode"));
                        System.out.println("samplecode>"+rs1.getString("samplecode"));
                        System.out.println("testgroupname>>"+ rs1.getString("testgroupname"));
                        
                        resultEntryVO = new ResultEntryVO(rs1.getString("laboratorycode"), rs1.getString("testcode"), rs1.getString("groupcode"), rs1.getString("hospitalcode"),rs1.getString("samplecode"),rs1.getString("testgroupname"));
                       /// System.out.println("resultEntryVO.testgroupname>>"+ resultEntryVO.getTestgroupname());
                        DataHandler.populateVOfrmRS(resultEntryVO, rs1);

                        resultEntryVOGroupByValidatedBy = new ResultEntryVOGroupByValidatedBy();
                        resultEntryVOGroupByValidatedBy.setTestgroupname(resultEntryVO.getTestgroupname());
                     ...
                     if(data!=null && !data.equals("") && data.contains(resultEntryVO.getTestCode()))
                        ...
                        if (((resultEntryVO.getRequisitionNo()).equals(rs1.getString("requisitionNo")) == true && resultEntryVO.getSampleCode().equals(rs1.getString("samplecode")) == true)) {// && (resultEntryVO.getLaboratoryCode().equals(rs.getString("laboratoryCode")) == true) && (resultEntryVO.getTestCode().equals(rs.getString("testCode")) == true)) {                            
                        	System.out.println("samplecode-"+rs1.getString("samplecode"));
                        	resultEntryVO = new ResultEntryVO(rs1.getString("laboratorycode"), rs1.getString("testcode"), rs1.getString("groupcode"), rs1.getString("hospitalcode"), rs1.getString("samplecode"),rs1.getString("testgroupname"));
                            DataHandler.populateVOfrmRS(resultEntryVO, rs1);
                        
                            System.out.println("Testgroupname>>>"+resultEntryVO.getTestgroupname());
                            if(data!=null && !data.equals("") && data.contains(resultEntryVO.getTestCode()))
...
*/
    ...
    private ResultEntryVOGroupByValidatedBy populateTheGroupingVOWithWorkOrdersPrintedWith(ResultEntryVOGroupByValidatedBy groupingVO) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (found == false) {
                    //resultEntryVO=new ResultEntryVO();	CACHING IMPLEMENTATION
                    resultEntryVO = new ResultEntryVO(rs.getString("laboratorycode"), rs.getString("testcode"), rs.getString("groupcode"), rs.getString("hospitalcode"), rs.getString("samplecode"),rs.getString("testgroupname"));
    ...
    public static String getreporttestforpagesepareation() {
		...
		System.out.println("getreporttestforpagesepareation::::>>>"+query);
		String data="";
    ...
    public static String getfinalheaderheight(String headerheight,int islabeldoubleprint) {
