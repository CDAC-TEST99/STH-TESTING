...
public class ipdDrDeskService {
	...
	public Response getRegistrationDepartments(@FormParam("JsonData") String JsonData ,@FormParam("FormattedJsonDataArray") String FormattedJsonDataArray) throws JSONException, ParseException{
		ipdDrDeskUtil.SaveDrDesk(JsonData);
	 ...
	 * getRegistrationDepartmentsNew(@FormParam("JsonData") String JsonData
	 * ,@FormParam("FormattedJsonDataArray") String FormattedJsonDataArray) throws
	 * JSONException, ParseException{ ipdDrDeskUtil.SaveIpdDrDesk(JsonData);
	 * System.out.println("JsonData"+JsonData);
	 * System.out.println("FormattedJsonDataArray"+FormattedJsonDataArray);
	 * this.InsertFormattedData(FormattedJsonDataArray); return Response.ok()
	 * .entity(JsonData) .header("Access-Control-Allow-Origin", "*") .build();
	 * //return JsonData; }
	 */
	
	
	public void InsertFormattedData(String JsonData) throws JSONException{
		ipdDrDeskUtil.SaveDrDeskFormattedData(JsonData);
	}
	...
	public Response referPatient(@FormParam("JsonData") String JsonData) throws JSONException, ParseException{
		ipdDrDeskUtil.referPatient(JsonData);
		System.out.println("JsonData"+JsonData);
	...
	public Response saveVitalData(@FormParam("JsonData") String JsonData) throws JSONException, ParseException{
		String RetValue=ipdDrDeskUtil.saveVitalData(JsonData);
		System.out.println("JsonData"+JsonData);
		 return Response.ok()
	               .entity(RetValue)
	               .header("Access-Control-Allow-Origin", "*")
	...
	public Response ModifyVital(@FormParam("JsonData") String JsonData) throws JSONException, ParseException{
		String RetValue=ipdDrDeskUtil.getModifyVitalData(JsonData);
	...
	public Response savePrscriptionProfileData(@FormParam("JsonData") String JsonData) throws JSONException, ParseException{
		String RetValue=ipdDrDeskUtil.savePrescriptionProfileData(JsonData);
		System.out.println("JsonData"+JsonData);
		 return Response.ok()
	               .entity(RetValue)
	               .header("Access-Control-Allow-Origin", "*")
	...
	@Path("/getDrugRoute")
	@Produces(MediaType.APPLICATION_JSON)
	public String getDrugRoute(@QueryParam("drugItemTypeId") String drugItemTypeId) {
	String response=(drugItemTypeId==null) ?  "{\r\n" + 
				"	\"status \": \"0 \",\r\n" + 
				"	\"msg \": \"Please pass drug item type id \"\r\n" + 
				"}":  ipdDrDeskUtil.getDrugRoute(drugItemTypeId);
	...
	@GET
	@Path("/getMotherAdmDtl")
	@Produces(MediaType.APPLICATION_JSON)
	public String getMotherAdmDtl(@QueryParam("patAdmNo") String patAdmNo,@QueryParam("hospCode") String hospCode) {
		String response=(patAdmNo==null || hospCode==null) ?  "{\r\n" + 
				"	\"status \": \"0 \",\r\n" + 
				"	\"msg \": \"Please check the value you have passed \"\r\n" + 
				"}":  ipdDrDeskUtil.getMotherAdmDtl(patAdmNo,hospCode);
	return response;
	}
	...
	@Path("/revokeDrugData")   
	@Produces(MediaType.APPLICATION_JSON)
	public Response revokeDrugData(@FormParam("JsonData") String JsonData) throws JSONException, ParseException{
		System.out.println("JsonData"+JsonData);
		String RetValue= ipdDrDeskUtil.revokeDrugData(JsonData);
		 return Response.ok()
	               .entity(RetValue)
	               .header("Access-Control-Allow-Origin", "*")
	               .build();
