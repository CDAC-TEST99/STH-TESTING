...
import new_investigation.reports.controller.utl.SampleRejectionReportListUTL;

public class SampleRejectionReportListACT  extends DispatchAction
{
	...
	{
		SampleRejectionReportListFB fb = (SampleRejectionReportListFB) form;
	...
	public ActionForward AjaxGetLabList(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		...
		try {
			 ...
			 jsonResponse=SampleRejectionReportListUTL.AjaxGetLabList(fb, request);
	...
	public ActionForward AjaxGetTestList(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		...
		try {
			 ...
			 jsonResponse=SampleRejectionReportListUTL.AjaxGetMachineList(fb, request);
	...
	public ActionForward AjaxGetMachineTestReportList(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		...
		try {
			 ...
			 jsonResponse=SampleRejectionReportListUTL.AjaxGetMachineTestReportList(fb, request);
