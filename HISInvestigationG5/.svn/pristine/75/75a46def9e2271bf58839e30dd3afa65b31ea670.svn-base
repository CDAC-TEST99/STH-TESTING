...
public class HISSSOClientRequestFilter implements Filter
{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
	{
		...
		try
		{
			...
			//Added by Prachi for acepting speciial characters at master on 17_04_2020
			...
			if (strURI.contains("investigationreportingservicenew")||strURI.contains("investigationCRNoservicenew") || strURI.contains("investigationreportingservice") || strURI.contains("GETPATDTL")||strURI.contains(HISSSOClientConfig.SSO_ST_SERVICE_URL) || strURI.contains("MachineInterface") || strURI.contains("PRINTREPORT")|| strURI.contains("EXTNEW")||  strURI.contains("investigationChatBot") || (objRequest.getParameter("hmode")!=null && objRequest.getParameter("hmode").equalsIgnoreCase("PRINTREPORT"))||strURI.contains("taskTracker")||strURI.contains("InvestigationTrackingReport") )
			{
