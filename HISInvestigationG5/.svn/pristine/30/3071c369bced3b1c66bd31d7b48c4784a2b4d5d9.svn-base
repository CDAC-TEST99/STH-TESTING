...
public final class HISTicketRegistry implements TicketRegistry
{
	...
	public HISTicketRegistry()
	{
		...
		//System.out.println("HIS_MC-SSO:: Ticket Registry Initalized");
	}
	...
	public void addTicket(final Ticket ticket)
	{
		...
		if(ticket instanceof HISServiceGrantTicket)
		{
			...
			//System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Registered-" + ticket.getTicketId() 
		...
		else if(ticket instanceof HISTicket)
		{
			...
			//System.out.println("HIS_MC-SSO:: Ticket Registry: HIS_MC Ticket Registered-" + hisTicket.getTicketId() + " of Credential-"+key);
		}
		else
		{
			...
			//System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Registered-" + ticket.getTicketId() + " of Credential-"+key);
		}
	}
	...
	public void addTicket(final Ticket ticket, final String userAgent)
	{
		// Adding Ticket to Registry Cache
		//this.cache.put(ticket.getTicketId(), ticket);
		//System.out.println("IMCS HIS_MC Ticket Registry --> Ticket Added::" + ticket.getTicketId()+"#"+userAgent);
		this.cache.put(ticket.getTicketId(), ticket);
	...
	/*public void addTicket(final Ticket ticket, HttpSession objSession)
	{
		...
		System.out.println("HIS_MC-SSO:: Ticket Registered-" + ticket.getTicketId());
	}
	...
	public Ticket getTicket(final String ticketId)
	{
		...
		if (ticket == null)
			System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Not Found-" + ticketId);
		/*else
			System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Found-" + ticketId);*/
		return ticket;
	}
	...
	/*public Ticket getTicket(final String ticketId , final String userAgent)
	{
		...
		System.out.println("AHIMSG5 HIS_MC Ticket Registry --> Retrieving Ticket ::" + ticketId+"#"+userAgent);

		final Ticket ticket = this.cache.get(ticketId+"#"+userAgent);
		if (ticket == null)
			System.out.println("HIS_MC Ticket Registry --> Ticket Not Found::" + ticketId);
	...
	public boolean deleteTicket(final String ticketId)
	{
		...
		if(ticket != null)
		{
			...
			if(ticket instanceof HISServiceGrantTicket)
			{
				...
				//System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Removed-" + ticketId + " of Service-"+objServiceTicket.getService().getContext()+" in TGT-"+objServiceTicket.getGrantingTicketId());
			}
			else if(ticket instanceof HISTicket)
			{
				HISTicket hisTicket = (HISTicket) ticket;
				...
				System.out.println("HIS_MC-SSO:: Ticket Registry: HIS_MC Ticket Removed-" + ticketId + " of Credential-"+key);
			}
			else
			{
				...
				String key = ticket.getAuthentication().getVarUserId()+"#"+ticket.getAuthentication().getVoUser().getVarIPAddress()+"#"
						+ ticket.getAuthentication().getVarUserLoginSessionId();
				this.userIPTicketCache.remove(key);
				//System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Removed-" + ticketId + " of Credential-"+key);
			}
	...
	public Ticket getTicketBasedOn(final String userId)
	{
		...
		if (ticket == null)
			System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Not Found, User-" + userId);
		else
			System.out.println("HIS_MC-SSO:: Ticket Registry: Ticket Found, User-" + userId + " of Id-" + ticket.getTicketId());
		return ticket;
	}
	...
	public Ticket getTicketBasedOn(final String grantingTicketId, final HISService objService)
	{
		...
		if (ticket == null)
			System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Not Found, TGT-" + grantingTicketId + " ,Service-" + objService.getContext());
		else
			System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Found, TGT-" + grantingTicketId + " ,Service-" + objService.getContext() + " of Id-" 
					+ ticket.getTicketId());
	...
	/*public Ticket getTicketBasedOn(final String userId, final String ipAddress)
	{
		...
		System.out.println("HIS_MC Ticket Registry --> Retrieving Ticket By User ID & IP Address ::" + userId + " & " + ipAddress);

		final Ticket ticket = this.userIPTicketCache.get(userId+"#"+ipAddress);
		if (ticket == null)
			System.out.println("HIS_MC Ticket Registry --> Ticket Not Found By User ID & IP Address ::" + userId + " & " + ipAddress);
	...
	public Ticket getTicketBasedOn(final String userId, final String ipAddress,HttpSession objSession)
	{
		...
		System.out.println("HIS_MC Ticket Registry --> Retrieving Ticket By User ID & IP Address & User Session ::" + userId + " & " + ipAddress + " & " + objSession.getId());

		final Ticket ticket = this.userIPTicketCache.get(userId+"#"+ipAddress+"#"+objSession.getId());
		if (ticket == null)
			System.out.println("HIS_MC Ticket Registry --> Ticket Not Found By User ID & IP Address & User Session ::" + userId + " & " + ipAddress + " & " + objSession.getId());
	...
	public Ticket getTicketBasedOn(final String userId, final String ipAddress, final String sessionID)
	{
		...
		if (ticket == null)
			System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Not Found, Credentials-" + key);
		else
			System.out.println("HIS_MC-SSO:: Ticket Registry: Service Ticket Found, Credentials-" + key + " of Id-"+ ticket.getTicketId());
