...
{	
 ...
 //	document.forms[0].submit();
	...
	var url1="/HISInvestigationG5/new_investigation/invResultValidationTemplateTilenew.cnt";
...
function onClickGO(hospitalCode)
{
	...
	//alert(document.getElementsByName("searchBy")[0].checked)
...
function displayAllTest(size,crno11)
{var k=0;
for(k=0;k<size;k++)
			{
	 	if(document.getElementById("headings"+k+crno11)!=null)
	document.getElementById("headings"+k+crno11).style.display="";
	if(document.getElementById("hideTest"+k+crno11)!=null)
	document.getElementById("hideTest"+k+crno11).style.display="";
	if(document.getElementById("showTest"+k+crno11)!=null)
	document.getElementById("showTest"+k+crno11).style.display="none";	
	 
	document.getElementById("showAllTest"+crno11).style.display="none";	
	document.getElementById("hideAllTest"+crno11).style.display="";
			}
}
...
function hideAllTests(size,crno11)
{	
	var k=0;
	for(k=0;k<size;k++)
		{
			...
			if(document.getElementById("headings"+k+crno11)!=null)
document.getElementById("headings"+k+crno11).style.display="none";
			if(document.getElementById("hideTest"+k+crno11)!=null)
document.getElementById("hideTest"+k+crno11).style.display="none";
			if(document.getElementById("showTest"+k+crno11)!=null)
document.getElementById("showTest"+k+crno11).style.display="";	
			 
document.getElementById("showAllTest"+crno11).style.display="";	
			 
document.getElementById("hideAllTest"+crno11).style.display="none";
			 
		}
	}
	
	
function showTestDetails(k,val,crnooo1)
{
	var val1=k; 
	//alert("k = "+k);
	//alert("val = "+val);//chkValue
...
document.getElementById("headings"+j+crnooo1).style.display="";
		 }
}
	 else
		 {
		 document.getElementById("headings"+k+crnooo1).style.display="";
		 
		 }
/* document.getElementById("values"+k).style.display="";
 */document.getElementById("hideTest"+k+crnooo1).style.display="";
document.getElementById("showTest"+k+crnooo1).style.display="none";	
	
}

function hideTestDetails(k,val,crnoo1)
{
	var val1=k; 
	//alert(val);//chkValue
	// alert(document.getElementsByName("chkValue")[0].value);
...
document.getElementById("headings"+j+crnoo1).style.display="none";
	 }
}
 else
	 {
	 document.getElementById("headings"+k+crnoo1).style.display="none";
	 
	 }
//document.getElementById("headings"+k).style.display="none";
/* document.getElementById("values"+k).style.display="none";
 */document.getElementById("hideTest"+k+crnoo1).style.display="none";
document.getElementById("showTest"+k+crnoo1).style.display="";	
}
...
<body onload="checkEntryType()">
	<html:form action="/invResultValidationTemplateTilenew">
...
<img src='/HISInvestigationG5/hisglobal/images/btn-sv.png'  onClick="closeInstructionscanned();"> 		                        
	...
	%>
		<% this.readOnly=false;%>
		<logic:equal name="InvResultValidationFB" property="hmode"
			value="VIEW">
			<% this.readOnly=true; %>
		</logic:equal>
		<his:TitleTag name="Result Validation Process">
			<%-- <his:insertDateTag/> --%>
		</his:TitleTag>
		<his:ContentTag>
			<%
         ...
         %>
			<bean:define name="InvResultValidationFB" property="fromDate"
				id="frDate" type="java.lang.String" />
			<bean:define name="InvResultValidationFB" property="toDate"
				id="tDate" type="java.lang.String" />
				
		    <bean:define name="InvResultValidationFB" property="fromCollDate"
				id="frCollDate" type="java.lang.String" />
			<bean:define name="InvResultValidationFB" property="toCollDate"
    	...
    	%>
			<logic:equal name="InvResultValidationFB" property="showStatus"
				value="0">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td width="25%" class="tdfont"><logic:present
								...
								<div align="left">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="labCode" tabindex="1"
											onchange="labBased()">
						...
						<td width="25%" class="tdfont"><html:radio
								name="InvResultValidationFB" tabindex="1" property="newEntry"
								value="1"></html:radio> <bean:message key="validate" />&nbsp; <html:radio
								name="InvResultValidationFB" tabindex="1" property="newEntry"
								value="2"></html:radio> <bean:message key="modifyValidate" />&nbsp;</td>
							...
							<div align="right">
								<font color="RED" size="2"
									...
									face="Verdana, Arial, Helvetica, sans-serif"> <logic:equal
										name="InvResultValidationFB" property="generationType"
										value="P">

										<bean:message key="crNO" />&nbsp;
								</logic:equal> <logic:equal name="InvResultValidationFB"
										property="generationType" value="T">
										<font color="RED" size="2"
						...
						<td width="25%" class="tdfont">
							<div align="left" id="patientwise">
								...
								<div align="left" id="testwise" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="testWiseCode"
											tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
								...
								<div align="left" id="samplenowise" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="fromSampleNo"
											tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
								...
								<div align="left" id="labnowise" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="fromLabNo"
											tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
								...
								<div align="left" id="testGrpWise" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="testGroupCodeWise"
											tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
					 ...
					 Search Name&nbsp;&nbsp;&nbsp;<input type="text" id="textBoxCss" name="tempPatName"  maxlength="20" size="20"  onkeypress="return validateAlphabetsOnly(event,this)" tabindex="1">
						...
						<td width="25%" class="tdfont"><logic:present
								...
								<div align="left" id="labnowise2" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="toLabNo" tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
												collection="<%=InvestigationConfig.LABNO_WISE_COMBO_FOR_RESULT_ENTRY%>"
												property="value" labelProperty="label" />
								...
								<div align="left" id="samplenowise2" style="display: none;">
									&nbsp;&nbsp; <span class="custom-dropdown small"> <html:select
											name="InvResultValidationFB" property="toSampleNo"
											tabindex="1">
											<html:option value="-1">Select Value</html:option>
											<html:options
												collection="<%=InvestigationConfig.SAMPLENO_WISE_COMBO_FOR_RESULT_ENTRY%>"
			...
			<%
				//Pagination Logic
					...
					fbPage.setObjArrName(InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO1);
					...
					List<ResultEntryVO> lstPatVO11=(List<ResultEntryVO>)session.getAttribute(InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO1);
					
					List<ResultEntryVO> lstPatVO112=(List<ResultEntryVO>)session.getAttribute(InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO);
					...
					int size1=0;
 		if(lstPatVO11!=null && lstPatVO11.size()>0 && lstPatVO112!=null )
 		{
 			//size=lstPatVO11.size();
 		

				
 			for(int l=0;l<lstPatVO112.size();l++)
 			{
 				ResultEntryVO vo=lstPatVO112.get(l);
		...
		<%			
 		...
 		if(crnomap.size()>0)
 		{
			 ...
			 int count=0;
			 for(int k=0;k<lstPatVO11.size();k++)
			 {
				...
				z --%>
					<table width="100%" bgcolor="#EBEBEB">
						<tr>
							...
							<td width="20%" align="left"><b><font color="#000000"
									size="2" face="Verdana, Arial, Helvetica, sans-serif"> Patient Name</font></b></td>

						<!-- <td width="8%" align="left"><b> <font color="#000000" -->
							 <td width="15%" align="left" style="display: ;"><b> <font color="#000000"
								size="2" face="Verdana, Arial, Helvetica, sans-serif"> <bean:message
							...
							<td width="10%" align="left"><b> <font color="#000000"
									size="2" face="Verdana, Arial, Helvetica, sans-serif">Test List</font></b></td>
					...
					List<ResultEntryVO> lstSampleAcceptanceVO1=crnomap.get(crnoo);

					
				
					lstPatVO=lstSampleAcceptanceVO;
		...
		if(lstPatVO!=null && lstPatVO.size()>0 )
		{
			size=lstPatVO.size();
					...
					ResultEntryVO vo=lstPatVO.get(0);
					...
					<tr>
								<td  width="5%" align="left"><font color="#3393FF" size="2"
									face="Verdana, Arial, Helvetica, sans-serif"> <input
										type="checkbox" class="jpCheckbox" 
										onclick="fff(<%=vo.getPatCRNo()%>,this)">
								</font></td>
								<td width="20%" align="left">
									<div>
										<font size="2" color="#3393FF"
											face="Verdana, Arial, Helvetica, sans-serif">  <%=vo.getPatCRNo() %></font>
									</div>
								</td>
								...
								<td width="20%" align="left">
									...
									<div>
										<font  size="2" color="#3393FF"
											face="Verdana, Arial, Helvetica, sans-serif">  <%=vo.getPatName() %></font>
									</div>

								</td>

								 <td width="15%" align="left" style="">

								<!-- <td width="8%" align="left"> -->

									<div>
										<font  size="2" color="#3393FF"
											face="Verdana, Arial, Helvetica, sans-serif">  <%=vo.getPatAge()+"/"+vo.getPatGender()%></font>
									</div>
								</td> 
								<td width="20%" align="left">
									<div>
										<font  size="2" color="#3393FF"
											face="Verdana, Arial, Helvetica, sans-serif">  <%=vo.getPatUnitName() %></font>
									</div>
								</td>
								<td width="10%" align="left">
									...
									<div>
										<font  size="2" color="#3393FF"
											face="Verdana, Arial, Helvetica, sans-serif">  <%=vo.getPatStatus() %></font></font>
									</div>
								</td>
							
                              <td width="10%" align="left">

 <img id="s<%=vo.getPatCRNo() %>" class="button" title="Show Test Details" src='<his:path src="/hisglobal/images/arrow_down.gif"/>'  tabindex="1" onclick="f12('<%=vo.getPatCRNo()%>')">
									
			
									<img id="h<%=vo.getPatCRNo() %>" class="button" title="Hide Test Details"
									src='<his:path src="/hisglobal/images/arrow_up.gif"/>'
									 style="display: none;" tabindex="1" onclick="f123('<%=vo.getPatCRNo()%>')"
									>						
					...
					<%countt++;} %>
					<table style="display: none" width="100%" bgcolor="#EBEBEB" id="tbl<%=vo.getPatCRNo() %>">
						<tr>
							<td width="5%" align="left"><b> <font color="#000000"
									size="2" face="Verdana, Arial, Helvetica, sans-serif"> <!-- <input
										type="checkbox" id="selectAllCheckbox" onclick="allSelected()" /> -->
...
<%-- 							<td width="9%" align="left"><b> <font color="#000000"
							...
							<td width="20%" align="left"><b> <font color="#000000"
									size="2" face="Verdana, Arial, Helvetica, sans-serif"> Send To Machine</font></b></td>
							...
							<td width="10%">
							 ...
							 <img class="button" title="Show Range"
								src='<his:path src="/hisglobal/images/plusinv.png"/>'
								id="showAllTest<%=vo.getPatCRNo() %>" tabindex="1"
								onclick="displayAllTest('<%=size%>','<%=vo.getPatCRNo()%>')"> <img class="button"
								title="Hide Range"
								src='<his:path src="/hisglobal/images/Minus.png"/>'
								id="hideAllTest<%=vo.getPatCRNo() %>" style="display: none;" tabindex="1"
								onclick="hideAllTests('<%=size %>','<%=vo.getPatCRNo()%>')">
     
     <b> <font color="#000000"
									size="2" face="Verdana, Arial, Helvetica, sans-serif">Template Preview</font></b>
					...
					<bean:define name="InvResultValidationFB" property="startDisplay"
						id="startDisplay" type="java.lang.Integer" />
					<bean:define name="InvResultValidationFB" property="hideDisplay"
						id="hideDisplay" type="java.lang.Integer" />

					<logic:notEmpty
						name="<%=InvestigationConfig.GROUP_MODIFIED_LIST_PATIENT_RESULT_ENTRY_ESSENTIALS_VO %>">
						<table  style="display: none" width="100%" id="tbll<%=vo.getPatCRNo() %>">
				...
				//	int startIndex=((Integer)request.getAttribute(PaginationTag.PAGINATION_START_INDEX)).intValue();
					...
					String chkSendToMachineVal = voPat.getPatCRNo()+"#"+voPat.getRequisitionDNo()+"#"+voPat.getTempSampleNo();
					...
					%>
							<tr class="showhover">
								<td width="5%" align="left"><font color="#000000" size="2"
									face="Verdana, Arial, Helvetica, sans-serif"> <input
										type="checkbox" class="jpCheckbox <%=voPat.getPatCRNo() %>" name="chkSamplePatient"
...
<!-- 								<td width="7%" align="left">
								...
								<td width="10%">
									<%  String showTest="showTestDetails("+j+",'"+value+"','"+voPat.getPatCRNo()+"')";
						 String hideTest="hideTestDetails("+j+",'"+value+"','"+voPat.getPatCRNo()+"')";
			
			 %><font color="<%=color%>" size="2"
											face="Verdana, Arial, Helvetica, sans-serif">	 <img class="button" title="Show Range"
									src='<his:path src="/hisglobal/images/plusinv.png"/>'
									id="showTest<%=j+voPat.getPatCRNo()%>" tabindex="1" onclick="<%=showTest%>">
									<img class="button" title="Hide Range"
									src='<his:path src="/hisglobal/images/Minus.png"/>'
									id="hideTest<%=j+voPat.getPatCRNo()%>" style="display: none;" tabindex="1"
							...
							<tr>
								...
								<th colspan="7">
									<table bgcolor="#F8F8F8" style="display: none;" width="100%"
										id="headings<%=j+voPat.getPatCRNo()%>" border="1">
										<tr>
						 ...
						 if(refValues.length>1)
						 {
							 ...
							 if(checkRangetyp.equals("1"))
							 {
								 String highValue=refValues[1];
									...
									if((highValue.matches("[.0-9]+") ) && (lowValue.matches("[.0-9]+") ))
									{
...
<%	}
 		...
 		<table width="100%" bgcolor="#EBEBEB">
					...
					<font color="red"
									size="4" face="Verdana, Arial, Helvetica, sans-serif">No Record Found</font></b></td>
...
<td class="tdfont" width="15%">
					...
					<table width="100%">
						<tr>
							...
							<td class="tdfonthead" width="16%">
								<div align="left">
									<font color="#000000" size="2"
										face="Verdana, Arial, Helvetica, sans-serif"> <%=invresultentryvo.getSampleName() %>
									</font>
								</div>
							</td>
								<td class="tdfont" width="15%">
						...
						<tr>
							...
							<td class="tdfonthead" width="16%">
								<div align="left">
									<font color="#000000" size="2"
										face="Verdana, Arial, Helvetica, sans-serif"> <%=invresultentryvo.getPatVisitDat() %>
									</font>
								</div>
							</td>
							<td class="tdfont" width="15%">
			...
			<logic:equal name="InvResultValidationFB" property="ispreview"
						value="1">
				<html:checkbox name="InvResultValidationFB" property="saveReVal" value="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()%>" onclick="selectSaveReVal(this)"></html:checkbox>
			...
			<tr >
			  ...
			  <logic:equal name="InvResultValidationFB" property="ispreview"
						...
						<td width="2%"><input type="checkbox" id="<%=i%><%=k%><%=i%>chkBOx"
							...
							<html:hidden name="InvResultValidationFB" styleId="<%=reqDno%>" value="<%=labCode%>"
								property="cannedLabCode" /> <html:hidden
								name="InvResultValidationFB" property="cannedOrMacroCheck" /></td>
...
<img src='/HISInvestigationG5/hisglobal/images/ok.gif'  onClick="closeInstructions();"> 		                        
 	...
 	<!-- END -- TO DISPLAY INSTRUCTIONS --> 
						...
						<td width='99.99%' id="<%=i%><%=k%><%=i%>templateValue"><%=lstResultEntryVO.get(k).getResultEntryVOListValidatedBy().get(0).getTemplateDocumentString() %>
	...
	<%}
	  			...
	  			<%-- 	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	  				...
	  				<html:checkbox name="InvResultValidationFB" property="saveReVal" value="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()%>"></html:checkbox>
	  				</td>
			...
			<%}}
					...
					%>
	  				...
	  				<html:textarea  style="width: 900px;" value="<%=invresultentryvo.getAddendumRemarkValue()%>" styleId="<%=invresultentryvo.getPatCRNo()+'#'+invresultentryvo.getRequisitionNo()%>" name="InvResultValidationFB" property="addendumRemarks"
	  				 >
	  				</html:textarea>
...
<div id="container">
		...
		<his:ButtonToolBarTag>
				...
				<logic:equal name="InvResultValidationFB" property="newEntry"
					value="1">
					<img class="button"
