...
<head>
  <title>Result Report Printing</title>
  ...
  <!--Custom Resources----->
  <script type="text/javascript" src="media/services/js/invReportPrintingResp.js"></script>
...
<fieldset class="m-2 px-1">
				...
				<div class="col-9 col-sm-7 col-md-5 col-lg-3 textFit">
					<p class="text-nowrap" style="font-family: 'averta-extrabolduploaded_file';">
						<span class="text-primary"><img height="35" width="35" src='media/images/resultValid.svg'></span>
							Investigation Result Report Printing
	...
	<html:form action="/invReportPrintingResp" enctype="multipart/form-data">
		...
		<bean:define name="InvResultReportPrintingFB" property="miscDate" id="mDate" type="java.lang.String" />
 ...
 %>
			...
			<div class="mx-md-1 mx-md-point5 row  p-2 pt-lg-0 align-items-center shadow rounded-lg bg-white filertsGradient  hover-shadow collapse show" id="container2Row1">
				<div class="col-12 col-lg-4 rounded border-right-lg border-primary noUserSelect mt-lg-2">
					...
					<div class="input-group d-flex flex-nowrap mb-2 mb-md-0">
						<div class="input-group-prepend">
							<div class="input-group-text">Reports&nbsp;&nbsp;&nbsp;</div>
						</div>
						<select class="form-control custom-select" id="valStatusSelectInput">
							<option value="-1" disabled>Choose List Type</option>
							<option selected value="1">PDF Generated List</option>
							<option value="2">PDF Generation Inprocess List </option>
						</select>
					</div>
				...
				<div class="col-1 col-point5 noUserSelect px-0  "> 
					...
					<div class="custom-range-container ">
					  <input type="range" class="custom-range dateFiltersOrBothRange" min="0" max="2" id="dateFiltersOrBothRange" value="2">
					</div>
				</div>
				...
				<div class="col-11 col-11-5 col-lg-7 col-lg-7-5 noUserSelect pl-lg-0  pt-lg-4">
					...
					<div class="form-row align-items-center d-flex justify-content-center mb-md-2"> 
						<div class="col-12 col-lg-4 col-lg-4-5 mb-2 mb-md-0 dateTypeSelectDiv d-none">
							<div class="input-group d-flex flex-nowrap ">
								...
								<select class="form-control custom-select" id="dateTypeSelectInput">
									...
									<option selected value="r">Requisition Date</option>
									<option value="p">Patient Acceptance Date</option>
								</select>
							</div>
						</div>

						<div class='inputDates col-12 col-lg-4  mb-2 mb-md-0 d-none'>
							<div class="">
						...
						<div class='inputDates col-12  col-lg-3 col-lg-3-5  mb-2 mb-md-0 d-none'>
							<div class="">
					...
					<div class="form-row d-flex"> <!-- align-items-center  -->
						...
						<div class="col-12 col-lg-4 col-lg-4-5 mb-2 mb-md-0" >
    <div class='input-group d-flex flex-nowrap input-group_inputFilterType'>
        <div class="input-group-append">
            <select class="form-control" id="inputFilterType" disabled>
                <option value="1" selected>Ben Id:&nbsp;&nbsp;</option>
                <!-- <option value="2">Bill No :</option> -->
            </select>
        </div>
        <input autofocus type="text" class="form-control" id="crNoInput" placeholder="Enter Ben Id." maxlength="7" minlength="7" value="" >
    </div>
    <small id="inputFilterTypeHelp" class="form-text text-muted">Search Based on Ben Id.</small>
</div>
						...
						<div class="col-12 col-lg-4 ml-auto ml-md-0 mr-md-auto mb-2 mb-md-0">
							<div class='input-group date d-flex flex-nowrap'>
								...
								<div class="input-group d-flex flex-nowrap">
								<div class="input-group-prepend">
									<div class="input-group-text">Reports From</div>
								</div>
								<select class="form-control custom-select" id="reporttypeinput">
									<option value="-1" disabled>Choose Type</option>
									<option selected value="0">Last 3 Months</option>
	...
	<div class="col-12 col-lg-6 divArchivalmsgCol d-none">
		...
		<div id="validationReqnListCont" class="container-fluid px-1 px-sm-3 mb-3 d-none ">
			...
			<div id='' class="col-12 mx-md-1 mx-md-point5 row  p-2 align-items-center shadow rounded-lg bg-white  hover-shadow ">
			    ...
			    <div class="ml-auto isshownn d-none" >
				  <span id="isshownnn">For more information about the Patient, <a href="#">click here.</a></span> 
					</div>				
								...
								<th>
					                ...
					                <th class="">
					                	<div class="custom-control custom-checkbox">
										    ...
										    <label class="custom-control-label" for="selectAllDtCheck1"></label>Ben Id
										</div>
									...
									<th class="">Test | <font color='#ff006c' >Group</font> Name</th>
									<th class="">Lab Name</th>
									<th class="">Sample/Accession No.</th>
									<th class="">Req No.</th>
									<th class="">Req Date</th>
									<th class="">Req Date</th>
									<th class="">Req Date</th>
									<th class="">Req Date</th>
									<th class="">Req Date</th>
					...
					<div class="col-12 pt-2 d-flex justify-content-center">
						...
						<div class="saveValidateBtnDiv">
							<button id="saveValidateBtn" type="button" class="btn btn-primary text-nowrap saveValidateBtn" disabled>
								<span class="saveValidateBtnSpan">&nbsp;&nbsp;Print &nbsp;&nbsp;</span>
								<span class="validatingBtnSpan d-none"><span class="spinner-border spinner-border-sm"></span><span class="">Loading Reports..</span></span>
							</button>
						</div>
						&emsp;
						...
						<div class="modifyBtnDiv">
							<button id="modifyBtn" type="button" class="btn btn-primary text-nowrap modifyBtn d-none"  disabled>
		...
		<%-- <html:hidden name="InvResultReportPrintingFB" property="crNo" />
		<html:hidden name="InvResultReportPrintingFB" property="billNo" />
		<html:hidden name="InvResultReportPrintingFB" property="crNo_url" />
		<html:hidden name="InvResultReportPrintingFB" property="billNo_url" />
		<html:hidden name="InvResultReportPrintingFB" property="searchType_url" />
		<html:hidden name="InvResultReportPrintingFB" property="isGroup_url" />
		<html:hidden name="InvResultReportPrintingFB" property="testCode_url" />
		<html:hidden name="InvResultReportPrintingFB" property="groupCode_url" />
		<html:hidden name="InvResultReportPrintingFB" property="requisitionDNo_url" />
		<html:hidden name="InvResultReportPrintingFB" property="requisitionNo_url" />
		<html:hidden name="InvResultReportPrintingFB" property="forTestOrGroupOrAll_url" />
		<html:hidden name="InvResultReportPrintingFB" property="showGraph" />
		 --%>
	</html:form>
