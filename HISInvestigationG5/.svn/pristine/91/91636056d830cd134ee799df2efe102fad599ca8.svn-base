...
public class HISSSOClientService implements HISSSOClientServiceCON
{
	...
	public HISClientSO isServiceTicketExpiredAtClient(HISClientSO objSO_p, @Context HttpServletRequest objRequest)
	{
		...
		System.out.println("HIS_MC-SSO-CLN::Service: ST Expiry Status-" + objHISClientSO.getActionStatus() + " in TGT-" + objSO_p.getGrantingTicketId()
	...
	public HISClientSO killServiceTicketAtClient(HISClientSO objSO_p, @Context HttpServletRequest objRequest)
	{
		...
		System.out.println("HIS_MC-SSO-CLN::Service: ST Killing Status-" + objHISClientSO.getActionStatus() + " in TGT-" + objSO_p.getGrantingTicketId()
					+ " of ST-" + objSO_p.getServiceTicketId());
		return objHISClientSO;
	}
	...
	public String test()
	{
		System.out.println("HIS_MC-SSO-CLN:: Service Test");
		return "HIS_MC-SSO-CLN:: Service Called";
	}
