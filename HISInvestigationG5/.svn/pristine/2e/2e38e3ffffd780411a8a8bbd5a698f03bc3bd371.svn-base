...
*/
		...
		if(testmandref_fb.getNumberOfRow()!=null && testmandref_fb.getNumberOfRowPresent()!=null && !testmandref_fb.getNumberOfRow().equals("") && !testmandref_fb.getNumberOfRowPresent().equals(""))
		{
...
/*	for(int i=0; i < list1.size(); i++){
			...
			*/
			...
			if(modify_lstTestMandRefVO.size()>0)
				System.out.print("savemodifyTestMandRef>>global");
			TestMandRefMstDATA.savemodifyTestMandRef(modify_lstTestMandRefVO, userVO);

			objStatus.add(Status.DONE, "Data Save1 Successfully", "");
