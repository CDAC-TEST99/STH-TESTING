 ...
 * <!--
 *
 * ## Copyright Information	: C-DAC, Noida ## Project Name	: NIMS ## Name of
 * Developer	: SIDDHARTH SRIVASTAVA ## Module Name	: INVESTIGATION ##
 * Process/Database Object Name	: Template Processing User Class ## Purpose	:
 * This class provides functions for utilizing the XML generated by Test
 * Parameter Master ## Date of Creation	: ## Modification Log	: ##	Modify Date	:
 * ##	Reason	(CR/PRS)	: ##	Modify By	: *
 *
 */
...
import TemplateHelper.vo.TemplateQueryParameterVO;
...
public class TemplateProcessingUSE {
    ...
    public static List<ResultEntryVOGroupByValidatedBy> groupSelectedWorkOrders(
    	...
    	System.out.println("------------groupSelectedWorkOrders----------------->>>>");
...
//                } else {
                ...
                //    System.out.println("keyy:"+key);
                    /*if (resultEntryVOGroupByValidatedBy.getRequisitionTypeCode().equals("1")) {
                     key = resultEntryVOGroupByValidatedBy.getPatCRNo() + resultEntryVOGroupByValidatedBy.getPatEpisodeCode() + resultEntryVOGroupByValidatedBy.getPatVisitNo() + resultEntryVOGroupByValidatedBy.getSampleNo();
                     ...
                     key = resultEntryVOGroupByValidatedBy.resultEntryVO.getRequisitionNo() + resultEntryVOGroupByValidatedBy.getSampleNo();
    ...
    public static synchronized void getResultEntryTemplatedocument(ResultEntryVO resultEntryVO, int index, int workOrderGroupIndex, Map<String, ResultEntryVO> reqDNoMap) {
        ...
        try {
        	...
        	if(resultEntryVO.getIsDeptEntry() != null && resultEntryVO.getIsDeptEntry().equals("1"))
        		testDocumentNode = PGDataHelper.getInstance().getTemplateNodeObj(Config.XML_DEPT_TESTTEMPLATE, testC, isPrintWithDynamicTemplate);
        	else */         
            ...
            if(resultEntryVO.getIsDeptEntry() != null && resultEntryVO.getIsDeptEntry().equals("1") && testDocumentNode == null)
            {
                ...
                System.out.println("Template Not found for Test: " + resultEntryVO.getTestCode());
...
//                    		 * 
//                    		 * 
//                    	namedNodeAttributesMap.getNamedItem("idC");
//                    		if(tableIdFlag)
//                    		
//                    		*
//                    		*
...
//                        
                        ...
                        } else if (resultEntryVO.getSampleName().equals("NA") == true)
                        {// Patient based Test
...
//					dmap.put(resultEntryVO.getRequisitionNo()+ resultEntryVO.getGroupCode() + resultEntryVO.getTestCode(), resultEntryVO);
			...
			/* } else */
            	if (idcNode.getNodeValue() != null && idcNode.getNodeValue().equals("label") == true) {
                if (node.getAttributes().getNamedItem("id") != null) {
                    ...
                    List<FourStringObject> resultValidationDataList1 = (List<FourStringObject>) PGDataHelper.getInstance().getResultEntryValidationList(resultEntryVO);
                    for (FourStringObject fourStringObject : resultValidationDataList1) {
