...
/*import investigationDesk.transactions.dao.Helper.InvestigationTemplateDataHelper;
...
/*	public List<PentaStringObject> getAssociatedViewingWorkOrders() {
	...
	public ResultEntryVO(String laboratoryCode,String testCode,String groupCode,String hospitalCode) throws Exception
	{
