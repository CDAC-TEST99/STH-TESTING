...
<logic:equal name="LabMstFB"
					...
					<tr>
						<td width="30%" class="tdfonthead" style="display:none;">
							<div align="right">
								<font color="RED" size="2"
									face="Verdana, Arial, Helvetica, sans-serif"> * </font> <font
									color="#000000" size="2"
						...
						<td width="70%" class="tdfont" style="display:none;"><logic:present
						...
						<%-- <logic:present
								...
								<div align="left">
									...
									<html:select name="LabMstFB" property="location" tabindex="1"
										style="width:41%">
										<html:option value="1059">Opd Block</html:option>
										<html:option value="-1">Select Value</html:option>
										<html:options
								...
								<div align="left">
									...
									<html:select name="LabMstFB" property="labIncharge" tabindex="1"
										style="width:41%">
											...
											<html:option value="991010000014">Dr Bala</html:option>
										<%-- <html:option value="-1">Select Value</html:option>
										<html:options
