...
eSampleNoSequenceInMaintainer(String sequence,String sampleCode,String labCode,UserVO _UserVO)
		...
		public void updateRequisitionHeader(String mobileNo,String emailId,String patAddress,String reqNo,UserVO _UserVO,String pat_cat_code)
		{	
			try
			{ 
				...
				strProc.addInParameter(47, Types.VARCHAR,pat_cat_code);
