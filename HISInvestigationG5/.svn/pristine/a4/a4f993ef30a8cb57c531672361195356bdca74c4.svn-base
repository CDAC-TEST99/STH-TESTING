  ...
  $('#getData').click(function() {
   ...
   // var acceptedByUser= $('.acceptedByUser:checked' ).val();
    ...
    if (labCode != 0 && labCode != null && labCode != "" && labCode != 0 && machineId != 0 && machineId != null && machineId != "") {
      ...
      AjaxGetMachineTestReportList(labCode, labName, machineId, machineName, fromDate, toDate);
    }
...
function AjaxGetLabList() {
  ...
  var url = "/HISInvestigationG5/new_investigation/SampleRejectionReportList.cnt?hmode=" + _mode;
...
function AjaxGetMachineList(labCode) {
  ...
  var _mode = "AjaxGetTestList";

  var url = "/HISInvestigationG5/new_investigation/SampleRejectionReportList.cnt?hmode=" + _mode + "&labCode=" + labCode;
  ...
  $.getJSON(url, function(data) {
      ...
      if (data) {
        ...
        if (machineList.length > 0) {
          ...
          dropdown.empty();
          dropdown.append('<option selected="true" value="0" disabled>Select Test</option>');
          dropdown.append('<option selected="true" value="1">All Test</option>');
          dropdown.prop('selectedIndex', 0);
          ...
          dropdown.empty();
          dropdown.append('<option selected="true" value="0" disabled>No Tests</option>');
          dropdown.prop('selectedIndex', 0);
        }
...
function AjaxGetMachineTestReportList(labCode, labName, machineId, machineName, fromDate, toDate) {
...
//alert("lab: - " +machineId);
  ...
  var table = $('#DataTable1').DataTable({
          ...
          doc['header'] = (function() {
            return {
              columns: [{
                alignment: 'center',
                italics: true,
                text: 'Lab Name :' + labName + " |   Test Name : " + machineName + " |   From Date : " + fromDate + " |   To Date " + toDate + '',
                fontSize: 10,
              }],
              margin: [0, 20, 0, 0]
            }
    ...
    "ajax": {
      "url": "/HISInvestigationG5/new_investigation/SampleRejectionReportList.cnt?hmode=" + _mode + "&labCode=" + labCode + "&testCode=" + machineId + "&fromDate=" + fromDate + "&toDate=" + toDate,
      sync: true,
      postData: "",
      handleAs: "text",
