...
/*	public ActionForward unspecified(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
		...
		if (primaryKeyFromListPage != null) {
			String [] arrpk = Base64Utils.decode(primaryKeyFromListPage).split("@");
			fb.setPatStatus("OPD");
			String selectedCheckbox=arrpk[1] +"#1#1#1#1#1"; 
			
			String []arrSelectedRequisitions =  new String[1];
			arrSelectedRequisitions[0]=selectedCheckbox;
			fb.setArrSelectedRequisitions(arrSelectedRequisitions);
			
			String patCrNo=Base64Utils.decode(primaryKeyFromListPage).split("@")[1];
		...
		//	String testCode=arrSelectedRequisitions[0].split("#")[5];
			...
			return this.SHOWPATDETAILS(mapping,fb,request,response);
		}
	...
	public ActionForward GETPATLIST(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
		...
		SampleCollectionCumAcceptanceFB fb = (SampleCollectionCumAcceptanceFB) form;
		//fb.setShowStatus("0");
		System.out.println("SamCum_SAVE2");
		SampleCollectionCumAcceptanceUTIL.getPatList(fb,request);
	...
	public ActionForward SHOWPATDETAILS(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
		System.out.println("InvestigationRaisingDtlACT6556: SHOWPATDETAILS  ");
		SampleCollectionCumAcceptanceFB fb = (SampleCollectionCumAcceptanceFB) form;
		fb.setShowStatus("1");
		SampleCollectionCumAcceptanceUTIL.getSampleCollectionArea(fb,request);
		/* SampleCollectionCumAcceptanceUTIL.getPatList(fb,request); */
	...
	public ActionForward CANCEL(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response)
	{
	 ...
	 public ActionForward SAVE(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws Exception
	 {
		 ...
		 System.out.println("SamCum_SAVE");
		...
		{
			SampleCollectionCumAcceptanceFB fb=(SampleCollectionCumAcceptanceFB)objForm_p;
			System.out.println("SamCum_SAVE1");
