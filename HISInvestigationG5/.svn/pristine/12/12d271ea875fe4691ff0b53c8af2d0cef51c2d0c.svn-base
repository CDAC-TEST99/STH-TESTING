...
public class InvOfflineResultEntryVO {
...
//	private String patEpisodeCode;
	...
	private WebRowSet offlineTestWS = null;
	...
	private WebRowSet strResultEntryListWS = null;
...
/*	public String getIsPartialTansmission() {
	...
	public void setStrResultEntryListWS(WebRowSet strResultEntryListWS) {
		this.strResultEntryListWS = strResultEntryListWS;
	}
	...
	public WebRowSet getDupPatListWS() {
		return dupPatListWS;
	}
	public void setDupPatListWS(WebRowSet dupPatListWS) {
		this.dupPatListWS = dupPatListWS;
	}
