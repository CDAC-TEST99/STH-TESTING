...
public class InvTrackingReportFB extends ActionForm{
	
	private String hmode;
	
	private String crNo_url;
	private String billNo_url;
	private String searchType_url;
	private String isGroup_url;
	private String testCode_url;
	private String groupCode_url;
	private String requisitionDNo_url;
	private String requisitionNo_url;
	private String forTestOrGroupOrAll_url;
	...
	public String getForTestOrGroupOrAll_url() {
		return forTestOrGroupOrAll_url;
	}

	public void setForTestOrGroupOrAll_url(String forTestOrGroupOrAll_url) {
		this.forTestOrGroupOrAll_url = forTestOrGroupOrAll_url;
	}
	...
	public String getCrNo_url() {
		return crNo_url;
	}

	public void setCrNo_url(String crNo_url) {
		this.crNo_url = crNo_url;
	}

	public String getBillNo_url() {
		return billNo_url;
	}

	public void setBillNo_url(String billNo_url) {
		this.billNo_url = billNo_url;
	}

	public String getSearchType_url() {
		return searchType_url;
	}

	public void setSearchType_url(String searchType_url) {
		this.searchType_url = searchType_url;
	}

	public String getIsGroup_url() {
		return isGroup_url;
	}

	public void setIsGroup_url(String isGroup_url) {
		this.isGroup_url = isGroup_url;
	}

	public String getTestCode_url() {
		return testCode_url;
	}

	public void setTestCode_url(String testCode_url) {
		this.testCode_url = testCode_url;
	}

	public String getGroupCode_url() {
		return groupCode_url;
	}

	public void setGroupCode_url(String groupCode_url) {
		this.groupCode_url = groupCode_url;
	}

	public String getRequisitionDNo_url() {
		return requisitionDNo_url;
	}

	public void setRequisitionDNo_url(String requisitionDNo_url) {
		this.requisitionDNo_url = requisitionDNo_url;
	}

	public String getRequisitionNo_url() {
		return requisitionNo_url;
	}

	public void setRequisitionNo_url(String requisitionNo_url) {
		this.requisitionNo_url = requisitionNo_url;
	}
