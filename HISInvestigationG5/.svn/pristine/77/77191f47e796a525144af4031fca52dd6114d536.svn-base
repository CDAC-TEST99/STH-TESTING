...
public class InvestigationRaisingDtlreqFB
  extends ActionForm
{
  ...
  private String totalselectedtest ;
  ...
  private String instructiontestwise[] ;
  private String reqchiefcode ;
  private String reqchiefname ;
  private String reqdiagcode ;
  private String strIsNewBorn ;
  private String strMLCNo ;
  private String ispat_vip ;
  private String ispat_dead ;
  private String ispat_unknown ;
  private String reqdiagname ;
  ...
  private String[] refIdCheck;
  
  


public String[] getRefIdCheck() {
	return refIdCheck;
}
...
public void setRefIdCheck(String[] refIdCheck) {
...
public String getTotalselectedtest() {
	return totalselectedtest;
}




public void setTotalselectedtest(String totalselectedtest) {
	this.totalselectedtest = totalselectedtest;
}
...
public String[] getInstructiontestwise() {
	return instructiontestwise;
}




public void setInstructiontestwise(String[] instructiontestwise) {
	this.instructiontestwise = instructiontestwise;
}




public String getReqchiefcode() {
	return reqchiefcode;
}
...
public void setReqchiefcode(String reqchiefcode) {
	this.reqchiefcode = reqchiefcode;
}




public String getReqchiefname() {
	return reqchiefname;
}
...
public void setReqchiefname(String reqchiefname) {
	this.reqchiefname = reqchiefname;
}




public String getReqdiagcode() {
	return reqdiagcode;
}
...
public void setReqdiagcode(String reqdiagcode) {
	this.reqdiagcode = reqdiagcode;
}




public String getReqdiagname() {
	return reqdiagname;
}
...
public void setReqdiagname(String reqdiagname) {
	this.reqdiagname = reqdiagname;
}
...
public void setIspat_vip(String ispat_vip) {
	this.ispat_vip = ispat_vip;
}




public String getIspat_dead() {
	return ispat_dead;
}
...
public void setIspat_dead(String ispat_dead) {
	this.ispat_dead = ispat_dead;
}




public String getIspat_unknown() {
	return ispat_unknown;
}




public void setIspat_unknown(String ispat_unknown) {
	this.ispat_unknown = ispat_unknown;
}
...
public String getSelectedDataJson() {
...
public void setSelectedDataJson(String selectedDataJson) {
	this.selectedDataJson = selectedDataJson;
}
