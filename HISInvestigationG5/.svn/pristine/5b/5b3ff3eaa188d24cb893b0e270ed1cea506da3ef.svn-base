...
public class InvOfflineResultEntryFB extends ActionForm
{
	...
	private String modifycannedLabCode;
	private String selectValuemapping;
	private String resultEntryTemplateValueWithHashlink;
	private String Counter;
	
	private String strResultDtl;
	private String strTestResult[];
	private String strPatHospCode="";
	private String patAdd="";
	private String strMsgString="";
	private String strSlipContent="";
	private String strResEntryList="";
	private String strMsgType="";
	private String strGoFlag="";
	...
	private String cannedValue;
	private String cannedContent;
	
	private String hyperLinkTableSession;
	...
	private String strPatAgeUnit="";
	private String patGuardianName="";
	private String samplecoldate="";
	private String resultDate="";
	private String strParentHospitalCode="";
	private String strHospitalList= "";
	private String patMobileNo;
	private String[] strRefRangeVal= null;
	private String strOfflineResEntPatDtl="";
	private String hospitalcode;
	private String strFromDate="";
	private String strToDate="";
	private String patMobNo="";
	private String strDupPatList="";
	private String strMultiPatList ="";
	...
	public String getCannedValue() {
		return cannedValue;
	}

	public void setCannedValue(String cannedValue) {
	...
	public String getModifycannedLabCode() {
		return modifycannedLabCode;
	}

	public void setModifycannedLabCode(String modifycannedLabCode) {
		this.modifycannedLabCode = modifycannedLabCode;
	}



	public String getSelectValuemapping() {
		return selectValuemapping;
	}

	public void setSelectValuemapping(String selectValuemapping) {
		this.selectValuemapping = selectValuemapping;
	}

	public String getResultEntryTemplateValueWithHashlink() {
		return resultEntryTemplateValueWithHashlink;
	}

	public void setResultEntryTemplateValueWithHashlink(
			String resultEntryTemplateValueWithHashlink) {
		this.resultEntryTemplateValueWithHashlink = resultEntryTemplateValueWithHashlink;
	}

	public String getHyperLinkTableSession() {
		return hyperLinkTableSession;
	}

	public void setHyperLinkTableSession(String hyperLinkTableSession) {
		this.hyperLinkTableSession = hyperLinkTableSession;
	}
	...
	public String getStrResultDtl() {
		return strResultDtl;
	}

	public void setStrResultDtl(String strResultDtl) {
		this.strResultDtl = strResultDtl;
	}

	public String getStrPatAgeUnit() {
		return strPatAgeUnit;
	}

	public void setStrPatAgeUnit(String strPatAgeUnit) {
		this.strPatAgeUnit = strPatAgeUnit;
	}
	...
	public String getStrParentHospitalCode() {
		return strParentHospitalCode;
	}

	public void setStrParentHospitalCode(String strParentHospitalCode) {
		this.strParentHospitalCode = strParentHospitalCode;
	}

	public String getStrHospitalList() {
		return strHospitalList;
	}

	public void setStrHospitalList(String strHospitalList) {
		this.strHospitalList = strHospitalList;
	}
	...
	public String getStrPatHospCode() {
		return strPatHospCode;
	}

	public void setStrPatHospCode(String strPatHospCode) {
		this.strPatHospCode = strPatHospCode;
	}
	...
	public String getStrPatAge() {
		return strPatAge;
	}

	public void setStrPatAge(String strPatAge) {
		this.strPatAge = strPatAge;
	}
	...
	public String[] getStrRefRangeVal() {
		return strRefRangeVal;
	}

	public void setStrRefRangeVal(String[] strRefRangeVal) {
		this.strRefRangeVal = strRefRangeVal;
	}
	...
	public String getStrSlipContent() {
		return strSlipContent;
	}

	public void setStrSlipContent(String strSlipContent) {
		this.strSlipContent = strSlipContent;
	}

	public String getStrResEntryList() {
		return strResEntryList;
	}

	public void setStrResEntryList(String strResEntryList) {
		this.strResEntryList = strResEntryList;
	}

	public String getStrOfflineResEntPatDtl() {
		return strOfflineResEntPatDtl;
	}

	public void setStrOfflineResEntPatDtl(String strOfflineResEntPatDtl) {
		this.strOfflineResEntPatDtl = strOfflineResEntPatDtl;
	}
	...
	public String getStrDupPatList() {
		return strDupPatList;
	}

	public void setStrDupPatList(String strDupPatList) {
		this.strDupPatList = strDupPatList;
	}

	public String getStrMultiPatList() {
		return strMultiPatList;
	}

	public void setStrMultiPatList(String strMultiPatList) {
		this.strMultiPatList = strMultiPatList;
	}
