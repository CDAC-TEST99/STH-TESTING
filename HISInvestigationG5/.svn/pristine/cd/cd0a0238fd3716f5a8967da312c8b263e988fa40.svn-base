...
public class NEWOfflineResultEntryVO extends ValueObject{
	...
	private String isbillingreq;
	public String getIsbillingreq() {
		return isbillingreq;
	}

	public void setIsbillingreq(String isbillingreq) {
		this.isbillingreq = isbillingreq;
	}


	private String isCRNumber;
	public String getIsCRNumber() {
		return isCRNumber;
	}

	public void setIsCRNumber(String isCRNumber) {
		this.isCRNumber = isCRNumber;
	}

	public String patLabName;
	public String patReqDate;	
	public String patName; //nandini
	private String departmentname;  //nandini
	private String unitname;
	private String OnlineReqJson;
   ...
   private String priorityAllCode;	
	...
	private WebRowSet strPatientDtlWS = null;
	private WebRowSet strPatientTestListWS = null;
	//private String strMsgType = "";
	private WebRowSet offlineTestWS = null;    ///nandini
    private String headerHeight = "0";
    private String strLogoFileName="";//Added by Anjali
   ...
   // private String pdfFileName;
    ...
    private String footerWidth = "595.0";
    private String headerWidth = "595.0";
    private String pageSize = "A4867.6";
	
	private String header;
	private String strParentHospitalCode="";
	private WebRowSet strHospitalListWS = null;
    private String pdfFileName;
	private String PdfFtpUrl;
	private String strMsgString="";
	private String strMsgType="";
	private String strPatFileName= "";
	private String strUserSign= "";
	private String strUserSignFileName="";
	private String seatId;
	private String strPatHospCode="";
	private String patAdd="";
	private String patMobNo="";
	private String[] strRefRangeVal= null;
	private WebRowSet patientListWS = null;
	...
	public String getStrUserSignFileName() {
		return strUserSignFileName;
	}
	public void setStrUserSignFileName(String strUserSignFileName) {
		this.strUserSignFileName = strUserSignFileName;
	}
	...
	public WebRowSet getOfflineTestWS() {
		return offlineTestWS;
	}
	
	public void setOfflineTestWS(WebRowSet offlineTestWS) {
		this.offlineTestWS = offlineTestWS;
	}
	...
	public WebRowSet getStrHospitalListWS() {
		return strHospitalListWS;
	}
	public void setStrHospitalListWS(WebRowSet strHospitalListWS) {
		this.strHospitalListWS = strHospitalListWS;
	}
	...
	public String getStrPatFileName() {
		return strPatFileName;
	}
	public void setStrPatFileName(String strPatFileName) {
		this.strPatFileName = strPatFileName;
	}
	...
	public WebRowSet getStrPatientTestListWS() {
		return strPatientTestListWS;
	}
	public void setStrPatientTestListWS(WebRowSet strPatientTestListWS) {
		this.strPatientTestListWS = strPatientTestListWS;
	}
//	public WebRowSet getStrResultEntryListWS() {
//		return strResultEntryListWS;
//	}
	public WebRowSet getStrPatientDtlWS() {
		return strPatientDtlWS;
	}
	public void setStrPatientDtlWS(WebRowSet strPatientDtlWS) {
		this.strPatientDtlWS = strPatientDtlWS;
	}
	public WebRowSet getPatientListWS() {
		return patientListWS;
	}
	public void setPatientListWS(WebRowSet patientListWS) {
		this.patientListWS = patientListWS;
	}
	...
	public void setIsfirstpagereq(String isfirstpagereq) {
	   ...
	   public String getPageSize() {
		...
		public String getStrLogoFileName() {
			return strLogoFileName;
		}


		public void setStrLogoFileName(String strLogoFileName) {
			this.strLogoFileName = strLogoFileName;
		}
		...
		public String getOnlineReqJson() {
			return OnlineReqJson;
		}

		public void setOnlineReqJson(String onlineReqJson) {
			OnlineReqJson = onlineReqJson;
		}
