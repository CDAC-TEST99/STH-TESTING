...
public class InvestigationBillingDAOxray extends DataAccessObject implements InvestigationBillingDAOi
{
	public InvestigationBillingDAOxray(JDBCTransactionContext _tx)
	{
		super(_tx);
	}
	...
	public void insertviewsdetail(String testcode,String viewcode,String viewcount,String reqno, String reqdno, UserVO voo,int toalcountviews,String type) {
		...
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_TRANSACTIONDAO_XRAY;
	...
	public void insertbilldeatils(InvestigationRequisitionBillDtlVO voBillingDtl,Inv_RequisitionRaisingPatientVO patVO,String tariffdetails,String tariffQty,String testGroupVal,UserVO userVO,String requisitionwiseno)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_TRANSACTIONDAO_XRAY;
		String queryKey ="INSERT_BILL_DETAILS_DEMO";
		...
		try {
			...
			populateMAP.put(sq.next(),voBillingDtl.getRequisitionNos());
			populateMAP.put(sq.next(),tariffdetails);
			populateMAP.put(sq.next(),requisitionwiseno);
	...
	public void insertbilldeatils_duplicate(RequistionHeaderVO voBillingDtl,Inv_RequisitionRaisingPatientVO patVO,UserVO userVO,String requisitionwiseno,String reqno)
	{
		...
		Sequence sq = new Sequence();
		String filename = InvestigationConfig.QUERY_FILE_FOR_INVESTIGATION_TRANSACTIONDAO_XRAY;
		String queryKey ="INSERT_BILL_DETAILS_DEMO_DUPLICATE";
