...
//import new_investigation.transactions.bo.InvestigationEssentialOfflineBOi;
//import new_investigation.transactions.bo.InvestigationEssentialOfflineBO;
import new_investigation.transactions.bo.InvestigationEssentialOfflineBOi;
import new_investigation.transactions.bo.InvestigationEssentialOfflineBO;
...
public class InvestigationEssentialOfflineDelegate extends Delegate
{
	public InvestigationEssentialOfflineDelegate()
	{
		super(new InvestigationEssentialOfflineBO());
	}
	...
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
	...
	public List<NEWOfflineResultEntryVO> getHospitalList(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.getHospitalList(objSampleCollectionVO,_userVO);   
	}
	
	public List<NEWOfflineResultEntryVO> insertOffllineResultEntry(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		System.out.println("vo.getPatCRNo() 18::\t"+objSampleCollectionVO.getPatCRNo());
		...
		System.out.println("vo.getPatMobileNo()::\t"+objSampleCollectionVO.getPatMobileNo());
		 return serviceBO.insertOffllineResultEntry(objSampleCollectionVO,_userVO);   
	}
	
	public List<NEWOfflineResultEntryVO> insertOffllineResultEntryBilling(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		...
		System.out.println("vo.getPatDOB()::\t"+objSampleCollectionVO.getPatDOB());  
		System.out.println("vo.getPatMobileNo()::\t"+objSampleCollectionVO.getPatMobileNo());
		 return serviceBO.insertOffllineResultEntryBilling(objSampleCollectionVO,_userVO);   
	}
	
	public List<NEWOfflineResultEntryVO> onlineReqResultEntry(String onlineReqJson,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
	    return serviceBO.onlineReqResultEntry(onlineReqJson,_userVO);
	    
	}
	
	
	
	public List<NEWOfflineResultEntryVO> insertAlreadyRegPat(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.insertAlreadyRegPat(objSampleCollectionVO,_userVO);   
	}
	//getOffllineResultEntryPatientCount
	
	public List<NEWOfflineResultEntryVO> getOffllineResultEntryPatientCount(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.getOffllineResultEntryPatientCount(objSampleCollectionVO,_userVO);   
	}
	
	public List<NEWOfflineResultEntryVO> getOffllineResultEntryPatientData(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.getOffllineResultEntryPatientData(objSampleCollectionVO,_userVO);   
	}
	
	
	public List<NEWOfflineResultEntryVO> getOffllineResultEntryPatientTestData(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.getOffllineResultEntryPatientTestData(objSampleCollectionVO,_userVO);   
	}	
	
	
	
	
	public List<NEWOfflineResultEntryVO> getOfflineTestDetail(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO,String mode)
	 
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		 return serviceBO.getOfflineTestDetail(objSampleCollectionVO,_userVO,mode); 
	...
	public Map  getBilledPatList(List<String> reqList,NEWOfflineResultEntryVO voSample,UserVO userVO)
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
	...
	//Save Logic
	//Sample Collection Process
	public List  saveSampleCollectionDetails(Map<String,Map<String,Map<String,List<NEWOfflineResultEntryVO>>>> mp,UserVO _userVO)
	{
		InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
	...
	//Duplicacy Check
		public boolean checkSampleNoDuplicacy(NEWOfflineResultEntryVO voSample,UserVO userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
		...
		public String checkAutoGenFormate(NEWOfflineResultEntryVO voSample,UserVO userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
	...
	// Getting Packing List Generation Essentials
		//Getting Billed/Unbilled Patient List
		public Map  getPackingListGenerationEssentials(NEWOfflineResultEntryVO voSample,UserVO userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
			return(serviceBO.getPackingListGenerationEssentials(voSample,userVO));
		}
		
		public Map  getPackingListGenerationOnLoad(NEWOfflineResultEntryVO voSample,UserVO userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
		...
		public List<NEWOfflineResultEntryVO> getPackingListGenerationPatList(NEWOfflineResultEntryVO objSampleCollectionVO,UserVO _userVO)
		...
		public Map<String,List<NEWOfflineResultEntryVO>>  savePackingListDetails(Map<String,List<NEWOfflineResultEntryVO>> mp,UserVO _userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		...
		//Save Logic
		//Packing List Process
		public Map<String,List<NEWOfflineResultEntryVO>>  generateDuplicatePackingList(Map<String,List<NEWOfflineResultEntryVO>> mp,UserVO _userVO)
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
		...
		{
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi)super.getServiceProvider();
			return(serviceBO.getcollectionareafromward(wardcode,hospitalcode));
		}
		...
		public String AjaxBilledUnbilledDetails(NEWOfflineResultEntryVO vo, UserVO userVO) {
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
			return serviceBO.AjaxBilledUnbilledDetails(vo, userVO);
		}
		
		public String AjaxGetDetails(NEWOfflineResultEntryVO vo, UserVO userVO) {
			InvestigationEssentialOfflineBOi serviceBO = (InvestigationEssentialOfflineBOi) super.getServiceProvider();
