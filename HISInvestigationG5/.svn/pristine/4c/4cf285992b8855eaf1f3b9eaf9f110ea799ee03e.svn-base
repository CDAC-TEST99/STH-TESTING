...
public class HISSSOServiceCLN
{
	...
	public HISServiceGrantTicket authenticate(String grantingTicketId, HISService objHISService, HttpServletRequest request)
	{
		...
		try
		{
			System.out.println("HIS_MC-SSO-CLN:: TGT-" + grantingTicketId+ " Authenticating/Registering Service-" + objHISService.getContext());
			...
			if(objHISGrantTicket!=null)
				System.out.println("HIS_MC-SSO-CLN:: TGT-" + grantingTicketId+ " Registered Service-" + objHISService.getContext() +" ST-"+objHISGrantTicket.getTicketId());
			else
				System.out.println("HIS_MC-SSO-CLN:: TGT-" + grantingTicketId+ " Not Registered Service-" + objHISService.getContext());
		}
		catch (Exception e)
		{
