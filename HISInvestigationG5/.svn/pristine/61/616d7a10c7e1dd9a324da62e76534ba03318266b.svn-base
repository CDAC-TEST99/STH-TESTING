...
public class HISSSOService implements HISSSOServiceCON
{
	...
	public HISServiceGrantTicket authenticate(HISServiceSO objHISServiceSO, @Context HttpServletRequest objRequest, @PathParam("agentId") String agentId)
	{
		...
		try
		{
			...
			System.out.println("HIS_MC-SSO-SRV::Service: Authenticating Service Context-" + objHISService.getContext()+" Granting Ticket Id-" + strGrantingTicketId);
		...
		//	System.out.println("catchedAgentId :: "+catchedAgentId);
			...
			if (objTicketGrantingTicket != null)
			{
				...
				System.out.println("HIS_MC-SSO-SRV::Service: Grant Ticket ID-" + objHISGrantTicket.getTicketId());
			}
		}
		catch (Exception e)
		{
	...
	public String test()
	{
		System.out.println("HIS_MC-SSO-SRV::Service test");
