...
//        }
    ...
    public String fetchFilenew(String id) throws IOException {
        return latestFetchFilenew(id);
        /*String newFileName = id;
        GridFS gfsPhoto = new GridFS(database);
        GridFSDBFile output = gfsPhoto.findOne(newFileName);
        if (output == null) {
    ...
    public String latestFetchFilenew(String id) throws IOException {
        String newFileName = id;
        GridFS gfsPhoto = new GridFS(database);
        //Map<String, String> hm = new HashMap<String, String>();
        //hm.put("filename", id);
    ...
    public String DeletefetchXML(String id) throws IOException {
   	...
   	/*DBCollection collection  = MongoXmlHandler.getInstance().getDbCollectionXML();
