...
public class InvestigationRaisingDtlreqDATA
{
  ...
  public static  List<Map<String, String>>  getreferraltestdata(Inv_RequisitionRaisingPatientVO patVO, UserVO userVO) {
	    InvestigationEssentialDelegatereq daoDelegate = new InvestigationEssentialDelegatereq();
	    System.out.println("AJX_GETREFERRALTESTDATA daoDelegate");
	    return daoDelegate.getreferraltestdata(patVO, userVO);
	  }

  
  public static  List<Map<String, String>>  gethospitalname(Inv_RequisitionRaisingPatientVO patVO, UserVO userVO) {
	    InvestigationEssentialDelegatereq daoDelegate = new InvestigationEssentialDelegatereq();
	    System.out.println("gethospitalname daoDelegate");
	    return daoDelegate.gethospitalname(patVO, userVO);
	  }
  ...
  public static List saveReferralDetails(List<Inv_RequisitionRaisingPatientVO> patVOList ,  UserVO _userVO ) {
	    InvestigationEssentialDelegatereq daoDelegate = new InvestigationEssentialDelegatereq();
	    return daoDelegate.saveReferralDetails( patVOList, _userVO);
	  }
