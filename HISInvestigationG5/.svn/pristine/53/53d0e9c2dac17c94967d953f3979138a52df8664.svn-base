...
public class HISSSOClientServiceCLN
{
	...
	public HISClientSO isServiceTicketExpired(HISClientSO objSO_p)
	{
		...
		try
		{
			...
			//System.out.println("HIS_MC-SSO-SRV:: Service URI:"+uri);
			...
			//System.out.println("HIS_MC-SSO-SRV:: Service Expiry Status-" + objHISClientSO.getActionStatus() + " of TGT-" + objSO_p.getGrantingTicketId()
	...
	public HISClientSO killServiceTicket(HISClientSO objSO_p)
	{
		...
		try
		{
			...
			objHISClientSO = response.readEntity(HISClientSO.class);
			response.close();
			//System.out.println("HIS_MC-SSO-SRV:: Service Killing Status-" + objHISClientSO.getActionStatus() + " of TGT-" + objSO_p.getGrantingTicketId()
					//+ " of ST-" + objSO_p.getServiceTicketId());
		}
		catch (Exception e)
		{
