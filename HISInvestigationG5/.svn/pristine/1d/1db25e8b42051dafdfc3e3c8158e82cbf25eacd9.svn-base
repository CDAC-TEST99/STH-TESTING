...
String condition_lab="";
		...
		//String orderByCondition=" order by hivdt_coll_date_time,hivdt_acceptance_date_time,tempSampleNo,labNo,hivtnum_req_dno ";
		//Modified by prachi for listing desc order based on requisition  date
		String orderByCondition=" order by  hivt_entry_date desc,priority desc,emer desc  ,is_patdead desc,as_patmlc,is_patdead desc,is_newborn desc,is_pregnant desc,hivnum_req_no";
