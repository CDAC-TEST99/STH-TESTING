...
<fieldset class="m-2 px-1">
	...
	<html:form action="/invResultValidationResp" enctype="multipart/form-data">
			...
			<div class="mx-md-1 mx-md-point5 row  p-2 pt-lg-0 align-items-center shadow rounded-lg bg-white filertsGradient  hover-shadow collapse show" id="container2Row1">
				<div class="col-12 col-lg-4 rounded border-right-lg border-primary noUserSelect mt-lg-2">
					...
					<div class="input-group d-flex flex-nowrap mb-2 mb-md-0">
						<div class="input-group-prepend">
							<div class="input-group-text">Validation Status</div>
						</div>
						<select class="form-control custom-select" id="valStatusSelectInput">
							<option value="-1" disabled>Choose Validation Status</option>
							<option selected value="1">Yet To Validate</option>
							<option value="2">Validated</option>
							<option value="3">Draft</option>
							<option value="4">Already Validated</option>
						</select>
					</div>
 ...
 <%-- <input type='hidden' id='varSSOTicketGrantingTicket' name='varSSOTicketGrantingTicket' value="<%=request.getParameter(HISSSOConfig.LOGGEDIN_USER_GRANTING_TICKET_ID_VAR)%>"/>
  --%>     
    ...
    <html:hidden name="InvResultValidationRespFB" property="validationOrRevalidationProcess" value="1" />
