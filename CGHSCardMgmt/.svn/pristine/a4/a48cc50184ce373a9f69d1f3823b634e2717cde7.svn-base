...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/transferrequestapprove.js"></script>
...
<fieldset  class='p-5' id="ENTRYFORM">
	...
	<div class="row" id=getcardtransferdetails">
					   <h3>Card Received</h3>
	      ...
	      <div class="col-lg-3">
            <div class="form-group">
             ...
             <div class="col-lg-3" id="remarksbox" style="display:none">
				...
				<div class="legend3">
				<button class='btn btn-his-outline ' id="BTNVerify" onclick="cardtransferSubmit()"><i class='fa-solid fa-broom fa-fw'></i>&nbsp;Submit</button>
				</div>
