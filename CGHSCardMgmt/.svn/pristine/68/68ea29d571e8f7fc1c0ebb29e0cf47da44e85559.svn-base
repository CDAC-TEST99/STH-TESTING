...
#detailsTable td {
	...
	<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/ModifyBeneficiaryDataWithDep.js"></script>
...
<body>
    ...
    <h4>Modify OR Renewal Beneficiary Details</h4>
    <div class="col-md-3">
  ...
  <div class="modal-dialog modal-lg">
   ...
   <input type='hidden' name="Benidvalue" id='Benidvalue' value=""  />  
   	     ...
   	     <input type='hidden' name="parentcitycodehidden" id='parentcitycodehidden' value=""  /> 
			  ...
			  <input type='hidden' name="patientwchidden" id='patientwchidden' value=""  /> 
