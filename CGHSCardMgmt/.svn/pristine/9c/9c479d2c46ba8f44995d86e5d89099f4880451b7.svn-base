...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/deletecardsbycmoic.js"></script>
...
<h7 style="text-align: center; color: red;">Note:- If you delete the main cardholder, then all dependents will be automatically  deleted.</h7>
 ...
 <h2>Family Details</h2>
   <div class="col-sm-6"  id="Fileupload2">
							...
							<input type="hidden" name="writtenapplication"
								id="filename13" value="" /> <label
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="writtenapplication">Upload Delete Application: <span class="star text-danger">
									*</span>
							</label>
