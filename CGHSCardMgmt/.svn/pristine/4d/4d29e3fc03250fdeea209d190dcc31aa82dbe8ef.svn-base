...
<head>
  ...
  <jsp:include page="/global/jsp/commonLayout.jsp" flush="true"></jsp:include>
   ...
   <style>
    ...
    .radio-row label {
      margin-right: 70px; /* Adjust this value to control the space between radio buttons */
    }
        .highlight {
...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/cardtransferben.js"></script>
          ...
          <div class="invalid-feedback"></div>
		            ...
		            <div class="col-sm-3"  id="Fileupload3" >
							...
							<input type="hidden" name="transferslip"
								...
								data-langtag="Residential Address Proof">Upload Transfer Order <span class="star text-danger">
									*</span>
							</label>
		           ...
		           <div class="col-sm-3"  id="Fileupload3" >
							...
							<input type="hidden" name="joiningorder"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Upload Reliving Letter">Upload Joining Order<span class="star text-danger">
									*</span>
							</label>
          ...
          <div class="invalid-feedback"></div>
      	      ...
      	      <div class="col-sm-3"  id="Fileupload3" >
							...
							<input type="hidden" name="Addressproof"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Upload Address Proof">Upload Address Proof<span class="star text-danger">
									*</span>
							</label>
							...
							<div id="divFaIcon16" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload16"
									onclick="uploadDoc(16,'CARDDOCUMENT','1');">Upload</a>
