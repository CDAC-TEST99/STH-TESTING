...
function getBeneficiarydetails()
{
	...
	$("#patBenId").val(Benidvalue);
	 var configJson={
    				serviceName:"/getData/getbeneficiarydetailsservingben",
    				primaryKeys:[Benidvalue],			
    				callBackFunctionName:"PopulateBeneficiaryDetails",
 ...
 var configJson={  
	 serviceName:"/getData/getfamilymembersservingben",
    				primaryKeys:[Benidvalue],			
    				callBackFunctionName:"populatefamilymembers",
    	  ...
    	  //alert("dataJson>>>>>>>> " + JSON.stringify(dataJson));
				hidePreloader();
				 $('#paymentdiv').hide();
    	 			 if (!dataJson || !dataJson.data || dataJson.data.length === 0) {
        // $('#applyplastccard').show();
         showAlertMsg("No Data Found Beneficiary Belongs to another Card Type", "danger", "alertMsg");
    ...
    /*
    	...
    	callService(configJson);*/
               ...
               //alert(cardtypevaluecategory);
				...
				//alert("serving>>>>>>>>"+cardtypevaluecategory);
...
var configJson={
  ...
  //alert("gvdhghdghdghdg"+json["orgid"]+'$'+json["ddocode"]);
	 var configJson={
    			...
    			callBackFunctionName:"commonPopulateCombo",
    			defaultOption:{"optionValue":json["ddocode"],"optionText":"Select Organisation name"},
...
//	alert("4444444444");
    ...
    var configJson = {
        serviceName: "/DMLSAVE/cardconvertservingtopensioner",
        callBackFunctionName: "callbackSaveDatacardconvertservingtopensioner",
        inputData: processSerializeArray("ENTRYFORM")
    };
...
function callbackSaveDatacardconvertservingtopensioner(configJson, dataJson){
