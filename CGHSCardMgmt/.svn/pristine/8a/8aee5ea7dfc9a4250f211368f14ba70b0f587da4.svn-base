...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/downloadPhoto.js"></script>
	...
	<div class='row'>
	  ...
	  <div class="col-lg-2">
        <div class="form-group">
          <label class="col-form-label col-form-label-md" for="patDOB">Date To :</label>
          <input type="text" class="form-control form-control-sm dateTo" id="dateTo" name=""dateTo"" placeholder="dd-Mon-yyyy" data-validation="mandatory"  readonly="readonly">
          <div class="invalid-feedback"></div>
        </div>
      </div>
      <div class="col-lg-2">
        <div class="form-group">
          <label class="col-form-label col-form-label-md" for="patDOB">Date From :</label>
          <input type="text" class="form-control form-control-sm dateFrom" id="dateFrom" name="dateFrom" placeholder="dd-Mon-yyyy" data-validation="mandatory"  readonly="readonly">
          <div class="invalid-feedback"></div>
        </div>
      </div>
		<div class='col-md-2  mb-2 hideOnSearch' >
			<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="cardType">Card Type :</label>
              	<select class="form-control filters" id='cardType' name="cardType">
		...
		<div class='col-md-2  mb-2 hideOnSearch' >
			<div class="form-group">
              	<label class="col-form-label col-form-label-md" for="WellnessCenter">Wellness Center :</label>
              	<select class="form-control filters" id='wellnessCenter' name="wellnessCenter">
              		<option value="" selected >Select</option>
              	</select>              	
              	<div class="invalid-feedback"></div>
 			 </div>
		</div>
		 <div class='col-md-1 mt-5 mb-2' style="display:block"  id='divdownLoadExcel'>
			<a href="#" class='btn-his-sm' style="margin-top :-20px" id='submitId' onClick="return submit();">Download Photos</a>
		</div> 
	   <div class='col-md-1 mt-5 mb-2' style="display:block"  id='divdownLoadExcelId'>
			<a href="#" class='btn-his-sm' style="margin-top :-20px" id='downLoadExcelId' onClick="return downLoadExcel();">Download Excel</a>
	  </div> 
