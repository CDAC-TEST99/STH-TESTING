...
#detailsTable td {
	...
	<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/cardconvertservingtopensioner.js"></script>
...
<body>
    ...
    <h4>Serving to Pensioner Conversion</h4>
    <div class="col-md-3">
    ...
    <h7 style="text-align: center; color: red;">Note:- Please Enter Only Serving Ben Id for Conversion.</h7>
    ...
    <div class="form-group">
         ...
         <div class="form-group">
          <label class="col-form-label col-form-label-md" for="patientwc">Wellness Center</label>
                    <input type="text" class="form-control form-control-sm" id="patientwc" name="patientwc" data-validation="mandatory" readonly="true" maxlength="" placeholder="">
...
<!-- 	<div class="col-sm-3">
    ...
    <div class="col-sm-3">
         <div class="form-group">
          <label class="col-form-label col-form-label-md" for="patallowdeponly">Allow Dependents Only :</label>
          <select class="form-control form-control-sm select1" id="patallowdeponly" name="patallowdeponly" data-validation="mandatory">
...
<!--         <th style="width:10%">Card Type</th> -->
        ...
        <th style="width:10%">Action</th>
         <th style="width:5%">Renewal Checkbox</th>
            <!--   <th>Action</th> -->
   ...
   <div  id="paymentdiv"  style="display:none;">
		<button class='btn btn-his' id="BTNADDPayment" onclick="addpayment()"><i class='fas fa-save fa-fw' ></i>&nbsp;ADD Payment</button>
		</div>
...
<button class='btn btn-his' id="BTNADDPayment" onclick="addpayment()"><i class='fas fa-save fa-fw' ></i>&nbsp;ADD Payment</button>
  ...
  <thead>
	...
	<tbody>
    	...
    	<!-- 
    	     <div class="row" id="selectedaction" style="display:block;">
     <div class="col-lg-3">
            <div class="form-group">
    	...
    	<button class='btn btn-his-outline btn-sm' id="BTNSUBMIT" onclick="Approve();"><i class='fas fa-save fa-fw'></i>&nbsp;Submit</button>
  ...
  <div class="col-lg-3">
       ...
       <div class="col-sm-3">
        <div class="form-group">
		  ...
		  <input type="text" class="form-control form-control-sm"  id='paymentdate' name='paymentdate' readonly="true" placeholder="dd-Mon-yyyy" data-validation="mandatory" maxlength="11" >
          <div class="invalid-feedback"></div>
        </div>
      </div>
       <div class="col-sm-3">
...
<div>
<button class='btn btn-his' id="BTNSAVEPAYMENT" onclick="SavePayment()"><i class='fas fa-save fa-fw' ></i>&nbsp;Save Details</button>
</div> 
</div>	

  <div class="legend3">
    	<button class='btn btn-his-outline btn-sm' id="BTNMODIFY" onclick="saveData1();"><i class='fas fa-save fa-fw'></i>&nbsp;Modify</button>
  ...
  <div class="modal-dialog modal-lg">
   ...
   <input type='hidden' name="Benidvalue" id='Benidvalue' value=""  />  
   	     ...
   	     <input type='hidden' name="parentcitycodehidden" id='parentcitycodehidden' value=""  /> 
						   ...
						   <input type='hidden' name="patBenId" id='patBenId' value=""  /> 
