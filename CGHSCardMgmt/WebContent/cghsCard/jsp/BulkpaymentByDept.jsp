...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/BulkpaymentByDept.js"></script>
...
<body>
	...
	<div class='modal' id='divApproveView' tabindex='-1' role='dialog'
		...
		<div class='modal-dialog modal-xl' role='document'>
			<div class='modal-content'>
				...
				<div class='modal-body container border'>
