...
<head>
 <script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/applyofflineformda.js"></script>
...
<form  id="form-wrapper" class='p-2' method="post" name="form-wrapper">
  ...
  <div  class="container-fluid" style="margin-left: -20px;" id="selectmaincardtype">
  <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-sm" id="patMobileNo" name="patMobileNo"  data-validation="mandatory,mobile,numeric" maxlength="10" placeholder="Enter Mobile No." value=''>
              <div class="invalid-feedback"></div>
            </div>
          </div>
          <div class="col-lg-3">
    ...
    <div class="form-group">
        ...
        <!--   <div class="col-lg-3">
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-sm" id="mainchdoctypeid" name="mainchdoctypeid" data-validation="">
            ...
            <div class="col-sm-3"  id="Fileuploadmainchidproof" >
							...
							<input type="hidden" name="mainchidproof"
								...
								for="ID Proof"
								data-langtag="ID Proof">ID Proof<span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon19" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload19"
									onclick="uploadDoc(19,'CARDDOCUMENT','0');">Upload</a>
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-sm" id="patresdoctypeid" name="patresdoctypeid" data-validation="">
              ...
              <div class="invalid-feedback"></div>
		            ...
		            <div class="col-sm-3"  id="Fileupload3" >
							...
							<input type="hidden" name="ResAddressproof"
								...
								data-langtag="Residential Address Proof">Residential Address Proof <span class="">
									*</span>
							</label>
          ...
          <div class="invalid-feedback"></div>
            ...
            <div class="col-sm-6"  id="Fileupload35" >
							...
							<input type="hidden" name="Payslip"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Pay Slip">Upload Pay Slip: <span class="">
									</span>
							</label>
							...
							<div id="divFaIcon35" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload35"
									onclick="uploadDoc(35,'CARDDOCUMENT','0');">Upload</a>
  ...
  <div class="container-fluid" style="display: none;" id="deptinfopensioner">
    ...
    <!--      <div class="col-sm-4">
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control form-control-sm" id="Patppopensioner" name="Patppopensioner"  maxlength="20" placeholder="PPO Number" onblur="ValidatePPO()">
          <div class="invalid-feedback"></div>
        </div>
      </div>
    ...
    <div class="col-sm-3"  id="Fileupload2" >
							...
							<input type="hidden" name="PPOCertificate"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="PPO Certificate/Last Pay">Upload Pension Proof: <span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon12" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload12"
									onclick="uploadDoc(12,'CARDDOCUMENT','0');">Upload</a>
    ...
    <!-- --Dependent Form -->
    <div class="container-fluid" style="display: none;" id="dependentinfo">
    ...
    <div class="col-sm-3"  id="fileuploadPANNotavailble" style="display:none">
							...
							<div id="divFaIcon29" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload29"
									onclick="uploadDoc(29,'CARDDOCUMENT','0');">Upload</a>
 ...
 -->	    		</div>
		   ...
		   <div class="col-lg-3">
		           <div class="form-group">
		              ...
		              <select class="form-control form-control-sm" id="depidproofdoctypeid" name="depidproofdoctypeid" data-validation="">
		              </select>
		             <div class="invalid-feedback"></div>
		     	  </div>
		      </div>
		   <div class="col-sm-3"  id="fileuploaddepidproof" >
							...
							<input type="hidden" name="depidproof"
								...
								class="col-form-label col-form-label-sm"
								for="ID Proof"
								data-langtag="ID Proof">Dependent ID Proof<span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon20" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload20"
									onclick="uploadDoc(20,'CARDDOCUMENT','0');">Upload</a>
		     ...
		     <div class="col-lg-3" id="depageprooftype" style="display:none;">
		           <div class="form-group">
		              ...
		              <select class="form-control form-control-sm" id="depagedoctypeid" name="depagedoctypeid" data-validation="">
		              </select>
		             <div class="invalid-feedback"></div>
		     	  </div>
		      </div>
		   <div class="col-sm-3"  id="fileuploadageproof" style="display:none;">
							...
							<input type="hidden" name="depageproof"
								...
								class="col-form-label col-form-label-sm"
								for="ID Proof"
								data-langtag="ID Proof">Dependent Age Proof<span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon24" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload24"
									onclick="uploadDoc(24,'CARDDOCUMENT','0');">Upload</a>
		    ...
		    <div class="col-lg-3" id="depmarprooftype" style="display:none;">
		           <div class="form-group">
		              <label class="col-form-label col-form-label-md" for="depmardoctypeid">Dependent Divorce Proof Type :</label>
		   ...
		   <div class="col-sm-3"  id="fileuploadmarriagedoc" style="display:none;">
							...
							<input type="hidden" name="depmarproof"
								...
								class="col-form-label col-form-label-sm"
								for="ID Proof"
								data-langtag="ID Proof">Dependent Divorce Proof<span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon25" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload25"
									onclick="uploadDoc(25,'CARDDOCUMENT','0');">Upload</a>
  ...
  <div class="col-lg-3"  id="fileuploadspousecertificate" style="display:none">
		            <div class="form-group">
		              	<input type="hidden" name="Jointdeclartionproof"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Joint Certificate">Joint Declaration: <span class="">
									*</span>
							</label>
          ...
          <div class="col-lg-3"  id="fileuploaddisablecertificate" style="display:none">
		            <div class="form-group">
		              	<input type="hidden" name="Disabilitycertificate"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Disability Certificate">Disability Certificate: <span class="">
									*</span>
							</label>
		   ...
		   <div class="col-sm-3" id="incomestatusdoctype" style="display:none">
	        ...
	        <label class="col-form-label col-form-label-md" for="depincomestatusdoctypeid">Income proof Type:</label>
	          <select class="form-control form-control-sm " id="depincomestatusdoctypeid" name="depincomestatusdoctypeid" data-validation="">
		        ...
		        <div class="col-lg-3"  id="fileuploadIncomestatus" style="display:none">
		            <div class="form-group">
		              	<input type="hidden" name="incomestatuscertificate"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Disability Certificate">Income Status Certificate: 
							</label>
							...
							<div id="divFaIcon26" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload11"
									onclick="uploadDoc(26,'CARDDOCUMENT','0');">Upload</a>
  	    ...
  	    <div class="row">
		          <div class="col-lg-3">
		            <div class="form-group">
		              ...
		              <input type="text" class="form-control form-control-sm" id="nomname" name="nomname" placeholder="Enter Name" data-validation="alphabetOnly" maxlength="100">
		              <div class="invalid-feedback"></div>
		            </div>
		          </div>
		          ...
		          <div class="col-lg-3">
		            <div class="form-group">
						...
						<input type="text" class="form-control form-control-sm datepickerdob"  id='nomdob' name='nomdob'  placeholder="dd-mm-yyyy" data-validation="" maxlength="11" readonly="readonly">
		              <div class="invalid-feedback"></div>
		            </div>
		          </div>
		        <div class="col-lg-3">
		            <div class="form-group">
		              ...
		              <select class="form-control form-control-sm" id="nomrelation" name="nomrelation" data-validation="">
		                <option value="">Select</option>
		              </select>
		              <div class="invalid-feedback"></div>
		            </div>
		          ...
		          <div class="col-lg-3">
		            <div class="form-group">
		              ...
		              <select class="form-control form-control-sm" id="nomgender" name="nomgender" data-validation="">
		                <option value="">Select Gender</option>
		              </select>
		              <div class="invalid-feedback"></div>
		            </div>
		...
		<!-- 	<div class="col-lg-3" >
		        ...
		        <div class="col-lg-3">
		            ...
		            <label class="col-form-label col-form-label-md" for="nomaddress">Address :</label>
		              <input type="text" class="form-control form-control-sm" id="nomaddress" name="nomaddress" placeholder="Enter Address" data-validation="address" maxlength="100">
		              <div class="invalid-feedback"></div>
		            </div>
		          </div>
		           <div class="col-lg-3" style="display:none">
		            ...
		            <div class="form-group">
		              	<input type="hidden" name="NomineeProof"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Nominee Proof">Nominee Proof: <span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon15" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload15"
									onclick="uploadDoc(15,'CARDDOCUMENT','0');">Upload</a>
              ...
              <div class="invalid-feedback"></div>
		            ...
		            <div class="form-group">
		              	<input type="hidden" name="AlternamteNomineeProof"
								...
								class="col-form-label col-form-label-sm"
								for="installationCertiFicate"
								data-langtag="Nominee Proof">Alternate Nominee Proof: <span class="">
									*</span>
							</label>
							...
							<div id="divFaIcon17" style="float: left; margin-right: 2px;">
								<a class="btn  btn-his-sm  btn-sm" id="faUpload17"
									onclick="uploadDoc(17,'CARDDOCUMENT','0');">Upload</a>
...
<!--                   <button class='btn btn-his' id="BTNBACK"    onclick="previouspage()"><i class='fas fa-save fa-fw'></i>&nbsp;Back</button>
 -->         
...
<div class="applyCardForm">
  ...
  <ol>
  <li>Name of the Applicant:&nbsp;&nbsp;<b> <span id="dialogName"></b> </span> </li>
   ...
   <li>Mobile:&nbsp;&nbsp;<b><span id="dialogemob"></span></b></li>
	...
	<li>Date of retirement/superannuation: <span id="dialogdateofret"></li>
    <li>Pension related:
    <ol>Do you have PPO? <span id="dialogppostatus"></ol>
    <ol>PPO number: <span id="dialogppono"></ol>
...
<!-- 
    <h3>CGHS Undertaking by Main Card Holder</h3>
...
<div class="applyCardForm">
  ...
  <li>Name of the Applicant:&nbsp;&nbsp;<b> <span id="dialogNameservindeo"></b> </span> </li>
    <li>Category /Subcategory:&nbsp;&nbsp;<b><span id="dialogcardtypedeo">/<span id="dialogsubcardtypedeo"></span></b></li>
   ...
   <li>Mobile:&nbsp;&nbsp;<b><span id="dialogemobdepon"></span></b></li>
    ...
    <ol>Department:<span id="dialogdeptserving"></span>
   	Are you under Deputation.</ol> <span id="dialogdepflag"></span>
		<ol>End Date of Deputation.</ol> <span id="dialogdepdate"></span>
		</ol>
	</li>
                 ...
                 <input type="hidden" name="isdisablityvaluehidden" id="isdisablityvaluehidden" value=""/>
                  ...
                  <input type="hidden" name="cghsbenidexistflag" id="cghsbenidexistflag" value=""/>
                      ...
                      <input type='hidden' name="fileUploadFlag" id='fileUploadFlag' />
                       ...
                       <input type="hidden" name="hiddenpatmobile" id="hiddenpatmobile" value=""/>
