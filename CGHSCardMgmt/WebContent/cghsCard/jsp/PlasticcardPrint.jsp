...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/PlasticcardPrint.js"></script>
...
<!-- CARD FRONT -->
 <button type="button" class="btn btn-primary" onclick="Downloadpdf()" id="downloadPDF" data-bs-dismiss="modal">Print</button>
...
<div class="card-body">
    <div class="card-content">
      ...
      <table>
	      <tr>
	      <td style='width:70%; font-size: small; padding:16px;color:#1F6780;font-weight: bold; text-transform: capitalize;letter-spacing: 0.040rem; '>
	          <p class="card-text">
	          NAME: <span id="cardname"></span>
	          </p>	          
	         <p>DOB/GENDER: <span id="cardDob"></span>/<span id="cardGender"></span></p>
	         <p class="card-text">CATEGORY: <span id="cardcardtype"></span> <span id="cardtypenamehindi"></span></p>
	         <p>RELATION: <span id="cardRelation"></span></p>
	          <p>FACILITY: <span id="cardfacility"></span></p>
	        ...
	        <td style="width: 30%; text-align: right; padding-left: 15px;" id="qrCode"></td>
	         <tr>
	          <td colspan="2" style="text-align: right; padding-right: 10px; padding-top: 12px;letter-spacing: 0.040rem;font-weight: bold;">&#x928;&#x93F;&#x930;&#x94D;&#x926;&#x947;&#x936;&#x915;/Director</td>
	     	 </tr>
    	</table>
    	<div style='margin-top: -43px;margin-left: -90px;font-size: 33x;color: #fff;font-weight: bold;font-size: 18px;font-style: italic;'>BEN ID : <span id="cardbenid"></span> </div>  
	  </div>
