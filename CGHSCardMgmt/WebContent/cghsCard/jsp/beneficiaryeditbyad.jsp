...
<script type="text/javascript"
	src="/CGHSCardMgmt/cghsCard/js/beneficiaryeditbyad.js"></script>
...
<body>
						...
						<div class="col-lg-3">
							<div class="form-group">
								<label class="col-form-label col-form-label-md" for="patientwc">Wellness
									Center</label> <select class="form-control form-control-sm select1"
   ...
   -->
				...
				<input type="hidden" name="editRowIndex" id="editRowIndex" /> <input
					...
					type="hidden" name="statusflag" id=statusflag value="" /> <input
					type='hidden' name="Benidvalue" id='Benidvalue' value="" /> <input
					type='hidden' name="Benid" id='Benid' value="" /> <input
					type='hidden' name="cardnovalue" id='cardnovalue' value="" /> <input
