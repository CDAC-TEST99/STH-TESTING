...
<script type="text/javascript" src="/CGHSCardMgmt/cghsCard/js/PhotouploadBycmoic.js"></script>
    ...
    <div class="col-sm-2">
     ...
     <div class="col-lg-6 mt-4" >
        <div class="form-group">            
 	    ...
 	    <h7 style="text-align: center; color: red;">Note:- Please Enter Only Pensioners Benid's for Photo Upload</h7>
 ...
 <h4>Family Details</h4>
   <div class="col-sm-6"  id="Fileupload2">
							...
							<input type="hidden" name="PPOCertificate"
								...
								data-langtag="PPO Certificate/Last Pay">Upload Pension Proof(PPO): <span class="star text-danger">
									*</span>
							</label>
...
<!-- <div >
<button class='btn btn-his' id="BTNUPDATE" onclick="UpdatePhotostatus()"><i class='fas fa-save fa-fw' ></i>&nbsp;Submit</button>
</div>  -->
