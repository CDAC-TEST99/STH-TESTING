...
<div class="row" id='divTrackingIdEntry' style="display: none;">
  ...
  <div class="container-fluid p-4" id="displayuserinfo" style="display:none">
    ...
    <div class="col-lg-3">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-sm" id="patPANNo" name="patPANNo" placeholder="Enter PAN Number" data-validation="mandatory" maxlength="10">
              <div class="invalid-feedback"></div>
            </div>
          </div>
  ...
  <div class="container-fluid p-4" id="servingdept" style="display:none">
      ...
      <!--  <div class="col-lg-3">
                   <div class="form-group">
          <label class="col-form-label col-form-label-md" for="PatCardtype">Card Type :</label>
    ...
    <div class="col-lg-4">
         ...
         <div class="col-lg-4">
               <div class="form-group">
          <label class="col-form-label col-form-label-md" for="patsubdepartmentP">Sub Department :</label>
     ...
     <!--   <div class="col-lg-3">
           ...
           <div class="form-group">
          <label class="col-form-label col-form-label-md" for="PatCardtypeP">Card Category :</label>
       ...
       <div class="col-lg-3">
           ...
           <div class="form-group">
          <label class="col-form-label col-form-label-md" for="PatCardsubtypeP">Card Sub Category :</label>
         <input type="text" class="form-control form-control-sm" id="PatCardsubtypeP" name="PatCardsubtypeP" data-validation="mandatory" value="">
          <div class="invalid-feedback"></div>
        </div>
        </div> -->
        ...
        <div class="col-lg-3">
         ...
         <input type="text" class="form-control form-control-sm" id="PatCardcategory" name="patcardtypecategorypen" data-validation="mandatory" value="">
          <div class="invalid-feedback"></div>
        </div>
        </div>
          <div class="col-lg-3">
                   <div class="form-group">
          <label class="col-form-label col-form-label-md" for="PatCardsubtype">Card Sub Category :</label>
         <input type="text" class="form-control form-control-sm" id="PatCardsubtype" name="patsubcardtypepensioner" data-validation="mandatory" value="">
          <div class="invalid-feedback"></div>
        </div>
        </div>
     <div class="col-lg-3">
 ...
 -->    </tr>
    ...
    <div class="col-lg-3">
      <div class="form-group mt-4">
		      ...
		      <div class="text-primary">Please upload photos in JPG or PNG format, with a maximum file size of 20 KB.</div>
	...
	<!-- 	  <div class="col-lg-3">
        		...
        		<div class="invalid-feedback"></div>
          	   ...
          	   <div class="col-lg-3">
                     <div class="form-group">
		              <label class="col-form-label col-form-label-md" for="depidproofdoctypeid">Dependent Proof Type :</label>
        ...
        <div class="col-lg-3"  id="fileupload" style="display:none">
		  ...
		  <div class="col-lg-3" id="spousedoctype" style="display:none;">
		           <div class="form-group">
		              ...
		              <select class="form-control form-control-sm" id="depspousedoctypeid" name="depspousedoctypeid" data-validation="mandatory">
		              </select>
		             <div class="invalid-feedback"></div>
		     	  </div>
		      </div>
...
<div class="row">
  ...
  <thead>
   ...
   <!--  <div class="row">
     ...
     <div class="col-lg-3">
            <div class="form-group">
              ...
              <select class="form-control form-control-sm select1" id="deptaction" name="deptaction" data-validation="mandatory">
                ...
                <option value="1">Verify and Forward to CGHS</option>
                <option value="2">Return to Applicant</option>
    ...
    <div class="container-fluid" style="display: none;" id="departmentundertaking">
  <h3 class='mt-4'>Undertaking by Department</h3>
  <hr/>
  <div class="row">

    <label>
      <input type="checkbox" id="select-all" checked> Select All Undertaking
    </label>

    <div class="checkbox-group" >
      <input type="checkbox"  name="undertakingChk" checked>
      <label for="income">
        The information furnished by the applicant has been verified and found to be correct. It is recommended that a CGHS Card be issued to Shri/Smt./Kumari -<span id="patnameundertaking"></span>, at basic pay -<span id="patbasicpay"></span> and Pay level -<span id="patpaylevel"></span>this Ministry/Department/Organization.
      </label>
    </div>

    <div class="checkbox-group" id="subscription" style="display: none;">
      <input type="checkbox" name="undertakingChk" checked>
      <label for="parents">
    ...
    <div class="checkbox-group" >
      ...
      <label for="daughters">
        ...
        <div class="legend3">
    	<button class='btn btn-his ' id="BTNMODIFY" onclick="savedeptdata();"><i class='fas fa-save fa-fw'></i>&nbsp;Submit</button>
    	</div>
 <div class="popup" id="popup">
    ...
    <canvas id="canvas" width="320" height="240" style="display:none;"></canvas>
      ...
      <input type="hidden" name="deptactionhidden" id="deptactionhidden" value=""/>
    <input type="hidden" name="isdependentmodify" id="isdependentmodify" value=""/>
    ...
    <input type="hidden" name="editRowIndex" id="editRowIndex"/>
       <input type='hidden' name="fileUploadFlag" id='fileUploadFlag' />
            <input type="hidden" name="isdisablityvaluehidden" id="isdisablityvaluehidden" value=""/>
              <input type="hidden" name="isEditabledependentflag" id="isEditabledependentflag" value=""/>
  </fieldset>    
                
                
                
               
         <input type="hidden" name="selectedRowId" id="selectedRowId" value=""/>
