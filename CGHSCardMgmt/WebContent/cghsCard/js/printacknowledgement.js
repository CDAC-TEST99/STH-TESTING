...
alert("mobile>>>>>>>>>>>>"+document.getElementById('hiddenmobile').value);
    	  var configJson={
        	    	...
        	    	let html = "<tr>";
                	  ...
                	  html += "<td>" + json["MobileNo"] + "</td>";
          	         ...
          	         if(statusflagapplication=="4"){
               	       ...
               	       html += "<td><a class='btn btn-his-sm'  onclick='enterpayment()'>Check Payment Details</a></td>";
                      }
                      else if(statusflagapplication=="8" || statusflagapplication=="7" ||  statusflagapplication=="9" || statusflagapplication=="10" ||statusflagapplication=="11" ||statusflagapplication=="12")
                      {
/*						  html += "<td>" + json["gstr_application_status"] + " | " + json["Rejremarks"] + "</td>";
*/								html += "<td>" + json["Rejremarks"] + "</td>";
					  }
					   else{
				 html += "<td><a class='btn btn-his-sm' onclick='viewItem()'>View</a></td>";
					  }
          	        html += "</tr>";
    	...
    	function enterpayment()
    	{
		 var configJson={
    			  ...
    			  primaryKeys:[$('#hiddentrackingid').val()],			
    			}
    		callService(configJson);	
